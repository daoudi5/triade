...
?>
<BR><center><font size=2><U><?php print LANGRESA44?></U> : <b><?php print recherche_equip($_GET["equip"]) ?></b> <br>
<?php print LANGRESA48?> <?php print $datedepart?> </font></center>
<br><br>
<form method=get name=form11>
&nbsp;&nbsp;&nbsp;<?php print LANGRESA49?> <input type=text size=10 name=saisiedate value="<?php print $datedepart?>" readonly class="bouton2" >
<?php
include_once("librairie_php/calendar.php");
calendar("id1","document.form11.saisiedate",$_SESSION["langue"],"0");
?>
...
for($i=0;$i<count($data);$i++) {
	...
	print "<td align=center width=5>".$valide."</td>";
	print "</tr>";
