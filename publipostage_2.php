...
<br><ul><ul>
<table><tr><td><input type=button onclick="open('visu_pdf_admin.php?id=<?php print $fichier?>','_blank','');" value="<?php print "Récupération du document Publipostage" ?>"  STYLE="font-family: Arial;font-size:10px;color:#CC0000;background-color:#CCCCFF;font-weight:bold;"></td><td><script>buttonMagicPrecedent2()</script></td></tr></table>
</ul></ul><br>
