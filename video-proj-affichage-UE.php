...
<tr>
	...
	<input type=button class=BUTTON value="<-- Précédent" onclick="open('video-proj-affichage-UE.php?apres=<?php print $imoins?>&saisie_classe=<?php print $idclasse?>&saisie_trimestre=<?php print $trimes?>','video','');this.disabled=true">
	<?php 
...
<td align=right valign=middle ><input type=button class=BUTTON value="Suivant -->" onclick="open('video-proj-affichage-UE.php?apres=<?php print $iplus ?>&saisie_classe=<?php print $idclasse?>&saisie_trimestre=<?php print $trimes?>','video','');this.disabled=true">
</form>
</td></tr></table>
</td></tr>
<?php // ---------------------------------------------------------- ?>
...
<td valign=top width=70% height=100%  >
	...
	<tr><td valign=top height=100% ><iframe width='100%' height='100%'  src="video-proj-bulletin-UE.php?saisie_eleve=<?php print $ideleve?>&saisie_classe=<?php print $idclasse?>&saisie_trimestre=<?php print $trimes?>" MARGINWIDTH=0 MARGINHEIGHT=0 HSPACE=0 VSPACE=0 FRAMEBORDER=0 SCROLLING=auto  ></iframe></td></tr>
	</table>
<td  valign=top>
	...
	<div id="visdir" style="position:absolute;top:140;left:330;display:none;width:550px;height:310px;padding:1px;border:1px #666 solid;background-color:#ddd;z-index:1000">
		...
		<form><br /><br />
			...
			if ($type_bulletin == "leap") {
			      $leap=rechercheleap($ideleve,$type_bulletin,$trimes); //leap_encouragement,leap_felicitation,leap_meg_comp,leap_meg_trav
			      ...
			      print "<br><br>&nbsp;&nbsp;&nbsp;";
			      print "Félicitations <input id='leap1' type='checkbox' onclick=\"reactualise()\" $checkedmont1 />&nbsp;&nbsp;\n";
	...
	<div id="visprofp" style="position:absolute;top:140;left:330;display:none;width:550px;height:280px;padding:1px;border:1px #666 solid;background-color:#ddd;z-index:1000">
		...
		&nbsp;&nbsp;&nbsp;<?php
				if  (($_SESSION["membre"] == "menuadmin") || ( ($_SESSION["membre"] == "menuprof") && (verif_profp_class2($_SESSION["id_pers"],$idclasse))) ) {
					print "<input type='button' onclick=\"enrVisaProfp('$ideleve',this.form.com.value,'$trimes','retourenr1','','','".$anneeScolaire."')\" value=\"".LANGENR."\" class='bouton2' />";
			} ?>
