...
<td align=center><input type="text" name="trimestre3_debut" value="<?php print $date33_debut ?>" size=12 readonly> <?php include_once("librairie_php/calendar.php");calendarDim('id5','document.formulaire.trimestre3_debut',$_SESSION["langue"],"0");?></td>
