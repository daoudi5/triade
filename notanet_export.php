...
<option value="STA" id='select1'><?php print "Collège, Série Professionnelle option agricole"  ?></option>
</select>
<br><br>
...
<font class='T2'>Prendre en compte l'histoire géographie :  </font><input type=checkbox <?php print $notehistgeo ?> value='1' name='notehistgeo' > <i>(oui)</i><br><br>
<font class='T2'>Prendre en compte l'éducation civique :  </font><input type=checkbox <?php print $noteeducivi ?> value='1' name='noteeducivi' > <i>(oui)</i><br><br>
...
<font class='T2'>Effectuer un contrôle avant l'extraction :  </font><input type=checkbox <?php print $contnotanet ?> value='1' name='controle' > <i>(oui)</i><br><br>
<font class='T2'>Matière "EPS" via "Examen Brevet" : </font><input type='checkbox' name="epsviaexamen" value='1' <?php print $checkepsviaexamen ?> /> <i>(oui)</i><br><br>
<font class='T2'>Matière "SANTE ENV." via "Exam. Brevet" : </font><input type='checkbox' name="prev_sante_envviaexamen" value='1' <?php print $checkprev_sante_envviaexamen ?> /> <i>(oui)</i><br><br>
<UL><UL><UL>
