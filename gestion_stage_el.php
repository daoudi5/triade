...
<?php 
if (  (($_SESSION["membre"] == "menueleve") && (CREATENTRELEVE == "oui")) ||  (($_SESSION["membre"] == "menuparent") && (CREATENTRPARENT == "oui"))  ) { ?>
<tr><td></td></tr>
<tr><td></td></tr>
<tr>
...
<tr><td></td></tr>
<tr>
<form action='gestion_stage_demande_convention.php'>
<td align=right><font class="T2"><?php print "Demande de convention de stage" ?> :</font></td>
