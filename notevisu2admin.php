...
if (count($valeur)) {
?>
	<iframe MARGINWIDTH=0 MARGINHEIGHT=0 HSPACE=0 VSPACE=0 FRAMEBORDER=0  name="visunote" src="visunoteadmin.php?sClasseGrp=<?php print $_POST["sClasseGrp"]?>&sMat=<?php print $_POST["sMat"]?>&saisie_pers=<?php print $_POST['saisie_pers'] ?>" width="100%" height="100%" ></iframe>
<?php
}else {
?>
