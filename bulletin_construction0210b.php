...
config_param_ajout($_POST["affichecommentairedirection"],"affichecommentairedirection");
$abssconet=$_POST["abssconet"];
$affichemoyengenerale=$_POST["affichemoyengenerale"];
$affichecommentairedirection=$_POST["affichecommentairedirection"];
...
<ul>
<font class="T2">
      <?php print LANGBULL27?> : <?php print ucwords($textTrimestre) ?> Partiel <br> <br>
...
$ordre=ordre_matiere_visubull_btsblanc($_POST["saisie_classe"],$anneeScolaire); // recup ordre matiere
...
//	$pdf->WriteHTML($soustitre5);
	...
	//	print $effbordure2." $libelleMatiere <br>";
		...
		$pdf->WriteHTML('<B>'.trunchaine(strtoupper(sansaccent(strtolower($libelleMatiere))),30).'</B>');
...
if ($affichemoyengenerale == "oui") {
	...
	if ($affichecommentairedirection == "oui") { 
