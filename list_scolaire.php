...
<tr id='coulBar0' ><td height="2"><b><font   id='menumodule1' ><?php print LANGMESS397 ?></font></b></td>
</tr>
<tr id='cadreCentral0'>
<td valign=top>
<!-- // fin  -->
...
for($i=0;$i<count($data);$i++) {
	...
	print civ($data[$i][1])." ".strtoupper($data[$i][2])."</a></td>\n";
	...
	print "<td width=5><input type=button class=button value=\"".LANGMESS396."\" onclick=\"open('modif_scolaire.php?saisie_id=".$data[$i][0]."','_parent','');\" ></td>\n";
	print "</tr>\n";
}
?>
</table>
