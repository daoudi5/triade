...
<tr id='cadreCentral0' ><td colspan=2><br>&nbsp;&nbsp;<input type=button class=BUTTON value="<-- <?php print LANGPRECE ?>" onclick="open('ficheeleve3.php?eid=<?php print $_GET["eid"]?>','_parent','')">   
<?php 
if ($_SESSION["membre"] == "menuadmin") {
	print "<input type=button class=BUTTON value=\"Ajouter une information\" onclick=\"open('profpcomplement.php?eid=".$_GET["eid"]."','_parent','')\">";
}
?>
<br><br>
