...
?>
	...
	?>
     ...
     <tr id='coulBar0' ><td height="2"><b><font   id='menumodule1' ><?php print LANGCALRET1?></font></b></td>
     </tr>
     <tr id='cadreCentral0'>
     <td >
     <!-- // fin  -->
...
&nbsp;&nbsp;&nbsp;&nbsp;<input type=button value="Réactualiser la page"  onclick="window.location.reload(true)"  STYLE="font-family: Arial;font-size:10px;color:#CC0000;background-color:#CCCCFF;font-weight:bold;">
<BR><BR>
     <center> <A href="./gestion_discipline_calendrier11.php?saisie_annee_choix=<?php print $saisie_annee_moin?>" ><?php print LANCALED1?></A> <------> <A href="./gestion_discipline_calendrier11.php?saisie_annee_choix=<?php print $saisie_annee_plus?>" ><?php print LANCALED2?></A></center>
