...
<TR><TD align=top><font class=T2><?php print "Module d'importation de fichier XML" ?> </font></TD>
</TR></TABLE><br>
<?php print "Le fichier à transmettre DOIT contenir 30 champs" ?>
<BR>
<BR>
...
function suite() {
	location.href="./base_de_donne_key.php?base=xml";
}
</script>
