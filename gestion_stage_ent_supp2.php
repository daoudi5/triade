...
?>
<!-- /************************************************************
Last updated: 16.03.2005    par ET
*************************************************************/ -->
<HTML>
<HEAD>
...
if (isset($_GET["supp"])) {
	...
	if($cr == 1){
		...
		alertJs("Entreprise supprimé");
	}else{
		alertJs("Entreprise non supprimé \\n \\n Au moins élève est affecté à cette entreprise"); 
	}
...
$fichier="gestion_stage_ent_supp2.php";
...
?>
		...
		<div align=right>
		<input type=button onclick="open('gestion_stage_ent_supp2.php?supp=1&id=<?php print $data[$i][0] ?>&activite=<?php print  $activite ?>&departement=<?php print $departement ?>','_parent','')" value="<?php print LANGBT50?>" STYLE="font-family: Arial;font-size:10px;color:#CC0000;background-color:#CCCCFF;font-weight:bold;">
		&nbsp;&nbsp;
...
<tr><td align=left width=33%><br>&nbsp;<?php precedent_entr($fichier,$table,$depart,$nbaff,$champs,$iddest,$departement); ?><br><br></td>
<td align=right width=33%><br><?php suivant_entr($fichier,$table,$depart,$nbaff,$champs,$iddest,$departement); ?>&nbsp;<br><br></td>
</tr></table>
