...
if ($liste_matiere != "") {
	...
	$data=chargeMat($res);
		for($i=0;$i<count($data);$i++) {
			$liste_français.=ucwords($data[$i][1]).",";
		}	
}
...
if ($moyenFrancais != ""){
	...
	$noteFrancais=ereg_replace('\.',',',$noteFrancais);
}
