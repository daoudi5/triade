...
<font class=T2>Absence(s) non justifié(s)  </font>
...
<?php 
		...
		if (ereg("^$filtreSMS",$telsms)) {
			...
			if (is_numeric($telsms)) { 
				$nb++; 
				print "<u>Tel Prof. Père:</u><br>".$telsms."&nbsp;<input type=checkbox name='sms[]' value='$ideleve#$telsms#$date_ab#$time' ><br>";
				$telok=1;  
			}
		}
		...
		if (ereg("^$filtreSMS",$telsms)) {
			...
			if (is_numeric($telsms)) { 
				$nb++; 
				print "<u>Tel Prof. Mère:</u><br>".$telsms."&nbsp;<input type=checkbox name='sms[]' value='$ideleve#$telsms#$date_ab#$time' ><br>";
				$telok=1;  
			}
		}
		...
		if (ereg("^$filtreSMS",$telsms)) {
			...
			if (is_numeric($telsms)) { 
				$nb++; 
				print "<u>Port Elève:</u><br>".$telsms."&nbsp;<input type=checkbox name='sms[]' value='$ideleve#$telsms#$date_ab#$time' ><br>";
				$telok=1; 
			}
		}
