...
if (ereg(":",$idClasse)) { list($idClasse)=split(":",$idClasse); }
?>
...
//		$taux=$taux/3600;
	...
	//	$taux=$taux/3600;
		...
		$nbTotalBrutHTML=ereg_replace(' ','&nbsp;',$nbTotalBrut);
		print "<tr>";
...
$nomClasse=ereg_replace("/","_",$nomClasse);
...
<center>
<input type=button  name="liste" class="bouton2"  value="Imprimer vacation" onClick="open('visu_pdf_admin.php?id=<?php print $fichier?>','_blank','');" />
</center>
<br />
