...
for($i=0;$i<count($data);$i++)
	...
	<td ><a style="text-decoration:underline" href="modif_groupes_ajout_multi2.php?eid=<?php print $data[$i][3]?>" onMouseOver="AffBulle('<font face=Verdana size=1><?php print "Sélectionner" ?></FONT>'); window.status=''; return true;" onMouseOut='HideBulle()'><?php print strtoupper($data[$i][1])?></a></td>
