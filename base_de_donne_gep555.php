...
$log=0;
for($i=0;$i<=$nb;$i++) {
	$matiere=$_POST["saisie_ref"][$i];
	$cr=insert_matiere_gep(strtolower($matiere));
	if ($cr) { 
		$nb1++;
		$log=1; 
	}
...
if ($log) {
	history_cmd($_SESSION["nom"],"IMPORT","GEP fichier matière");
}


?>
<center><br /><br /><font class=T2> <?php print $nb1 ?> matières sont enregistrées. </font></center>
<br><br>
<!-- // fin  -->
</td></tr></table>
