...
// ----------------------------------------------------------------------------------------------------------------
	...
	if ($_POST["etape"] == "1") {
		...
		$cr=create_cahiertexteContenu($_POST["saisie_idclsorgrp"],$_POST["saisie_idmatiere"],$_POST["saisie_date"],$_POST["date_contenu"],$clsorgrp,$_POST["number"],$id_pers,filtreCopierColler($_POST["saisie_contenu"]));
		if($cr == 1){
			if ($clsorgrp == 0) {
...
// ----------------------------------------------------------------------------------------------------------------
	if ($_POST["etape"] == "2" ) {
		...
		$date=$_POST["date_contenu"];
		if ($_POST["saisie_clsorgrp"] != 0 ) { $clsorgrp=1 ; }
		$cr=create_cahiertexteObjectif($_POST["saisie_idclsorgrp"],$_POST["saisie_idmatiere"],$_POST["saisie_date"],$_POST["date_contenu"],$clsorgrp,$_POST["number"],$id_pers,filtreCopierColler($_POST["saisie_contenu"]));
		if($cr == 1){
			if ($clsorgrp == 0) {
				$info=chercheClasse_nom($_POST["saisie_idclsorgrp"])." ".chercheMatiereNom($_POST["saisie_idmatiere"]);
			}else{
...
// ----------------------------------------------------------------------------------------------------------------	
	if ($_POST["etape"] == "3") {
		...
		if ($_POST["saisie_clsorgrp"] != 0 ) { $clsorgrp=1 ; }
		$cr=create_devoirscolaire($_POST["saisie_idclsorgrp"],$_POST["saisie_idmatiere"],date("d/m/Y"),$_POST["date_devoir"],filtreCopierColler($_POST["saisie_contenu"],"$tag"),$clsorgrp,$_POST["number"],$id_pers,$_POST["tempsestime"]);	
		if($cr == 1){
			if ($clsorgrp == 0) {
				$info=chercheClasse_nom($_POST["saisie_idclsorgrp"])." ".chercheMatiereNom($_POST["saisie_idmatiere"]);
			}else{
