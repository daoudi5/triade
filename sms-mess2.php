...
if (LAN == "oui") {
	if (file_exists("./common/config-sms.php")) {
		...
		print "<iframe width='5' height='5' name='TRIADE-SMS' src='vide.html' style='visibility:hidden'  ></iframe>";
		print "<form method='post' action='${urlsms}sms-envoi-message.php' target='TRIADE-SMS' name='formulaire'>";
		print "<input type=hidden name='sms-envoi' value=\"$tel\">";
		...
		print "</font></center>";
		history_cmd($_SESSION["nom"],"SMS","Envoi message");
	}else{
