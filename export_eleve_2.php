...
if (isset($_POST['create'])) {
	...
	foreach($tab as $key=>$value) {
		...
		print "</select>&nbsp;";
		$name="";
		if ($value == "nom") { $name="nom&nbsp;élève"; }
		if ($value == "prenom") { $name="prenom&nbsp;élève"; }
		...
		if ($value == "numero_eleve") { $name="INE&nbsp;-&nbsp;N°&nbsp;élève"; }
		if ($value == "email_eleve") { $name="Email&nbsp;élève"; }
		...
		if ($value == "tel_eleve") { $name="Tél.&nbsp;élève"; }
		if ($value == "sexe") { $name="sexe"; }
		if ($value == "code_barre") { $name="Code&nbsp;barre"; }
		if ($value == "email_eleve") { $name="Email&nbsp;élève"; }
		if ($value == "email_eleve_pro") { $name="Email&nbsp;élève&nbsp;Univ."; }
		if ($value == "annee_scolaire") { $name="Année&nbsp;scolaire."; }
		if ($value == "tel_fixe_eleve") { $name="Tél.&nbsp;fixe&nbsp;élève"; }
