...
foreach($tab as $key=>$value) {
	if (ereg('1',$value)) { $checkj1='checked="checked"'; } 
	if (ereg('2',$value)) { $checkj2='checked="checked"'; } 
	if (ereg('3',$value)) { $checkj3='checked="checked"'; } 
	if (ereg('4',$value)) { $checkj4='checked="checked"'; } 
	if (ereg('5',$value)) { $checkj5='checked="checked"'; } 
	if (ereg('6',$value)) { $checkj6='checked="checked"'; } 
	if (ereg('7',$value)) { $checkj7='checked="checked"'; } 
}
?>
<tr>
...
<td align=left><input type=text size=30 name=lieu value="<?php print $lieu?>" ></td>
</tr>
<tr>
<td align=right width=45%><font class="T2"><?php print LANGSTAGE30 ?> :</font></td>
<td align=left><input type=text size=30 name=ville value="<?php print $ville?>" ></td>
</tr>
<tr>
<td align=right width=45%><font class="T2"><?php print LANGSTAGE29 ?> :</font></td>
<td align=left><input type=text size=15 name=postal value="<?php print $codep?>" ></td>
</tr>
<tr>
...
<td align=left><input type=text size=30 name=responsable value="<?php print $tuteur?>" ></td>
</tr>
<tr>
<td align=right width=45%><font class="T2"><?php print LANGABS38 ?> :</font></td>
<td align=left><input type=text size=30 name=tel value="<?php print $tel?>" ></td>
</tr>
<tr>
