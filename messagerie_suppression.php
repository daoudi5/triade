...
for($i=0;$i<count($data);$i++) {
	...
	$lu="<img src='./image/lu.gif'>";
	if (DBTYPE == "pgsql") {
		if ($data[$i][10] == "f") { $lu="<img src='./image/nonlu.gif'>"; }
	}
	if (DBTYPE == "mysql") {
		if ($data[$i][10] == 0) { $lu="<img src='./image/nonlu.gif'>"; }
	}
...
<?php
$mess="<font face=Verdana size=1><img src=\'./image/nonlu.gif\'>".LANGMESS39." &nbsp; &nbsp; &nbsp; <img src=\'./image/lu.gif\'>". LANGMESS38." </font>";
...
if ((LAN == "oui") && (AGENTWEB == "oui")) {
	...
	$mess="<iframe width=100 height=100 src=\'./agentweb/agentmel.php?inc=5&mess=$vocal\'  MARGINWIDTH=0 MARGINHEIGHT=0 HSPACE=0 VSPACE=0 FRAMEBORDER=0 SCROLLING=no align=left ></iframe><br><font face=Verdana size=1><img src=\'./image/nonlu.gif\'>".LANGMESS39." <br><br> <img src=\'./image/lu.gif\'>". LANGMESS38." </font>" ;
}
