...
<td id='bordure'><font class='T1'>&nbsp;<?php print $data[$i][6] ?></font></td>
<td id='bordure'><font class='T1'>&nbsp;<?php if ($data[$i][3] == "Accepté") print "<font color='green'>"; if ($data[$i][3] == "Refusé") print "<font color='red'>"; print ereg_replace(' ','&nbsp;',$data[$i][3]); if ($data[$i][3] == "accepté") print "</font>"; if ($data[$i][3] == "Refusé") print "</font>"; ?></a>&nbsp;</font>&nbsp;<a href="preinscriptiondetail.php?ideleve=<?php print $data[$i][5] ?>"><img src="image/commun/b_edit.png" border='0' align='center' /></td>
