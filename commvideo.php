...
<TD  align="left" ><input type="text" name="saisie_lien" size=40  value="<?php print $lienvideo ?>" onclick="this.value=''; this.form.saisie_lien_youtube.value='';" > <i>(format flv)</i></td>
</td>
</tr>
<tr>
