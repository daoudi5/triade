...
<SCRIPT language="JavaScript" src="./<?php print REPADMIN?>/librairie_js/menudepart.js"></SCRIPT>
    ...
    <table border="0" cellpadding="3" cellspacing="1" width="100%" bgcolor="#0B3A0C" height="85">
             <tr id='coulBar0' ><td height="2"><b><font   id='menumodule1' >Statistique par Navigateur.</font></b></td></tr>
...
for($i=0;$i<count($data);$i++)
{
	...
	<tr><td colspan=4><?php print $data[$i][0]?></td></tr>
	<tr>
		<td>Version : <?php print $data[$i][1]?></td>
		<td>Os : <?php print $data[$i][3]?></td>
		<td>Langue : <?php print $data[$i][4]?></td>
		<td>Nombre : <b><?php print $data[$i][2]?></b></td>
