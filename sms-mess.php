...
?>
		...
		if (isset($_GET["eid"])) {
			...
			print "<font class='T2'>".LANGSMS9." $nom $prenom :</font> <br><br> <table border=0 width='100%' >";
				...
				$tel5=ereg_replace(" ","",$tel5);
				$tel5=ereg_replace("\.","",$tel5);
				$tel5=ereg_replace("/","",$tel5);
				$tel5=ereg_replace("-","",$tel5);
				$tel5=ereg_replace("_","",$tel5);
				if (is_numeric($tel5)) { 
					$num=1;
