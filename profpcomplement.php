...
<table bordercolor="#CCCC00"  width=60% align=center border=1 bgcolor="#FFFFFF">
<tr>
<td width=50% align=right  id='bordure'><font class='T2'><?php print LANGPROFP6 ?> :</font> </td>
<td id='bordure' ><input type=text name=dateDebut value="<?php print dateDMY()?>"  size=10 class=bouton2 readonly ></td>
</tr>
<tr>
<td  align=right id='bordure' ><font class='T2'><?php print LANGPROFP7 ?> :</font> </td>
<td  id='bordure'><input type=text name=dateFin size=10 readonly class=bouton2>
	<?php
