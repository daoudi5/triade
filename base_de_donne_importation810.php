...
<ul>
<br />
<form method=post  action='./base_de_donne_importation812.php' name=formulaire ENCTYPE="multipart/form-data">

<font class=T2><?php print LANGGEP2?> : (<b>xls</b>)  <input type="file" name="fichier1" size=20 > </font><br /><br />
<br><br>
<ul><ul>
