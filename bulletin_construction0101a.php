...
//			$infoLibelPiedPage.="($etoile) $libelleMatiereLong / ";
	...
	if ($notaffmoyclass != "oui") { 
		...
		$pdf->MultiCell(87+20,$confPolice[1],$commentaireeleve,'','','L',0);
	}
...
if (($affnoteviescolaire == "oui") && (MODNAMUR0 == "oui")) {
	...
	if ($notaffmoyclass != "oui") { 
		...
		$pdf->SetXY($Xnote-20,$Ynote);
		$pdf->MultiCell(87+20,$hauteurMatiere,'',1,'',0);
	}
	$Ynote=$Ynote + $hauteurMatiere;
	...
	if ($notaffmoyclass != "oui") { 
		$pdf->SetXY($Xcom-32,$Ycom);
		$pdf->MultiCell(87+12,$confPolice[1],$commentaireeleve,'','','L',0);
	}else{
		$pdf->SetXY($Xcom-20,$Ycom);
		$pdf->MultiCell(87+20,$confPolice[1],$commentaireeleve,'','','L',0);
	}
