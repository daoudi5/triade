...
if(autorisation_module()) {
	...
	$type_reglement_id = lire_parametre('type_reglement_id', $g_tab_type_reglement_id['cheque'], 'POST');
	//***************************************************************************
	...
	if($date_remise == '') {
		$date_remise = $date_au_cinq_du_mois;
	}
	...
	// Recherche des numeros de bordereau existants
	$tab_numero_bordereau = array();
	$sql  = "SELECT numero_bordereau ";
	$sql .= "FROM ".FIN_TAB_REGLEMENT." ";
	$sql .= "WHERE numero_bordereau <> '' ";
	$sql .= "GROUP BY numero_bordereau ";
	//echo $sql;
	$res_numero_bordereau=execSql($sql);
								...
								<td valign=top align="center">
									...
									<fieldset id="fieldset_criteres" style="z-index:5; margin-left:15px; margin-right:15px;">
										...
										<table cellpadding="0" cellspacing="2" align="center">
											<tr>
												<td align="right"><?php echo LANG_FIN_GBOR_013; ?>&nbsp;:&nbsp;</td>
												<td align="left">
													<table cellspacing="0" cellpadding="0" border="0">
														<tr>
															<td align="left">
																...
																$valeur = $date_remise;
																?>
																<input type="text" name="date_remise" id="date_remise" size="10" maxlength="10" value="<?php echo $valeur; ?>">
															</td>
															<td>&nbsp;</td>
															<td align="left">
																<?php
																calendarDim("div_date_remise","document.formulaire.date_remise",$_SESSION["langue"], "0", "0", 'fieldset_criteres', 'null', 'null');	
																?>
															</td>
															<td>&nbsp;</td>
															<td valign="middle">
															<a href="javascript:;"  onMouseOver="AffBulle3('<?php echo LANG_FIN_GENE_002; ?>','./image/commun/info.jpg',' <?php echo LANG_FIN_GBOR_014; ?>', 'fieldset_criteres');"  onMouseOut="HideBulle();"><img src="./image/help.gif" border="0" align="middle" style="display: block;"></a>
