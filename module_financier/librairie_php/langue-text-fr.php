...
// GENERAL
//-------------------------------
define("LANG_FIN_GENE_001","Les données ont été enregistrées");
...
define("LANG_FIN_GENE_063","Choisissez une année");
define("LANG_FIN_GENE_064","Editer facture");
//------------------------------
...
define("LANG_FIN_GROUPE_001","Gestion des groupes de frais");
define("LANG_FIN_GROUPE_002","Ajouter, modifier ou supprimer un groupe de frais");
define("LANG_FIN_GROUPE_003","Modification d'un groupe de frais");
define("LANG_FIN_GROUPE_004","Intitulé du groupe de frais");
define("LANG_FIN_GROUPE_005","Créer un groupe de frais");
define("LANG_FIN_GROUPE_006","Liste / modifier groupe de frais");
define("LANG_FIN_GROUPE_007","Supprimer un groupe de frais");
define("LANG_FIN_GROUPE_008","Pas de groupe de frais disponible");
define("LANG_FIN_GROUPE_009","Modifier un groupe de frais");
define("LANG_FIN_GROUPE_010","Suppression d'un groupe de frais");
define("LANG_FIN_GROUPE_011","Les groupes de frais grisés ne peuvent pas être supprimés car ils sont utilisés par un ou plusieurs types de frais");
define("LANG_FIN_GROUPE_012","Ce groupe de frais ne peut pas être supprimé car il est utilisé par un ou plusieurs type de frais");
define("LANG_FIN_GROUPE_013","Groupe de frais");
define("LANG_FIN_GROUPE_014","Groupe");
define("LANG_FIN_GROUPE_015","Pas de groupe");
define("LANG_FIN_GROUPE_016","Détail");
define("LANG_FIN_GROUPE_017","Valider la création du groupe de frais ?");
define("LANG_FIN_GROUPE_018","Groupes");
...
define("LANG_FIN_FBAR_013","Groupe de frais");
...
define("LANG_FIN_INSC_034","La date de l'échéance n°#i# doit être est inférieur à la date du jour");
//------------------------------
...
define("LANG_FIN_ECHE_021","Fusionner les échéances");
...
//------------------------------
// PARAMETRAGE FICHIER PRELEVEMENT
//-------------------------------

define("LANG_FIN_PARP_001","Paramétrage du fichier de prélèvement");
define("LANG_FIN_PARP_002","Nom du fichier de prélèvement");
define("LANG_FIN_PARP_003","Numéro émetteur");
define("LANG_FIN_PARP_004","Titulaire");
define("LANG_FIN_PARP_005","Banque");
define("LANG_FIN_PARP_006","Code guichet");
define("LANG_FIN_PARP_007","Code banque");
define("LANG_FIN_PARP_008","Numéro compte");
define("LANG_FIN_PARP_009","Libelle");
define("LANG_FIN_PARP_010","Référence émetteur");
define("LANG_FIN_PARP_011","Modifier le paramétrage");
...
define("LANG_FIN_PAIE_011","Voir la liste des précédents prélèvements");
define("LANG_FIN_PAIE_012","Ancien fichier envoyé à la banque pour les prélèvements automatiques");
define("LANG_FIN_PAIE_013","Voir la liste des précédents bordereaux");
...
define("LANG_FIN_IMPA_005","Choisissez un type de réglement et une date de limite d'échéances et cliquez sur 'Rechercher'");
...
define("LANG_FIN_GPRE_014","Répartition comptable du prélèvement");
//------------------------------
// TYPE D'ECHEANCE
//-------------------------------
...
define("LANG_FIN_EDIT_007","Editions des inscriptions par frais");
define("LANG_FIN_EDIT_008","Editions des inscriptions par groupes");
...
define("LANG_FIN_EENC_010","Total par groupe");

//------------------------------
// EDITION - FACTURE
//-------------------------------
define("LANG_FIN_FACT_001","Impression de la facture");
