		...
		<table border="0" cellpadding="3" cellspacing="1" width="100%" bgcolor="#0B3A0C" height="85">
			...
			<tr id="cadreCentral0">
				<td valign="top" align="center">
										...
										<tr>
											<td align="center" colspan="2">
												<table border="0" align="center" cellpadding="0" cellspacing="0">
													<tr>
														<td align="center">
															<script language="javascript">buttonMagicSubmit("<?php print LANG_FIN_TREG_009?>","create"); //text,nomInput</script>
														</td>
													</tr>
												</table>
											</td>
					...
					<form name="formulaire_liste" id="formulaire_liste" action="<?php echo $g_chemin_relatif_module; ?>type_reglement_liste.php" method="post">
					</form>
					<form name="formulaire_supp" id="formulaire_supp" action="<?php echo $g_chemin_relatif_module; ?>type_reglement_supp.php" method="post">
					</form>
