...
{
    protected $_normalizeAlef = array('Ã','Å','Â');
    protected $_normalizeDiacritics = array('ó','ð','õ','ñ','ö','ò','ú','ø');

    protected $_commonChars = array('É','å','í','ä','æ','Ê','á','Ç','Ó','ã', 'e', 't', 'a', 'o', 'i', 'n', 's');

    protected $_separators = array('.',"\n",'¡','º','(','[','{',')',']','}',',',';');

    protected $_commonWords = array();
    protected $_importantWords = array();
     ...
     * @author Khaled Al-Shamaa <khaled.alshamaa@gmail.com>
     */
    protected function _doNormalize($str)
    {
     ...
     * @author Khaled Al-Shamaa <khaled.alshamaa@gmail.com>
     */
    protected function _draftStem($str)
    {
     ...
     * @author Khaled Al-Shamaa <khaled.alshamaa@gmail.com>
     */
    protected function _rankWords($str)
    {
        $wordsRanks = array();
     ...
     * @author Khaled Al-Shamaa <khaled.alshamaa@gmail.com>
     */
    protected function _rankSentences($sentences, $stemmedSentences, $arr)
    {
        $sentenceArr = array();
        $rankArr = array();
     ...
     * @author Khaled Al-Shamaa <khaled.alshamaa@gmail.com>
     */
    protected function _minAcceptedRank($arr, $int)
    {
     ...
     * @author Khaled Al-Shamaa <khaled.alshamaa@gmail.com>
     */
    protected function _acceptedWord($word)
    {
        $accept = true;
