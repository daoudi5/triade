...
class ArWordTag
{
    protected static $_particle_pre_nouns = array('⁄‰', '›Ì', '„–', '„‰–', '„‰', '«·Ï', '⁄·Ï', 'Õ Ï', '«·«', '€Ì—', '”ÊÏ', 'Œ·«', '⁄œ«', 'Õ«‘«', '·Ì”');
    protected static $_normalizeAlef = array('√','≈','¬');
    protected static $_normalizeDiacritics = array('Û','','ı','Ò','ˆ','Ú','˙','¯');
