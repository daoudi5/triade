 ...
 * direction AN to the direction AK towards the Ka‘ba, and so q is the qibla 
 * bearing to be computed. Let Φ and λ be the latitude and longitude of A, and ΦK 
 * and λK be the latitude and longitude ofK (the Ka‘ba). If all angles and arc 
 * lengths are measured in degrees, then it is seen that the arcs AN and KN are 
 * of measure 90 - Φ and 90 - ΦK, respectively. Also, the angle ANK between the 
 * meridians of K and A equals the difference between the longitudes of A and K, 
 * that is, λK - λ, no matter what the prime meridian is. Here we are given two 
