...
if(autorisation_module()) {
	...
	// Avertissement : Informer l'utilisateur qu'il n'y a pas de type de reglement disponible.
	if($res->numRows() == 0) {
		...
		<table border="0" cellpadding="3" cellspacing="1" width="100%" bgcolor="#0B3A0C" height="85">
			<tr id="coulBar0">
				<td height="2" align="left">
					<b><font id="menumodule1" ><?php echo LANG_FIN_TREG_004; ?></font></b>
				</td>
			</tr>
			<tr id="cadreCentral0">
				<td valign="top" align="center">
									...
									<table width="100%" cellpadding="0" cellspacing="2" align="center">
										...
										?>
													<tr class='tabnormal2' onMouseOver="this.className='tabover';" onMouseOut="this.className='tabnormal2';">
														...
														?>
														<td width="5"><input type="button" class="button" value="<?php echo LANG_FIN_GENE_005; ?>" onClick="onclick_modifier('<?php echo $ligne[0]; ?>');" <?php echo $disabled; ?> ></td>
													</tr>
										<?php
											}
										?>
					...
					<script language="javascript">
						...
						function onclick_modifier(type_reglement_id) {
							msg_util_attente_montrer(true);
							document.getElementById('type_reglement_id').value = type_reglement_id;
					...
					<form name="formulaire_modif" id="formulaire_modif" action="<?php echo $g_chemin_relatif_module; ?>type_reglement_modif.php" method="post">
						<input type="hidden" name="type_reglement_id" id="type_reglement_id" value="0">
					</form>
