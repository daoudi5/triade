...
if(autorisation_module()) {
	...
	if($type_fichier == 'corrige') {
		$fichier_import = "echeance_groupe1.txt";
								...
								<td valign=top align="center">
									...
									<table cellspacing="1" cellpadding="3" border="0" bgcolor="#0b3a0c" width="100%" >
                                    	<tr bgcolor="#ffffff" style="font-size:12px;">
											...
											<th nowrap="nowrap">Sous ligne</th>
											
											<th nowrap="nowrap">Inscription</th>
											<th nowrap="nowrap">Echeancier</th>
											<th nowrap="nowrap">Montant Total</th>
											<th nowrap="nowrap">Inscription</th>
                                        	<th nowrap="nowrap">Scolarité</th>
                                      		<th nowrap="nowrap">Restauration</th>
                                        	<th nowrap="nowrap">Hébergement</th>
                                        	<th nowrap="nowrap">Divers</th>
                                       </tr>
                                       <?php
									   $total_erreur = 0;
                                       for($i=0;$i<count($lignes_associatif);$i++) {
                                       ...
                                       <tr class="tabnormal2" onMouseOver="this.className='tabover';" onMouseOut="this.className='tabnormal2';" style="font-size:8px;<?php echo $style; ?>">
											...
											<td align="left" nowrap="nowrap"><?php echo $lignes_associatif[$i]['sous_ligne']; ?></td>
											<td align="left" nowrap="nowrap"><?php echo $lignes_associatif[$i]['inscription_id']; ?></td>
											<td align="left" nowrap="nowrap"><?php echo $lignes_associatif[$i]['echeancier_id']; ?></td>
											<td align="left" nowrap="nowrap"><?php echo $lignes_associatif[$i]['montant']; ?></td>
											<td align="left" nowrap="nowrap"><?php echo $lignes_associatif[$i]['inscription']; ?></td>
                                        	<td align="left" nowrap="nowrap"><?php echo $lignes_associatif[$i]['scolarite']; ?></td>
                                      		<td align="left" nowrap="nowrap"><?php echo $lignes_associatif[$i]['restauration']; ?></td>
                                       		<td align="left" nowrap="nowrap"><?php echo $lignes_associatif[$i]['hebergement']; ?></td>
                                       		<td align="left" nowrap="nowrap"><?php echo $lignes_associatif[$i]['divers']; ?></td>
                                       </tr>
                                       <?php
									   }
									   ?>
