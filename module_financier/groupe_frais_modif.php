...
if(autorisation_module()) {
	...
	if($operation == "enregistrer") {
		if($groupe_frais_id > 0) {
			$sql= "UPDATE ".FIN_TAB_GROUPE_FRAIS." ";
	...
	//***************************************************************************
		...
		// Rechercher la liste des groupe de frais
				...
				<td valign="top" align="center">
					<form name="formulaire" id="formulaire" action="<?php echo url_script(); ?>" method="post" onSubmit="return valider_le_formulaire();">
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="0" align="center">
							...
							<input type="hidden" name="groupe_frais_id" id="groupe_frais_id" value="<?php echo $groupe_frais_id; ?>">
								...
								<td align="center" colspan="3">
									<table border="0" align="center" cellpadding="4" cellspacing="0">
										<tr>
											...
											?>
											<td align="center">
												<script language="javascript">buttonMagicSubmit("<?php print LANG_FIN_GROUPE_009?>","create");</script>
											</td>
											<?php
											}
											?>
					...
					<form name="formulaire_annuler" id="formulaire_annuler" action="<?php echo $g_chemin_relatif_module; ?>groupe_frais_liste.php" method="post">
					</form>
