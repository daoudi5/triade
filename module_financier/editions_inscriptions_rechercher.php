					...
					?>
						...
						<script language="javascript">
							...
							function onclick_imprimer() {										
									...
									liste_fenetre[liste_fenetre.length] = open('<?php echo site_url_racine(FIN_REP_MODULE); ?>module_financier/editions_inscriptions_rechercher.php?mode_affichage=impression&operation=rechercher&code_class=<?php echo urlencode($code_class); ?>&annee_scolaire=<?php echo urlencode($annee_scolaire); ?>&type_frais_id=<?php echo urlencode($type_frais_id); ?>','fenetre_editer_' + liste_fenetre.length,'width=800,height=600,resizable=yes,scrollbars=yes');
