...
<td bgcolor="#FFFFFF"> <?php print LANGABS65 ?> </td>
</tr>
</table>
<table border="1" bordercolor="#000000" width="100%">
<TR>
...
?>
	...
	<form method=POST>
        <TD align=center><?php print dateForm($data_2[$j][1])?></td>
	<TD align=center>
	<?php
	if ($data_2[$j][4] >= 0) {	
	...
	?>
        ...
        <TD align=center><?php print ucwords($data_2[$j][3])?></td>
	    <TD align=center><input type=submit name=supp_absence value="<?php print LANGBT50 ?>" STYLE="font-family: Arial;font-size:10px;color:#CC0000;background-color:#CCCCFF;font-weight:bold;">
	    <input type=hidden name=saisie_eleve_id_2 value="<?php print $data[$i][3]?>">
        <input type=hidden name=saisie_date_ret_2 value="<?php print $data_2[$j][1]?>">
        <input type=hidden name=saisie_nom_eleve value="<?php print $data[$i][3]?>">
	<input type=hidden name=saisie_time value="<?php print $data_2[$j][9]?>">
	<input type=hidden name=saisie_matiere value="<?php print $data_2[$j][8]?>">
	</td>
	</form>
	</TR>
...
<BR>
<?php 
print "&nbsp;&nbsp;<script language='JavaScript'>buttonMagicRetour2('gestion_abs_retard.php','_self','Retour menu')</script> <br /><br />";
?>
     <!-- // fin  -->
     </td></tr></table>
     <?php
