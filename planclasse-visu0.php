...
$divfin="";
$moins=86;
if ($_POST["format"] == "paysage") {
	print "<div style='position:relative;width:29.7cm;height:21cm;border: 1px black solid;'>";
	$divfin="</div>";	
}
if ($_POST["format"] == "portrait") {
	print "<div style='position:relative;width:21cm;height:29.7cm;border: 1px black solid;'>";
	$divfin="</div>";
}
...
if (isset($_POST["print"])) {
	print "<script>javascript:window.print();</script>";
}
print $divfin;
?>
</BODY>
