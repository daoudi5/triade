...
<br><br>
Afficher le cadre "Résultat d'examen" : <input type='checkbox' name="cadredubas" value='1' <?php print $checkcadre ?> /> <i>(oui)</i>
<br><br>
Afficher la matière "Histoire des arts" : <input type='checkbox' name="histoireart" value='1' <?php print $checkhistoireart ?> /> <i>(oui)</i>
<br><br>
Afficher la matière "Vie scolaire" : <input type='checkbox' name="viescolaire" value='1' <?php print $checkviescolaire ?> /> <i>(oui)</i>
<br><br>
Matière "EPS" via "Examen Brevet" : <input type='checkbox' name="epsviaexamen" value='1' <?php print $checkepsviaexamen ?> /> <i>(oui)</i>
<br><br>
