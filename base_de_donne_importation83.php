...
<font class="T2"><?php print LANGBULL3?> : </font><select name="anneeScolaire" size="1" onChange="document.getElementById('file').disabled=false;" >
<?php
filtreAnneeScolaireSelectFutur(); // creation des options
?>
 </select><br><br><br>

<font class=T2><?php print LANGIMP39?></font> (<b>format : xls</b>) : <br><br> <input type="file" name="fichier" size=20 id='file' disabled='disabled'  >
<br />
<br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;
<script language=JavaScript>buttonMagicSubmit2("<?php print LANGBT23?>","<?php print LANGbasededon2-01 ?>","<?php print LANGBT5?>"); //text,nomInput</script>
