...
<script type="text/javascript" >var mailcontact="<?php 
	...
	<script type="text/javascript" >var urlnomcontact="<?php 
		if ((URLNOMCONTACT != "") && (defined("URLNOMCONTACT"))) { 
			$urlnomcontact=ereg_replace(" ","&nbsp;",URLNOMCONTACT);
			print URLNOMCONTACT; 
		}else{ 
			print ""; 
		} ?>"; </script>
...
<table border="1" bgcolor=#FFFFFF  bordercolor="#000000" cellpadding="3" cellspacing="1" width="100%"  height="85" style="-moz-box-shadow: 10px 10px 5px #656565; -webkit-box-shadow: 10px 10px 5px #656565; -o-box-shadow: 10px 10px 5px #656565; box-shadow: 10px 10px 5px #656565; filter:progid:DXImageTransform.Microsoft.Shadow(color='#6565', Direction=135, Strength=5);border-radius: 25px ; -webkit-border-radius: 25px; -moz-border-radius: 25px; "    >
...
<a href="http://www.triade-educ.com" target="_blank">www.triade-educ.com</a>
</ul>
<!-- // fin de la saisie -->
<br><br>
</TD></TR></table>
