...
<tr><td><img src="./image/commun/kitwarning.gif" /></td>
    <td width=300><font color=red> Ne sont archivés que les notes, disciplines, entretiens, absences et retards. (Pour les bulletins vous devez les sauvegarder sur votre ordinateur.)</font></td></tr>
</table>
</ul>
<?php 
...
if (!file_exists("./data/archive/archive_${annee}.sql")) {
	$bouton="Effectuer";
	$attention="";
}else{
...
<?php
		print "<form method='post' action='archivage33.php' >";
		print $attention;
		print "<table align='center'>";
		print "<tr><td>";
		?>
		<script language=JavaScript>buttonMagicSubmit3("<?php print $bouton ?>",'etape1',"onclick='this.value=\"<?php print LANGBT5 ?>\";AfficheAttente()'");</script> 
		<?php
		print "</td></tr>";
		print "</table>";
