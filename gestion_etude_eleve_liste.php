...
<tr id='coulBar0' ><td height="2"><b><font   id='menumodule1' ><?php print LANGETUDE28 ?></font></b></td>
</tr>
<tr id='cadreCentral0'>
<td valign=top>
<!-- // fin  -->
...
?>
	...
	<td valign=center align=center bordercolor="#FFFFFF" >
        <input type=button onclick="open('gestion_etude_liste_eleve2.php?id=<?php print $data[$i][0]?>','listeE','width=490,height=500,scrollbars=yes')" name="supp" value="<?php print LANGETUDE31 ?>" class="bouton2" >
<br><br>
        <input type=button onclick="open('planclasseetude.php?id=<?php print $data[$i][0]?>','_blank','width=800,height=600,resizable=yes,scrollbars=yes')" name="supp" value="<?php print "Plan étude" ?>" class="bouton2" >
        </form>
        </td>
	</tr>
