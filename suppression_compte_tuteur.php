...
if(isset($_POST["supp"])):
	$personne=recherche_personne($_POST["saisie_pers_supp"]);
		...
		reload_page('suppression_compte_tuteur.php');
        else:
                error(0);
        endif;
endif;
...
<form method=post onsubmit="return valide_supp_choix('saisie_pers_supp','<?php print LANGSUPP11?>')" name="formulaire">
<table border="0" cellpadding="3" cellspacing="1" width="100%" bgcolor="#0B3A0C" height="85">
<tr id='coulBar0' ><td height="2"><b><font   id='menumodule1' >
<?php print LANGSUPP9." "."Tuteur de stage"?></font></b></td>
</tr>
<tr id='cadreCentral0' >
<td >
<blockquote><BR>
...
<?php
select_personne('TUT'); // creation des options
Pgclose();
?>
</select> <BR><br>
