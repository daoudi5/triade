...
<td bgcolor="#FFFFFF"><?php print LANGDISC29 ?></td>
</tr>
</table>
<table border="1" bordercolor="#000000" width="100%" style="border-collapse: collapse;" >
<TR>
...
<input type=submit value="<?php print LANGDISC31?><?php print ucwords(trim($data[$i][1])) ?>" onclick="this.value='<?php print LANGattente2?>'"  STYLE="font-family: Arial;font-size:10px;color:#CC0000;background-color:#CCCCFF;font-weight:bold;"  >
</form>
</center>
<?php
        }
