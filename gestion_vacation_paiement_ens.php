...
<?php print "Paiement de vacation d'un enseignant" ?></font></b></td>
</tr>
<tr id='cadreCentral0'>
<td >
<br><br>
<form method="post" action="gestion_vacation_paiement_ens2.php" onsubmit="return valide_supp_choix('saisie_pers_supp','<?php print LANGSUPP13?>')" name="formulaire" >
<blockquote>
<fieldset><legend><?php print "Choix de l'enseignant"?></legend>
&nbsp;&nbsp;
<font class="T2"><?php print LANGNA1." ".LANGNA2?>  :</font> <select name="saisie_pers">
