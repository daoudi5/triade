...
/*--------------------------------------------------------------------------------
Pour crÃƒÂ©er l'objet on a 2 maniÃƒÂ¨res :
soit on donne les valeurs d'un format personnalisÃƒÂ© en les passant dans un tableau
soit on donne le nom d'un format AVERY
--------------------------------------------------------------------------------*/

// Exemple avec un format personnalisÃƒÂ©
if ($id_vignette == 1) {
