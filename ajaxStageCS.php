...
if($HTTP_RAW_POST_DATA != "") {
        list($a,$b,$c,$d)=split('&',$HTTP_RAW_POST_DATA); // here you will get variable $foo
        list($null,$valeur)=split('=',$a);
        $p=$valeur;
        list($null,$valeur)=split('=',$b);
        $productid=$valeur;
        list($null,$valeur)=split('=',$c);
        $identreprise=$valeur;
        list($null,$valeur)=split('=',$d);
        $info=$valeur;
