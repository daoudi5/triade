...
if ( ($id_user > 0) and ($n_version > 0) )
{
  ...
  if ($t_sharefiles == "")
  {
    die(">F148#KO#2#"); // 2: n'a pas les droits (option non activée).
  }
  */
  //
  //
  ...
  {
    echo ">F148#OK####|";
    while( list ($id_media, $media_name) = mysql_fetch_row ($result) )
    {
      echo f_encode64("#" . $id_media . "#" . $media_name . "#") . "|"; // séparateur de ligne : '|' (pipe).
    }
  }
  else
  {
