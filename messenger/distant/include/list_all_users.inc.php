...
if ( ($id_user > 0) and ($version > 18) and ($ip != "") )
{
  ...
  {
    if (f_verif_id_session_id_user($id_user, $id_session) <> 'OK')    die(">F18#KO#1#"); // 1:session non ouverte.
  }
  //
  //
  ...
  {
    echo ">F18#OK####|";
    while( list ($id_user_2, $user_name, $nickname, $name, $level, $country_code, $language_code, $avatar, $timeshift, $email, $phone, $gender, $usr_rating, $usr_id_role) = mysql_fetch_row ($result) )
    {
