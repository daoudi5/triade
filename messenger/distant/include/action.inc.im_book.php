...
if ($pass != "")
{
  ...
  {
    write_log("error_acces_no_pass", "Pass : " . $pass ); 
  }
  else
  {
    if ( (_PASSWORD_FOR_PRIVATE_SERVER == '') and (_ALLOW_AUTO_ADD_NEW_USER_ON_SERVER != '') and (_IM_ADDRESS_BOOK_PASSWORD != '') and (_ENTERPRISE_SERVER == "") )
    {
