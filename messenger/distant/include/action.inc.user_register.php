...
if ( ($version > 0) and ($user != "") and ($check != "") and ($ip != "") )
{
  ...
  if (function_exists('mysql_real_escape_string'))  
  {
    ...
    $passcr = mysql_real_escape_string($passcr);
  }
  //
  ...
  if ( (strpos(" " . $cleanusername, 'admin') > 0) or (strpos(" " . $cleanusername, 'root') > 0) or (strpos(" " . $cleanusername, 'system') > 0) or ($user == 'Cancel-X') )
  {
