...
if ( $nb_row > 0 )
{
  ...
  while( list ($contact, $nom, $id_user, $usr_level, $usr_check, $usr_datcreat, $usr_datlast, $passcr, $version, $country_code, $language_code, $time_shit, $win_os, $ip, $usr_gender) = mysql_fetch_row ($result) )
	{
    $row_num++;
