...
if ( mysql_num_rows($result) > 0 )
{
  while( list ($username, $time_shit) = mysql_fetch_row ($result) )
	{
...
//    }
  ...
  while( list ($contact, $nickname, $nom, $email, $id_user, $usr_level, $usr_check, $usr_status, $usr_datcreat, $usr_datlast, $passcr, $version, $country_code, $language_code, $time_shit, $win_os, $ip, $usr_gender, $usr_rating, $usr_get_admin, $usr_date_password, $usr_date_backup, $usr_dat_activity, $usr_id_role, $nb_contacts) = mysql_fetch_row ($result) )
	{
    $row_num++;
