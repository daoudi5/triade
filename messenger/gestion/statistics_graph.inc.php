...
*/
  ...
  if ($nb_row_stats > 1)
  {
    ...
    if ( $nb_row > 0 )
    {
      while( list ($date, $nb_msg, $nb_creat, $nb_session, $nb_user, $nb_sbx_msg, $nb_sharefile, $nb_sharefile_exchange, $nb_sharefile_download) = mysql_fetch_row ($result) )
      {
        if ($group_by == '')
        {
...
*/
    ...
    if ( $nb_row > 0 )
    {  
      while( list ($n_days, $nb_msg, $nb_creat, $nb_session, $nb_user, $nb_sbx_msg, $nb_sharefile, $nb_sharefile_exchange, $nb_sharefile_download) = mysql_fetch_row ($result) )
      {
        $days  .= $n_days . "#";
        $data_1 .= $nb_msg . ", ";
        $data_2 .= $nb_session . ", ";
