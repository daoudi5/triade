...
if ( _ENTERPRISE_SERVER != '' )
{
  ...
  if ( $nb_row > 0 )
  {
    ...
    while( list ($id_user, $usr_online, $username, $nickname, $nom, $usr_datlast, $version, $ip, $country_code, $win_os, $computername, $mac_adr, $screen_size, $emailclient, $browser, $ooo) = mysql_fetch_row ($result) )
    {
      $row_num++;
