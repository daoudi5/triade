...
<script language='Javascript' type='text/javascript'>
  document.getElementById('attente').className="section_to_hide";
  document.getElementById("graph_session").className="section_to_show";
  document.getElementById('graph_user').className="section_to_show";
  document.getElementById('graph_create').className="section_to_show";
  document.getElementById('graph_message').className="section_to_show";
  document.getElementById('graph_week').className="section_to_show";
