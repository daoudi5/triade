...
if ( _SHARE_FILES != '' )
{
  ...
  if ( $nb_row > 0 )
  {
    ...
    */
    ...
    while( list ($id_file, $fil_name, $fil_size, $fil_date, $fil_date_add, $fil_date_trash, $fil_hash, $usrname_auth, $nickname_auth, $usrname_dest, $nickname_dest, $id_user_aut, $id_user_dest, $fmd_name, $fil_compress, $fil_comment) = mysql_fetch_row ($result) )
    {
      $row_num++;
