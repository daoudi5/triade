...
*/
    ...
    while( list ($id_file, $fil_name, $fil_size, $fil_date, $fil_date_add, $fil_nb_download, $fil_hash, $usrname_auth, $nickname_auth, $id_user_aut, $fmd_name, $id_filemedia, $fpj_name, $id_project, $id_group_dest, $fil_rating, $fil_compress, $fil_comment) = mysql_fetch_row ($result) )
    {
      $row_num++;
        ...
        echo "</TD><TD WITH='50%' ALIGN='RIGHT' VALIGN='TOP'>\n"; //-----------------------
            ...
            if ( ($id_project_only <= 0) or ($id_media_only <= 0) )
            {
              ...
              if ( mysql_num_rows($result) > 0 )
              {
                ...
                echo "</TD></TR>";
                while( list ($id_media, $media_name, $nbre) = mysql_fetch_row ($result) )
                {
                  echo "<TR>";
                  echo "<TD ALIGN='LEFT' class='row2'>";
                  echo "<font face='verdana' size='2'>";
