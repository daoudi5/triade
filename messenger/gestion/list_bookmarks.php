...
if ( _BOOKMARKS != '')
{
  ...
  if ( mysql_num_rows($result) > 0 )
  {
    ...
    $last_group = "";
    $id_book_max = 0;
    while( list ($id_book, $id_aut, $bmk_url, $bmk_title, $bmk_date, $bmk_rating) = mysql_fetch_row ($result) )
    {
  ...
  if ($only_pending == "")
  {
    ...
    */
    ...
    if ( mysql_num_rows($result) > 0 )
    {
      ...
      while( list ($id_book, $id_aut, $bmk_url, $bmk_title, $bmk_date, $bmk_rating, $id_categ) = mysql_fetch_row ($result) )
      {
