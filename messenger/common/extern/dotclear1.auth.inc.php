...
define("_EXTERNAL_AUTHENTICATION_NAME", "Dotclear 1");
...
function f_external_authentication($t_user, $t_pass)
{
  ...
  {
    // Si Dotclear 1 n'est pas sur le même serveur ou la même base de donnée.
    mysql_close();
  ...
  if (!$result) error_sql_log("[ERR-T44a]", $requete);
