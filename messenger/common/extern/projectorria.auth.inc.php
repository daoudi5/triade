...
define("_EXTERNAL_AUTHENTICATION_NAME", "Project`Or RIA");
...
function f_external_authentication($t_user, $t_pass)
{
  ...
  {
    // Si Project'Or RIA n'est pas sur le même serveur ou la même base de donnée.
    mysql_close();
    require("extern.sql.inc.php");
  }
   //
  $requete  = " select LOWER(name), password FROM " . $extern_prefix . "resource ";
