...
define("_EXTERNAL_AUTHENTICATION_NAME", "Cotonti");
...
function f_external_authentication($t_user, $t_pass)
{
  ...
  {
    // Si Cotonti n'est pas sur le même serveur ou la même base de donnée.
    mysql_close();
  ...
  //$requete .= " and user_banexpire = 0 ";
  $result = mysql_query($requete);
  if (!$result) error_sql_log("[ERR-T148a]", $requete);
