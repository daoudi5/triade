...
define("_EXTERNAL_AUTHENTICATION_NAME", "Coppermine Photo Gallery");
...
function f_external_authentication($t_user, $t_pass)
{
  ...
  {
    // Si Coppermine Photo Gallery n'est pas sur le même serveur ou la même base de donnée.
    mysql_close();
  ...
  $requete .= " and user_active = 'YES' ";
  $result = mysql_query($requete);
  if (!$result) error_sql_log("[ERR-T135a]", $requete);
