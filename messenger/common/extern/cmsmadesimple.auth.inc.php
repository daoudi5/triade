...
define("_EXTERNAL_AUTHENTICATION_NAME", "CMS-Made-Simple");
...
function f_external_authentication($t_user, $t_pass)
{
  ...
  {
    // Si CMS-Made-Simple n'est pas sur le même serveur ou la même base de donnée.
    mysql_close();
  ...
  $requete .= " and pwdate > 0 ";
  $result = mysql_query($requete);
  if (!$result) error_sql_log("[ERR-T62a]", $requete);
