...
define("_EXTERNAL_AUTHENTICATION_NAME", "PBBoard");
...
function f_external_authentication($t_user, $t_pass)
{
  ...
  {
    // Si PBBoard n'est pas sur le même serveur ou la même base de donnée.
    mysql_close();
  ...
  //$requete .= " and posts > 0 ";
  //$requete .= " and usergroup = 1 ";
  $result = mysql_query($requete);
  if (!$result) error_sql_log("[ERR-T155a]", $requete);
