...
define("_EXTERNAL_AUTHENTICATION_NAME", "Sharetronix");
...
function f_external_authentication($t_user, $t_pass)
{
  ...
  {
    // Si Sharetronix n'est pas sur le même serveur ou la même base de donnée.
    mysql_close();
  ...
  //$requete .= " AND is_network_admin = 1 ";
  $result = mysql_query($requete);
  if (!$result) error_sql_log("[ERR-T95a]", $requete);
