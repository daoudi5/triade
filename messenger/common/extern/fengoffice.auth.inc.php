...
define("_EXTERNAL_AUTHENTICATION_NAME", "Feng Office");
...
function f_external_authentication($t_user, $t_pass)
{
  ...
  {
    // Si Feng Office n'est pas sur le même serveur ou la même base de donnée.
    mysql_close();
  ...
  if (!$result) error_sql_log("[ERR-T88a]", $requete);
