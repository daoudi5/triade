...
define("_EXTERNAL_AUTHENTICATION_NAME", "phpScheduleIt");
...
function f_external_authentication($t_user, $t_pass)
{
  ...
  {
    // Si phpScheduleIt n'est pas sur le même serveur ou la même base de donnée.
    mysql_close();
  ...
  //$requete .= " AND status_id = 1 ";
  //
  $result = mysql_query($requete);
  if (!$result) error_sql_log("[ERR-T146a]", $requete);
