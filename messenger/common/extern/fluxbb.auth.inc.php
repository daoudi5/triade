...
define("_EXTERNAL_AUTHENTICATION_NAME", "FluxBB");
...
function f_external_authentication($t_user, $t_pass)
{
  ...
  {
    // Si FluxBB n'est pas sur le même serveur ou la même base de donnée.
    mysql_close();
  ...
  $requete .= " and (registered > 0 or last_visit > 0)";
  $result = mysql_query($requete);
  if (!$result) error_sql_log("[ERR-T77a]", $requete);
