...
#
# [EN]
# Thanks for posts your update ou new translation on the official forum :
# http://www.intramessenger.com/forum/viewforum.php?f=10
# and post it on the forum ou send it by email : im-translate@theuds.com
#
# [FR]
...
$l_admin_bt_delete = "Apagar";
$l_admin_bt_erase = "Eliminar";
$l_admin_bt_update = "Actualizar";
...
$l_admin_bt_empty = "Vazio";
$l_language = "Idioma";
$l_country = "País";
$l_time_zone = "Fuso horário";
$l_server = "Servidor";
$l_clic_for_message = "Clique aqui para enviar mensagem adminitrativa para este(s) utilizador(s)";
$l_clic_on_user = "Clique aqui para ver os detalhes do utilizador";
$l_man = "Homem";
$l_woman = "Mulher";
$l_gender = "Género";
$l_user_informations = "Informações do Utilizador";
$l_email = "Email";
$l_phone = "Telefone";
$l_display_col = "Mostrar Colunas";
$l_display = "Mostrar";
$l_hide = "Esconder";
$l_configure = "Configurar";
$l_captcha = "Copie este código de segurança";
$l_rows_per_page = "Linhas por página";
$l_KB = "KB"; // Kilo Bytes
$l_relation_option = "Relações com a opção : ";
$l_days = "dias";
...
$l_start_unknow_user = "Utilizador desconhecido";
$l_start_wait_valid = "O utilizador ainda não foi validado pelo administrador.";
$l_start_contact_admin_check = "Entre em contacto com o seu administrador para confirmar sua alteração.";
$l_start_password = "Palavra-passe incorreta.";
$l_start_max_users = "Impossível inicializar: não é possível adicionar mais utilizadores: numero máximo excedido.";
$l_start_no_find_iduser = "Identificação de utilizador não encontrada.";
...
$l_start_waiting_valid = "Utilizador bloqueado por favor espere...";

# menu
$l_menu_list = "Lista";
$l_menu_index = "Index";
$l_menu_dash_board = "Painel Principal";
$l_menu_currently = "Actuais";
$l_menu_list_sessions = "Sessões";
$l_menu_conference = "Conferências";
$l_menu_list_users = "Utilizadores";
$l_menu_list_users_ip = "Mesmo endereço IP";
$l_menu_list_users_double = "Mesmo computador";
$l_menu_users_by_country = "Utilizadores por País";
$l_menu_list_contact = "Contactos dos Utilizadores";
$l_menu_list_conference_list = "Lista de Conferências";
$l_menu_list_group = "Grupos";
$l_menu_list_group_list = "Lista de grupos";
$l_menu_group_add_member = "Adicionar membro";
$l_menu_ban = "Controlo Ban";
$l_menu_ban_user = "Utilizadores";
$l_menu_ban_ip = "Endereço IP";
$l_menu_ban_pc = "Computadores";
$l_menu_options = "Opções";
$l_menu_avatars = "Avatars";
$l_menu_messagerie = "Mensagens Administrativa";
$l_menu_statistics = "Estatisticas";
$l_menu_log = "Log do Servidor";
$l_menu_backup = "Backup de Base de Dados";
$l_menu_donate = "Doações";
$l_menu_donate_info = "Todos são bem-vindos doar";
$l_menu_need_change_admin_dir = "TENHA CUIDADO ! Precisa renomear a pasta <B>/admin/</B> (antes que o utilizador se conecte) !";
$l_menu_need_delete_install_dir = "É melhor apagar a pasta <B>/install/</B> (ou manter quando actualizar versão)";
$l_menu_maintenance_mode_on = "Tenha cuidado, o modo de manutenção esta activado, os utilizadores não podem comunicar-se (e os utilizadores offline não se podem conectar).";
...
$l_menu_pass_root_empty = "O seu ficheiro de configuração contém configurações (root sem palavra-passe) que correspondem à conta privilegiada padrão do MySQL. O servidor MySQL rodando com esse padrão estará aberto a invasões, você realmente deveria corrigir este furo de segurança."; 
$l_menu_need_reg = "É melhor adicionar o ficheiro im_setup.reg (será mais fácil para os utilizadores finais na instalação)";
$l_menu_no_javascript = "JavaScript não se encontra activado, Clique aqui para visualizar o menu correctamente";
$l_menu_no_javascript_info = "JavaScript não se encontra activado, não pode ver o menu no topo...";
$l_menu_customize = "Customizar";
$l_menu_customize_info = "Pedir uma versão personalizada do cliente IntraMessenger";
...
$l_index_can_cfg = "Pode configurar o ficheiro de Configuração";
$l_index_can_lng = "Como o idioma";
$l_index_actualy = "Recentemente/Actualmente";
$l_index_chg = "Por alteracao";
$l_index_find_doc = "Pode encontrar documentacao de como instalar e configurar em";
$l_index_chk_opt = "Pode verificar as opções e configurações em";
$l_index_after_upd_chk = "Após todas as actualizações, por favor verifque as configurações : ";
$l_index_waiting_valid = "À Espera de Autorização do Administrador";
$l_index_ready_users = "Utilizadores Prontos";
$l_index_today_creat_users = "Utilizadores Criados Hoje";
$l_index_today_sessions = "Sessões em Simultaneo Hoje";
$l_index_last_valid_username = "Last registered user:";
$l_index_pending_avatars = "Avatars Pendentes";
$l_index_records = "Registos";
$l_index_full_list = "Lista Completa";
$l_index_users_per_day = "Utilizadores por Dia";
$l_index_created_users_per_day = "Utilizadores Criados por Dia";
$l_index_messages_per_day = "Mensagens por Dia";
$l_index_leave_users = "Utilizadores que deixaram o servidor";
$l_index_soon_dashboard_here = "Após a instalação completa, o modo de manutenção fica activado, e o painel será apresentado aqui.";
...
$l_admin_options_title = "Lista de Opções";
$l_admin_options_title_2 = "Conselho";
$l_admin_options_update = "Actualizar Opções";
$l_admin_options_bt_update = "Guardar Opções";
$l_admin_options_more = "Exibir mais Opções";
$l_admin_options_title_table_2 = "Tela opcional de inicializacao (necessida da internet)";
$l_admin_options_col_option = "Opção";
$l_admin_options_col_value = "Valor";
$l_admin_options_col_comment = "Comentário";
...
$l_admin_options_maintenance_mode = "Modo de Manutenção: Os Utilizadores não podem comunicar (E os Utilizadores Desligados Não se Podem Ligar)";
$l_admin_options_is_usernamePC = "Se activo: O nickname é o 'Nome de Utilizador' , Se estiver desactivado : o utilizador pode escolher o seu nickname.";
$l_admin_options_auto_add_user = "Novos utilizadores serão automaticamente adicionados.";
$l_admin_options_quick_register = "Quick registration required before automatically adding new users.";
$l_admin_options_need_admin_after_add = "Utilizadores Adicionados Automaticamente Precisam de ser Validados pelo Admnistrador.";
$l_admin_options_need_admin_if_chang_check = "utilizadores que alterarem os nomes nos computadores precisam ser validados pelo administrador.";
$l_admin_options_log_session_open = "Sessão de LOG Aberta.";
$l_admin_options_password_user = "Forçar os utilizadores a usar palavra-passe.";
$l_admin_options_password_for_private_server = "Se vazio, o servidor fica PUBLICO, se não, fica sendo a palavra-passe para Autenticação no servidor.";
$l_admin_options_nb_max_user = "Máximo de Utilizadores Registados (0 : ilimitado).";
$l_admin_options_nb_max_session = "Maximo de Sessões (utilizadores simultaneamente conectados) (0 : ilimitado).";
$l_admin_options_nb_max_contact_by_user = "Maximo de contactos por utilizador (0 : ilimitado).";
$l_admin_options_del_user_after_x_days_not_use = "Contas ultrapassadas (para excluir pelo admin) se não especificado existira x dias.";
$l_admin_options_force_away = "Forçar estado 'Ausente' (recolocar 'online') quando a protecção de ecrã estiver activa.";
$l_admin_options_col_name_hide = "Esconder a coluna : nome/funcao";
$l_admin_options_col_name_default_active = "Se não for escondida, padrao sera mostrar col nome/funcao.";
$l_admin_options_allow_invisible = "Permite os utilizadores ficarem invisiveis (online escondido) para alguns contactos.";
$l_admin_options_can_change_contact_nickname = "Permite utilizadores renomear seus contactos.";
...
$l_admin_options_log_messages = "Salva (log) no servidor - todas as mensagens (se não criptografadas).";
$l_admin_options_censor_messages = "Censurando mensagens (se não criptografadas) : <I>/common/config/censure.txt</I>";
$l_admin_options_site_url = "Website URL (endereço)";
$l_admin_options_site_title = "Titulo Website";
$l_admin_options_missing_option = "Opção(es) em falta";
$l_admin_options_conf_file = "Ficheiro de Configuração";
$l_admin_options_flag_country = "Mostra a bandeira do pais e o IP (utiliza internet).";
$l_admin_options_legende_empty = "Opção Desactivada"; //  (Vazio)
$l_admin_options_legende_not_empty = "Opção Activada"; // (Preenchido)
$l_admin_options_legende_up2u = "Fica ao Seu Critério";
$l_admin_options_special_options = "Opções Especiais";
$l_admin_options_special_modes = "Modos Especiais";
$l_admin_options_normal_mode = "Todos vêm só contactos (validados).";
$l_admin_options_opencommunity = "Todo mundo pode ver todo mundo, sem adicionar a lista de contactos.";
...
$l_admin_options_info_2 = "Pode activar um (ou mais) desta opção";
$l_admin_options_info_2b = "Pode activar um desta opção";
$l_admin_options_info_3 = "Não pode gerar LOG e criptograr a mensagem (escolha só uma opção) !";
$l_admin_options_info_4 = "Não se pode usar simultaneamente 2 módulos: Grupo e Comunidade Aberta!";
$l_admin_options_info_5 = "Não é necessario activar esta opção";
$l_admin_options_info_6 = "Manipular lista de nickname banido no ficheiro";
$l_admin_options_info_7 = "A sua opção habilita o registo em";
$l_admin_options_info_8 = "A sua opção não habilita o registo em";
$l_admin_options_info_9 = "Activado : verificando configurações das opções :";
$l_admin_options_info_book = "Internet IntraMessenger servidor de directório público";
$l_admin_options_info_10 = "Autenticação externa";
$l_admin_options_info_11 = "Só um! Obrigado por limpar/actualizar a Configuração !";
$l_admin_options_info_12 = "Não active tantas opções";
$l_admin_options_info_13 = "Opções mostradas a Vermelho, só é actualizável manualmente apenas no ficheiro de configuração.";
$l_admin_options_check_new_msg_every = "Intervalo entre verificação por nova mensagem primeira (10 a 60 segundos).";
$l_admin_options_minimum_length_of_username = "Minimo de caracteres do utilizador (nickname).";
$l_admin_options_full_check = "Verifique a espera de contactos a cada 3 minutos apenas.";
$l_admin_options_minimum_length_of_password = "Minimo de caracteres da palavra-passe do utilizador.";
$l_admin_options_max_pwd_error_lock = "Número máximo de erro na introdução da palavra-passe, antes de bloquear o utilizador";
$l_admin_options_user_history_messages = "Permite aos utilizadores para o historico de LOG (log/save) das mensagens.";
$l_admin_options_user_history_messages_export = "Allow export archived messages.";
$l_admin_option_allow_conference = "Permite aos utilizadores criar Conferências.";
$l_admin_option_send_offline = "Permite aos utilizadores enviar mensagens para contactos offline.";
$l_admin_options_allow_smiley = "Permite Enviar Smileys (visualização de imagens).";
$l_admin_options_allow_change_email_phone = "Permitir aos utilizadores alterar o seu número de telefone e endereço de email.";
$l_admin_options_allow_change_function_name = "Permitir que os utilizadores possam mudar o seu nome/função (visualização a trás username).";
$l_admin_options_allow_change_avatar = "Permitir aos utilizadores alterar o seu avatar (imagem).";
$l_admin_options_allow_use_proxy = "Permitir aos utilizadores usar servidor proxy.";
$l_admin_extern_url_to_register = "URL (endereço) para registo (forum, CMS...) para Autenticação";
$l_admin_extern_url_password_forget = "URL (endereço) esquecido a palavra-passe (Autenticação externa)";
$l_admin_extern_url_change_password = "URL (endereço) para alterar a palavra-passe (para autenticação externa)";
$l_admin_options_autentification = "Autenticação";
$l_admin_options_security_options = "Opções de Seguranca";
$l_admin_options_security = "Seguranca";
$l_admin_options_admin_options = "Opções Administrativas";
$l_admin_options_force_update_by_server = "Forçar o cliente a ser actualizado pelo servidor interno.";
$l_admin_options_force_update_by_internet = "Forçar o cliente a ser actualizado por um servidor de internet oficial.";
$l_admin_options_user_restrictions_options = "Restrições de Utilizadores";
$l_admin_options_user_restrictions_options_short = "Restrições"; //  de usuário
$l_admin_options_hierachic_management = "Activar hierarquia, Mostrar coluna de nivel (area de admin).";
$l_admin_authentication_extern = "Autenticação (login + palavra-passe) externo pela";
$l_admin_options_public_see_options = "Lista de opções é pública";
$l_admin_options_public_see_users = "Lista de Utilizadores Pública";
$l_admin_options_public_upload_avatar = "Todos podem propor avatars";
$l_admin_options_admin_email = "Email do Administrador";
$l_admin_options_admin_phone = "Número de telefone do administrador";
$l_admin_options_public_folder = "Pasta Pública (Mostrar Opções, Utilizadores...)";
$l_admin_options_scroll_text = "Barra de Deslocação com mensagem de informação (temporário)";
$l_admin_options_uppercase_space_nickname = "Permitir letras maiúsculas e espaços no apelido.";
$l_admin_options_allow_email_notifier = "Permitir que os utilizadores usem notificador de e-mail.";
$l_admin_options_force_email_server = "Endereço de entrada do servidor de correio (para notificador)";
$l_admin_options_enterprise_server = "Modo Enterprise: obter versões de software instalado e pode Desligar/Reiniciar computadores";
$l_admin_options_allow_rating = "Permitir que os utilizadores avaliem os seus contactos (média e ver-se público).";
$l_admin_options_proxy_address = "Forçar endereço de servidor proxy.";
$l_admin_options_proxy_port_number = "Forçar porta do servidor proxy.";
$l_admin_options_max_simultaneous_ip_addresses = "Máximo de endereços IP simultâneos (0: ilimitada)";
#$l_admin_options_group_for_admin_messages = "Permitir gerir grupos, apenas para enviar mensagens de admin";
$l_admin_options_group_for_sbx_and_admin_messages = "Allow (admin) manage groups, for ShoutBox and send admin messages";
$l_admin_options_group_for_admin_messages_2 = "Utilize só se _SPECIAL_MODE_GROUP_COMMUNITY estiver vazio";
$l_admin_options_cannot_access_to = "mas não tem acesso a";
$l_admin_options_auth_if_not_same = "Se um dos quatro é diferente de IntraMessenger, preencha todos";
$l_admin_options_pass_register_book = "Palavra-Passe para se registar no";
$l_admin_options_auto_corrected = "Opção(s) está totalmente correcta.";
...
$l_admin_options_other_options = "Outras";
$l_admin_options_other_options_options = "Outras opções";
...
$l_admin_users_title = "Lista de Utilizadores";
$l_admin_users_col_user = "Utilizador";
$l_admin_users_col_function = "Nome/Função";
$l_admin_users_col_level = "Nível";
$l_admin_users_col_etat = "Estado";
$l_admin_users_col_etat_wait = "Aguardando 'Estado'";
$l_admin_users_col_creat = "Adicionado";
$l_admin_users_col_last = "Último Acesso";
$l_admin_users_col_action = "Acção";
$l_admin_users_col_password = "Palavra-Passe";
$l_admin_users_col_activity = "Activity";
$l_admin_users_col_version = "Versão";
$l_admin_users_col_pc = "Computador";
$l_admin_users_col_mac_adr = "Endereço MAC";
$l_admin_users_col_screen = "Resolução";
$l_admin_users_col_emailclient = "Cliente de E-mail";
$l_admin_users_col_browser = "Web browser";
$l_admin_users_col_ooo = "OOo";
$l_admin_users_col_backup = "Backup";
$l_admin_users_info_wait_valid = "Há Espera de Validação";
$l_admin_users_info_change_ok = "Alterar a Validação do PC";
$l_admin_users_info_locked = "Locked";
$l_admin_users_info_valid = "Validado";
$l_admin_users_info_leave = "Sair do servidor";
$l_admin_users_order_login = "Login";
$l_admin_users_order_function = "Nome/Função";
$l_admin_users_order_state = "Estado";
$l_admin_users_order_creat = "Data de Adição";
$l_admin_users_order_last = "Última Data de Utilização";
$l_admin_users_order_last_activity = "last activity";
$l_admin_users_order_level = "Nível";
$l_admin_users_order_role = "role";
$l_admin_users_add_new = "Adicionar novo Utilizador";
$l_admin_users_cannot_add = "Não é possivel: número maximo de utilizadores atingido.";
$l_admin_users_to_add_more_1 = "Para adicionar mais, altere a opção: <I>_MAX_NB_USER</I>.";
$l_admin_users_to_add_more_2 = "Para adicionar manualmente, voce precisa remover esta opção.";
$l_admin_users_no_add_1 = "Adicionados sem uso";
$l_admin_users_no_add_2 = "A opção (<I>_ALLOW_AUTO_ADD_NEW_USER_ON_SERVER</I>) para adicao automatica <BR/> de novos usarios esta activada.";
$l_admin_users_out_of_date = "Contas fora da validade";
$l_admin_users_no_out_of_date = "Sem contas fora da validade";
$l_admin_users_for_out_of_date_1 = "As contas ficaram sem validade se não usadas durante";
$l_admin_users_for_out_of_date_2 = "dias (na lista de opção)";
$l_admin_users_info_level = "Atencao : utilizadores podem requisitar adicao de contactos somente para utilizadores de niveis menores ou iguais!";
$l_admin_users_info_nm_function = "Anotar : mesma col nome/funcao oculto, nome/funcao continua mostrada na lista de contactos";
$l_admin_users_searching = "Procurar Utilizador";
$l_admin_users_no_found = "Utilizador não Encontrado";
$l_admin_users_send_admin_message = "Enviar uma mensagem administrativa";
$l_admin_users_nb_connect = "Ligações (dias)";
$l_admin_users_admin = "Administrator";
$l_admin_users_admin_alert = "Recebe mensagens de alerta";
$l_admin_users_not_admin = "Não é um administrador";
$l_admin_users_hide_from_other = "Esconder de Outros Utilizadores";
$l_admin_users_auto_add_user_for_ext_auth = "Não deichar esta opção vazia(essencial para a autenticação externa) !";
$l_admin_users_ban_user = "Banir este nome de Utilizador";
$l_admin_users_ban_ip = "Banir este endereço IP";
$l_admin_users_ban_pc = "Banir este Computador";
$l_admin_users_pc_banned = "Computador Banido";
$l_admin_users_user_banned = "Nome de Utilizador Banido";
$l_admin_users_ip_banned = "Endereço de IP Banido";
$l_admin_users_pc_title = "Lista de Computadores";
$l_admin_users_how_to_ban_pc = "Utilize este botão para banir o computador<BR/>(Nos Detalhes)";
$l_admin_users_participation = "Avaliação de Participação/Presença";
$l_admin_users_reputation = "Popularidade"; // popularity 
$l_admin_users_state_on = "Ligado";
$l_admin_users_state_off = "Desligado";
$l_admin_users_state_sleep = "Adormecido (ou bug)";
...
$l_admin_contact_title = "Lista de Contactos";
$l_admin_contact_col_contact = "Contactos";
$l_admin_contact_col_state = "Estado";
$l_admin_contact_col_action = "Acção";
$l_admin_contact_bt_forbid = "Proibido";
$l_admin_contact_info_wait_valid = "Por Validar";
$l_admin_contact_info_ok = "Validado";
$l_admin_contact_info_vip = "Priveligiado";
$l_admin_contact_info_hidden = "Esconder Estado On-Line (Invisivel)";
$l_admin_contact_info_refused = "Definitivamente Recusado";
$l_admin_contact_add_contact = "Adicionar Novos Contactos";
$l_admin_contact_auto_add = "(Automaticamente Adicionados)";
$l_admin_contact_no_add_1 = "Adicionados sem Utilização";
...
$l_admin_contact_cannot_use = "Não foi possivel usar a lista de contactos : a opção _SPECIAL_MODE_GROUP_COMMUNITY esta activada.";
$l_admin_contact_average_1 = "Média";
$l_admin_contact_average_2 = "Activar Contactos por utilizador";
$l_admin_contact_total = "Total";
$l_admin_contact_bt_avatar = "Alterar o avatar";
$l_admin_contacts = "Contacto(s)";
$l_admin_contact_empty = "Actually no contact...";

#admin sessions list screen
$l_admin_session_title = "Lista de Sessões";
$l_admin_session_title_2 = "Sessões Corrente";
$l_admin_session_at = "em";
$l_admin_session_col_state = "Estado";
$l_admin_session_col_user = "Utilizador";
$l_admin_session_col_function = "Nome/Função";
$l_admin_session_col_ip = "Endereço IP";
$l_admin_session_col_begin = "Ínicio";
$l_admin_session_col_last = "Último";
$l_admin_session_col_version = "Versão";
$l_admin_session_info_not_connect = "Desligado";
$l_admin_session_info_online = "Activo"; // Available
$l_admin_session_info_away = "Ausente";
$l_admin_session_info_busy = "Ocupado";
$l_admin_session_info_do_not_disturb = "Não Perturbe";
$l_admin_session_order_user = "Utilizador";
$l_admin_session_order_state = "Estado";
$l_admin_session_no_session = "Actualmente sem Sessões";
$l_admin_session_col_time = "Tempo";
$l_admin_session_col_state_reason = "Reason";

#admin messenger screen
$l_admin_mess_title = "Mensagens Administrativas";
$l_admin_mess_title_2 = "Enviar uma mensagem de informação (como administrador)";
$l_admin_mess_title_3 = "Mensagens por Ler";
$l_admin_mess_title_4 = "Escolha uma imagem para enviar (png jpg gif)";
$l_admin_mess_message = "Mensagem";
$l_admin_mess_to = "Destinatário(s)";
$l_admin_mess_only = "Só Para";
$l_admin_mess_all_connected = "Todos os utilizadores conectados";
$l_admin_mess_all = "Todos utilizadores ( incluindo utilizadores desconetados)";
$l_admin_mess_group = "Todos os Membros do Grupo";
$l_admin_mess_group_connected = "Todos os Membros do Grupo Ligados";
...
$l_admin_mess_select = "Seleccionar";
$l_admin_mess_title_5 = "Enviar um Pedido";
$l_admin_mess_order = "Pedido";
$l_admin_mess_stop_pc = "Desligar o Computador";
$l_admin_mess_boot_pc = "Reiniciar o Computador";
$l_admin_mess_boot_im = "Reiniciar o IM";
$l_admin_mess_cannot_order = "Não pode ser utilizado : a opção _ENTERPRISE_SERVER não está activada";
...
#admin group manage
$l_admin_group_title = "Grupo de utilizadores";
$l_admin_group_title_2 = "Manusear grupo de utilizadores";
...
$l_admin_group_rename_group = "Alterar Nome do Grupo";
$l_admin_group_title_add_to_group = "Adicionar Membros ao Grupo";
$l_admin_group_new_name = "Novo Nome";
$l_admin_group_add_to_group = "Adicionar ao Grupo";
$l_admin_group_order_group = "Grupo";
$l_admin_group_cannot_use_1 = "Não é possível usar os grupos: opção _SPECIAL_MODE_GROUP_COMMUNITY não esta activada (tenha cuidado, a lista de contactos sera desactivada).";
$l_admin_group_cannot_use_2 = "Não obstante, os utilizadores podem adicionar grupos a eles mesmo nas suas listas de contactos.";
...
$l_admin_stats_col_nb_creat = "Utilizadores Criados";
$l_admin_stats_col_nb_session = "Sessões Simultaneas";
$l_admin_stats_col_nb_users = "Utilizadores";
$l_admin_stats_col_nb_msg_sbx = "ShoutBox Messages";
$l_admin_stats_no_stats = "Actualmente sem estatisticas";
$l_admin_stats_option_not = "Opção não Activada";
$l_admin_stats_rate = "Valor Máximo de";
...
$l_admin_stats_day_of_week = "Por Dia da Semana";
$l_admin_stats_latest = "Últimos";
$l_admin_stats_click_drag_to_zoom = "Clique e arraste na área de desenho para ampliar";
$l_admin_stats_click_to_show_hide = "Clique na legenda para mostrar/ocultar";
$l_admin_stats_empty = "Need to use more days to get statistics...";

#admin conference screen
$l_admin_conference_title = "Conferências";
$l_admin_conference_cannot_use_1 = "Não foi possível usar a opção _ALLOW_CONFERENCE porque não se encontra activada.";
$l_admin_conference_col_creator = "Criador";
$l_admin_conference_col_partaker = "Partilhas";
$l_admin_conference_no_conference = "Actualmente sem Conferências";

#admin change avatar screen
$l_admin_avatar_title = "Alterar Avatar/Imagem";
$l_admin_avatar_title_2 = "Seleccione outro avatar (ou imagem)";
$l_admin_avatar_title_3 = "Adicionar outro avatar (ou imagem) à lista";
$l_admin_avatar_title_4 = "Seleccione avatar (ou imagem) para eliminar";
$l_admin_avatar_title_5 = "Espere que o admin valide o avatar";
$l_admin_avatar_title_6 = "Lista inaceitavél de avatar (ex: dimensões)";
$l_admin_avatar_bt_download = "Download mais avatars";
$l_admin_avatar_info_1 = "Coloque imagens (ou avatars) na pasta";
...
#admin log screen
$l_admin_log_title = "Lista de Logs no Servidor";
$l_admin_log_title_admin = "Lista de Logs da Administração do Servidor";
$l_admin_log_select = "Seleccione o Servidor de Logs";
$l_admin_log_hack = "Hack attempt";
$l_admin_log_error_log = "Erro de log";
$l_admin_log_error_log_connection = "Connections error log";
$l_admin_log_type_error = "Erro";
$l_admin_log_type_warning = "Aviso/Proibido";
$l_admin_log_type_info = "Informação";
$l_admin_log_type_monitor = "Monitor";
$l_admin_log_session_open = "Sessões Abertas";
$l_admin_log_password_errors = "Erros nas Palavra-Passe";
$l_admin_log_lock_user_password = "Utilizadores bloqueados por erros na palavra-passe";
$l_admin_log_check_change = "Alteração na Configuração";
$l_admin_log_change_nickname = "Utilizador altera nickname";
$l_admin_log_upload_avatar = "Avatars Carregados";
$l_admin_log_username_unknown = "Utilizadores Desconhecidos";
$l_admin_log_reject_username = "Utilizadores com nickname proibidos";
$l_admin_log_reject_ip = "Endereço IP Banido";
$l_admin_log_reject_pc = "Computador Banido";
$l_admin_log_reject_max_same_ip = "Capacidade máxima de endereços IP";
$l_admin_log_reject_max_same_pc = "Capacidade máxima de utilização simultânea de um único Computador";
$l_admin_log_reject_max_users = "Rejeitado : número máximo de utilizadores registrados";
$l_admin_log_server_full = "Rejeitado : Servidor Cheio";
$l_admin_log_no_ip_address = "Sem Endereço IP";
$l_admin_log_version_to_old = "Versões antigas";
$l_admin_log_private_password = "Erro da palavra-passe privada";
$l_admin_log_user_create = "Utilizadores Criados";
$l_admin_log_user_allow = "Utilizadores autorizados";
$l_admin_log_user_disallow = "Utilizadores Desactivados";
$l_admin_log_user_delete = "Utilizadores Eliminados";
$l_admin_log_user_avatar_valid = "Avatars pendentes";
$l_admin_log_send_order = "Pedidos Enviados";
$l_admin_log_send_message = "Mensagens Administrativas Enviadas";
$l_admin_log_ban_ip_address = "Endereços IP Banidos";
$l_admin_log_unban_ip_address = "Unbanned ip addresses";
$l_admin_log_ban_username = "Nome de Utilizadores Banidos";
$l_admin_log_unban_username = "Ubanned usernames";
$l_admin_log_ban_computer = "Computadores Banidos";
...
#admin check config
$l_admin_check_title = "Verificar Configuração (Depois de Todas as Actualizações)";
$l_admin_check_conf_file = "Ficheiro de Configuração";
$l_admin_check_not_found = "Não Encontrado !";
$l_admin_check_found = "Encontrado";
$l_admin_check_on = "Ligado";
$l_admin_check_off = "Desligado";
$l_admin_check_before_upgrade = "Antes de Actualizar";
$l_admin_check_read_last = "Última Leitura";
$l_admin_check_last_options = "Vérificar as Últimas Opções";
$l_admin_check_new_options_are = "Todas as opções novas estão";
$l_admin_check_in_conf_file = "no ficheiro de configuração";
$l_admin_check_mysql = "Verificar Ligação ao MySQL";
$l_admin_check_connect_server = "Ligação ao Servidor";
$l_admin_check_failed = "Falhado";
$l_admin_check_cannot_continue = "Não pode continuar sem testes";
$l_admin_check_language_file = "Ficheiro Linguagem";
$l_admin_check_connect_to_server = "ligação ao servidor";
$l_admin_check_connect_to_database  = "ligação à base de dados";
$l_admin_check_missing_option = "falta opção";
$l_admin_check_all_tables = "todas as tabelas na base de dados";
$l_admin_check_version = "Versão do MySQL";
$l_admin_check_connect_database = "Ligação à Base de Dados";
$l_admin_check_option_missing = "Opção não encontrada no ficheiro";
$l_admin_check_tables_list = "Lista de verificação de tabelas";
$l_admin_check_table = "Tabela";
$l_admin_check_tables_ok = "Todas as Tabelas Existentes";
$l_admin_check_use = "Utilize";
$l_admin_check_in_admin = "na Administração do MySQL (Ex: PHPMyAdmin)";
$l_admin_check_to_create_table = "para criar as tabelas";
$l_admin_check_tables_structure = "Verificar a estrutura das Tabelas";
$l_admin_check_tables_structure_are = "Toda a estrutura existente das tabelas estão";
$l_admin_check_col = "Coluna"; // column
$l_admin_check_for_structure = "para atualizar a estrutura da tabela";
$l_admin_check_update_now = "Actualizar Agora";
$l_admin_check_conf_not_ok = "Configuração : Não está correcta : tem de actualizar a configuração !";
$l_admin_check_folders = "Verificar Pastas";
$l_admin_check_folder = "Pasta";
$l_admin_check_not_writeable = "Não gravável";
$l_admin_check_history = "Por favor, leia a história na versão no ficheiro";
$l_admin_check_conf_ok = "Configuração/Actualização Finalizada com Sucesso";
$l_admin_check_can_go = "Pode seguir agora";
$l_admin_check_admin_panel = "Painel de Administração";
$l_admin_check_optimize_tables = "Optimizar Tabelas";
$l_admin_check_tables_are_optimized = "Todas as tabelas foram optimizadas";
$l_admin_check_system_info = "Informações do Sistema";
$l_admin_check_incomplete = "incomplete";
$l_admin_check_fix_missing_option = "To fix it, just save options";

#admin save database
$l_admin_save_title = "Backup da Base de Dados";
$l_admin_save_bt_now = "Fazer Backup Agora";
$l_admin_save_selet_to_restore = "Seleccione o Backup para Restaurar";
$l_admin_save_bt_restore = "Restaurar";
$l_admin_save_list = "Lista de Backups";
$l_admin_save_not_in_maintenance = "Impossível Restaurar : O modo de Manutenção está Activo.";
$l_admin_save_cannot_use = "Cannot use";
$l_admin_save_do_not_use = "Do not use";

#admin ban control
$l_admin_ban_users = "Nome de Utilizadores Banidos";
$l_admin_ban_ip = "Endereços IP Banidos";
$l_admin_ban_pc = "Computadores Banidos";
$l_admin_ban_add_user = "Adicionar Utilizador para Banir";
$l_admin_ban_add_ip = "Adicionar Endereço IP para Banir";
$l_admin_ban_add_pc = "Adicionar Computador para Bainr";
...
#install
$l_install_check_files = "Verificar Ficheiros";
$l_install_file = "Ficheiro";
$l_install_bt_next = "Continuar";
$l_install_step = "Etapa";
$l_install_check_cannot_continue = "Não é possível continuar a instalar sem";
...
#home
$l_home_not_configured = "O Servidor de Instant messenger não foi configurado ainda...";
$l_home_welcome = "Bemvindo ao seu Servidor de instant messenger";
$l_home_thanks_to_first = "Obrigado em Primeiro Lugar";
$l_home_here_register = "Clque Aqui para se Registar";
$l_home_register = "Registar";
$l_home_download_execute = "Download e Executar";
$l_home_before_install = "<B>Antes</B> da Instalação.<BR/> Para uma fácil instalação e evitar a última etapa";
$l_home_download_install = "Download IntraMessenger (setup/install)";
$l_home_or = "ou";
$l_home_download_zip = "Download IntraMessenger (Versão zip)";
$l_home_on_startup_config_url = "No arranque do IntraMessenger, configure o endereço para (<I>URL</I>)";
$l_home_replace = "Substituir";
$l_home_by_ip_address = " pelo endereço IP do servidor para conectar-se <blink> a partir de outro computador</blink>";
