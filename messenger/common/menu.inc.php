...
//
$force_check = "";
if ( (!defined("_MAINTENANCE_MODE")) or (!defined("_ROLE_ID_DEFAULT_FOR_NEW_USER")) or (!defined("_ACP_ALLOW_MEMORY_AUTH")) or (!defined("_FLAG_COUNTRY_FROM_IP"))  )  $force_check = "X";
...
function footer()
{
  ...
  //
	...
	echo " by <a href='http://www.theuds.com/' target='_blank' class='copyright' alt='THeUDS.com' title='THeUDS.com'>THeUDS</A> &copy; 2006 - 2014";
