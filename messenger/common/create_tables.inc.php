...
$requete .= " USR_DATE_CREAT date NOT NULL default '0000-00-00',";
$requete .= " USR_DATE_LAST date NOT NULL default '0000-00-00',";
$requete .= " USR_DATE_PASSWORD date NOT NULL default '0000-00-00',";
$requete .= " USR_DATE_ACTIVITY date NOT NULL default '0000-00-00',";
$requete .= " USR_DATE_BIRTH date NOT NULL default '0000-00-00',";
...
$requete .= " USR_DATE_BACKUP date NOT NULL default '0000-00-00',";
...
$requete .= " MSG_DATE date NOT NULL default '0000-00-00',";
...
$requete .= " SES_STARTDATE date NOT NULL default '0000-00-00',";
...
{
  list ($nb_row) = mysql_fetch_row ($result);
  if ($nb_row < 5)
  {
...
$requete .= " SRV_STATE_DATE date NOT NULL default '0000-00-00', ";
...
$requete .= " FPJ_DATE_END date NOT NULL default '0000-00-00', ";
$requete .= " FPJ_DATE_CLOSE date NOT NULL default '0000-00-00', ";
...
$requete .= " FIL_DATE date NOT NULL default '0000-00-00', ";
$requete .= " FIL_DATE_ADD date NOT NULL default '0000-00-00', ";
$requete .= " FIL_DATE_TRASH date NOT NULL default '0000-00-00', ";
$requete .= " FIL_SIZE INT UNSIGNED NULL, ";
$requete .= " FIL_HASH CHAR(32) NOT NULL, ";
$requete .= " FIL_PROTECT VARCHAR(32) NOT NULL, ";
$requete .= " FIL_PASSWORD VARCHAR(32) NOT NULL, ";
$requete .= " FIL_COMPRESS CHAR(1) NOT NULL, ";
...
$requete .= " ADM_DATE_CREAT date NOT NULL default '0000-00-00', ";
$requete .= " ADM_DATE_LAST date NOT NULL default '0000-00-00', ";
$requete .= " ADM_DATE_PASSWORD date NOT NULL default '0000-00-00', ";
...
$requete .= " FIB_DATE_ADD date NOT NULL default '0000-00-00', ";
