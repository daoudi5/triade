...
// deuxieme ligne
	...
	$pdf->SetXY($Xmat1,$Ymat);
	$pdf->MultiCell(20,6,'Partiel 1',1,'C',1);

	$Xmat1=$Xmat1+20;
	$pdf->SetXY($Xmat1,$Ymat);
	$pdf->MultiCell(20,6,'Partiel 2',1,'C',1);
...
//		}
		...
		$moyenMadridP1=$affiche_note*0.25;
		...
		$pdf->SetXY($Xmat+$largeurMat+20+20,$Ymat);
		$pdf->MultiCell(20,$hauteurMatiere,$affiche_note,'LR','C',1);		
		
		$moyenMadridP2=$affiche_note*0.40;
		...
		if ($moyenne_periode >=0 && is_numeric($moyenne_periode) && $nb_note_periode>0) { 
			...
			$moyenne_periode=($moyenne_periode*0.35)+$moyenMadridP2+$moyenMadridP1;
