...
Last updated: 03.10.2002    par FO
*************************************************************/ -->
<HTML>
<HEAD>
...
<?php print LANGSUPP16?> </font></b></td>
</tr>
<tr id='cadreCentral0' >
<td >
     <!-- // debut form  -->
...
<center>
<script language=JavaScript>buttonMagic("<?php print LANGSUPP19 ?>","acces2.php","_parent","","");</script> <script language=JavaScript>buttonMagicSubmit("<?php print LANGSUPP10?>","rien"); //text,nomInput</script>&nbsp;&nbsp;
</center>
<br><br>
</form>
</blockquote>
