...
<?php $nomprenom=recherche_personne($data[$i][0]); print ucwords(strtolower($nomprenom)); ?> </td><td id="bordure"  > <?php $data2=chercheClasse($data[$i][1]);print ucwords(ereg_replace(' ',"&nbsp;",$data2[0][1]));?>
</td>
