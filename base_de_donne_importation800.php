...
<TR><TD align=top><font class=T2><?php print "Module d'importation du code barre" ?> </font></TD>
</TR></TABLE><br>
<?php print "Le fichier à transmettre DOIT contenir 2 champs" ?>
<BR>
<BR>
...
<table width="100%" border="1" bgcolor="#FCE4BA" bordercolor="#000000" >
	<tr bgcolor="#FFCC00">
	  <td valign=top width=25%>1) Numero Elève/Etudiant *</td>
	  <td valign=top width=25%>2) Numero code barre *</td>
	</tr>
</table>
<br>
<script language=JavaScript>
function suite() {
	location.href="./base_de_donne_key.php?base=codebarrexls";
}
</script>
