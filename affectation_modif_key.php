...
<tr id='coulBar0' ><td height="2"><b><font   id='menumodule1' ><?php print LANGaffec_mod_key1?></font></b></td></tr>
<tr id='cadreCentral0'>
<td valign=top>
<br><br>
<ul><font class=T2><?php print LANGaffec_mod_key2 ?></font></ul><br>
      ...
      function suite() {
               ...
               if (confirmation) {
		       location.href="./base_de_donne_key.php?base=affectationmodif&sClasseGrp=<?php print $_GET["sClasseGrp"] ?>";
               }
      }
      </script>
