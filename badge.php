...
<script language="JavaScript" src="http://support.triade-educ.com/support/badge/config.php"></script>
</head>
...
<br>
	<iframe src='http://support.triade-educ.com/support/badge/tarif.php?GRAPH=<?php print GRAPH ?>' width='400' height='300' MARGINWIDTH=0 MARGINHEIGHT=0 HSPACE=0 VSPACE=0 FRAMEBORDER=0 SCROLLING=yes /></iframe>
<?php 
} 
...
<font class='T2'>
	...
	Télécharger la facture ProFormat <a href='http://support.triade-educ.com/support/badge/factureProFormat.php?productid=<?php print $productid ?>&email=<?php print $email ?>&nbBadge=<?php print $nbBadge ?>' target='_blank' ><font color=blue>Facture</font></a><br><br>

        <font size=1><i>Pour toutes questions, merci de contacter le support à cette adresse :<br> support@triade-educ.com</i></font>
