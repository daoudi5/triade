...
<tr id='coulBar0' ><td height="2"><b><font   id='menumodule1' ><?php print "Ajout d'une note vie scolaire" ?></font></b></td></tr>
<tr id='cadreCentral0' >
<td>
     <!-- // fin  -->
<?php 
...
?>
<form method="POST" onsubmit="return verifAccesFiche()" name="formulaire" action="note_scolaire2.php">
                 <br />
                 <ul>
		<font class="T2"><?php print LANGBULL3 ?> :</font>
		 ...
		 <br><br><br>
                 <font class=T2><font class="T2"><?php print LANGPROFG ?> :</font></font>
				...
				<?php
				if (EXAMENJTC == "oui") {
					print "<br><font class='T2'>Note de type carnet : <input type='checkbox' name='examen' value='1' > ( <i>oui</i> ) </font><br><br>"; 
				}
				?>
				<br>
				 <UL><UL><UL><UL>
