...
<tr id='coulBar0' ><td height="2"><b><font   id='menumodule1' ><?php print LANGMESS403 ?></font></b></td>
</tr>
<tr id='cadreCentral0'>
<td valign=top>
<!-- // fin  -->
...
for($i=0;$i<count($data);$i++) {
	...
	print "<td width=5><input type=button class=button value=\"".LANGMESS396."\" onclick=\"open('modif_tuteur.php?saisie_id=".$data[$i][0]."','_parent','');\" ></td>\n";
	print "</tr>\n";
}
?>
</table>
