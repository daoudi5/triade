...
<br><ul>
	<script language=JavaScript>buttonMagic3("<?php print "Créditer le compte" ?>","new Effect.Grow('viscredit', 1); return false;");</script>
	<script language=JavaScript>buttonMagic3("<?php print "Réactualiser la page" ?>","open('cantine_compta_2.php?idpers=<?php print $idpers ?>&membre=<?php print $membre ?>','_parent','');");</script>
