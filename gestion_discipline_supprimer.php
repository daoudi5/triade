...
<tr id='cadreCentral0'>
<td valign=top>
<font class=T2><?php print LANGDISC50 ?></font>
<!-- // fin  -->
<?php
include_once("./librairie_php/lib_licence.php");
...
$cnx=cnx();
?>
<form method=post name=formulaire action="gestion_discipline_supprimer_2.php" onSubmit="return valide_supp_discipline();">
...
<script language=JavaScript>buttonMagicSubmit3("<?php print LANGBT50 ?>","rien",""); //text,nomInput</script></td></tr></table>
</form>
<br>
<!-- // fin  -->
