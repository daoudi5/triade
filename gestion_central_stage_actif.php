...
<br><br>
<form action='http://support.triade-educ.com/centralestage/activation.php' method='post' target="centralstage" name="formulaire" id="formulaire" >
...
<tr id='cadreCentral0'>
<td valign=top>
<iframe width='100%' height=100% src="http://support.triade-educ.com/centralestage/verifactivation.php?productid=<?php print PRODUCTID ?>&inc=<?php print GRAPH ?>" name='centralstage' MARGINWIDTH=0 MARGINHEIGHT=0 HSPACE=0 VSPACE=0 FRAMEBORDER=0 SCROLLING=no ></iframe> 
