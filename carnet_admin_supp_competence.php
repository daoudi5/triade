...
<?php
if (isset($_POST["suppdirect_competence"])) { supprimerCompetence($idcarnet,$_POST["idcompetence"]); }
...
?>
<tr><td><br /><br />
<script language=JavaScript>buttonMagicSubmit("<?php print "Supprimer" ?>","suppdirect_competence"); </script>
	<script language=JavaScript>buttonMagic("<?php print "Retour" ?>","carnet_admin_modif_2.php?idcarnet=<?php print $idcarnet?>","_parent","",""); </script>&nbsp;&nbsp;</td></tr>
</table>
...
?>
	...
	<table align=center><tr><td><script language=JavaScript>buttonMagic("<?php print "Retour" ?>","carnet_admin_modif_2.php?idcarnet=<?php print $idcarnet?>","_parent","",""); </script>&nbsp;&nbsp;</td></tr></table>
	</form>
<?php	
}
?>
