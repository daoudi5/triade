...
for($j=0;$j<count($dataClasse);$j++) {
	...
	for($i=0;$i<count($data);$i++) {
		...
		print 	"</td>
			...
			<td width='5%'  bgcolor='#CCCCCC' id='bordure' align='right'>&nbsp;<span>$s".ereg_replace(' ','&nbsp;',affichageFormatMonnaie($montant))."$ss</span>&nbsp;</td></form></tr>";
	}
...
for($i=0;$i<count($data);$i++) {
	...
	<td width='5%'  bgcolor='#CCCCCC' id='bordure' align='right' >&nbsp;<span id='montant$j$i' >".ereg_replace(' ','&nbsp;',affichageFormatMonnaie($montant))."</span>&nbsp;</td></form></tr>";
}
print "<tr><td height='20' id='bordure' ></td></tr>";
print "</table>";
