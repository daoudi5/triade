...
<input type="hidden" name="idcarnet" value="<?php print chercheIdCarnet($nom_carnet); ?>" >
<table border=0 align=center width=85%>
<tr><td align="left" colspan=2><font class="T2"><?php print LANGCARNET44 ?>  </font><br /><br /></td></tr>
