...
//	$classe=chercheClasse_nom($idclasse);
	...
	for($j=0;$j<count($dataV);$j++) {
		...
		if ($affiche == 1) {
			...
			print "<td valign='top' align='right'>&nbsp;<b>".ereg_replace(' ','&nbsp;',affichageFormatMonnaie($dataV[$j][3]))."</b></td>";
...
print "<td align='center' bgcolor='#FFFFFF'  >&nbsp;<b>".ereg_replace(' ','&nbsp;',affichageFormatMonnaie($total))."</b></td>";
