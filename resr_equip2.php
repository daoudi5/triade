...
if (isset($_POST["supp"])) {
	...
	history_cmd($_SESSION["nom"],"SUPPRESSION","reservation Equip");
}
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
[<a href="resr_equip_fen.php?date=<?php print dateFormBase($date)?>" ><b><?php print LANGRESA64 ?></b></a>]
...
<?php
	...
	// id.n,idmatos.n,idqui.n,quand.n,heure_depart.n,heure_fin.n,info.n,valider.n,type.m,id.m,n.refcommun
	print "<table width=95% border=1 align=center>";
	print "<tr bgcolor='yellow'>";
	print "<td width=95 valign=top >".LANGRESA65."</td>";
	print "<td width=150 valign=top>&nbsp;".LANGRESA66."&nbsp;par</td>";
	print "<td valign=top >&nbsp;".LANGRESA33."&nbsp;</td>";
	...
	for($i=0;$i<count($data);$i++) {
		...
		print "<td valign=top > ".ucwords(recherche_equip($data[$i][1]))." ".$res."<br><i>".$data[$i][6]."</i></td></tr>";
		if (($_SESSION["membre"] == "menuadmin") || ($_SESSION["membre"] == "menuascolaire")) {
