...
<?php print LANGPROF3 ?> /  </b><font id="color2" > <?php print $libel?></font>  / <?php print $anneeScolaire ?></font></td>
</tr>
...
if (count($valeur)) {
?>
<iframe MARGINWIDTH=0 MARGINHEIGHT=0 HSPACE=0 VSPACE=0 FRAMEBORDER=0  name="visunote" src="visunoteprof.php?sClasseGrp=<?php print $_POST["sClasseGrp"]?>&sMat=<?php print $_POST["sMat"]?>&anneeScolaire=<?php print $anneeScolaire?>" width="100%" height="100%" ></iframe>
<?php
}else {
?>
<iframe MARGINWIDTH=0 MARGINHEIGHT=0 HSPACE=0 VSPACE=0 FRAMEBORDER=0  scrolling=no name="visunote" src="visunoteprofnon.php" width="100%" height="100%" ></iframe>
<?php } ?>
