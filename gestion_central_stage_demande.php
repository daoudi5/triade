...
if ($etat != "") {
	print "<script language='JavaScript' src='http://support.triade-educ.com/centralestage/etataffiliation.php?productidclient=".$_POST["productid"]."&productidcentral=".PRODUCTID."&etat=$etat' ></script>";
}
