...
<tr id='coulBar0' ><td height="2"><b><font   id='menumodule1' ><?php print LANGDISC36 ?> </font></b></td></tr>
<tr id='cadreCentral0'>
<td >
<?php
//--------------------------------------------------//
if(isset($_POST["supp_dispence"])) {
        $cr=suppression_retenue($_POST["saisie_id_eleve"],$_POST["saisie_date"],$_POST["saisie_heure"]);
        if($cr):
...
<?php
$data_2= affRetenu_par_eleve($data[$i][3]);
...
<TD align=center valign=top><?php print dateForm($data_2[$j][1])?></td>
	...
	<TD valign=top>&nbsp;<?php print ucwords($data_2[$j][8])?></td>
	...
	<input type=hidden name=saisie_id_eleve value="<?php print $data_2[$j][0]?>">
	<input type=hidden name=saisie_date value="<?php print $data_2[$j][1]?>">
	<input type=hidden name=saisie_heure value="<?php print $data_2[$j][2]?>">
