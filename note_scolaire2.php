...
<table border="0" cellpadding="3" cellspacing="1" width="100%" bgcolor="#0B3A0C" height="950">
<tr id='coulBar0' ><td height="2"><b><font   id='menumodule1' >
<?php print "Note vie scolaire " ?> : <font id="color2"> <?php print $libel?></font>
/ <?php print LANGBULL3 ?> : <font id="color2"><?php print $anneeScolaire ?></font>
</font></b></td>
</tr>
