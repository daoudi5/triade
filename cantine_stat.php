...
<td colspan="2" ><br>
<select name="saisie_section">
<option  value=0 selected   STYLE='color:#000066;background-color:#FCE4BA' ><?php print LANGCHOIX ?></option>
<option  value="tous" selected   STYLE='color:#000066;background-color:#FCE4BA' ><?php print "Toutes les sections" ?></option>
<?php recupListPlateau(); ?>
</select>
</td></tr>
-->
</table>
...
<script language=JavaScript>buttonMagicSubmit3("<?php print LANGPER27 ?>","rien",""); //text,nomInput</script></td><td><script language=JavaScript>buttonMagicRetour('cantine.php','_self')</script></td></tr></table>
</form>
