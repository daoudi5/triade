...
<ul>
<br />
<form method=post  action='./base_de_donne_gep44.php' name=formulaire ENCTYPE="multipart/form-data">

<font class=T1><?php print LANGGEP2?> : <b>F_WIND.DBF</b>  <input type="file" name="fichier1" size=20 > <br /><br />
<br />
<br />
<ul><ul>
