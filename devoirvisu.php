...
<SCRIPT language="JavaScript" src="./librairie_js/menuprof1.js"></SCRIPT>
     ...
     <tr id='coulBar0' ><td height="2"><b><font   id='menumodule1' ><?php print LANGPROF3bis ?></font></b></td>
     </tr>
     <tr id='cadreCentral0' >
     <td>
     <!-- // fin  -->
                 <br />
                 <form method="POST" name="formulaire2" action="devoirvisu.php" >
                 <ul>
		 <font class="T2"><?php print LANGBULL29 ?> :</font>
                 <select name='anneeScolaire' onChange="document.formulaire2.submit()" >
                 <?php
		...
		<br>
		<br>
                 <form method="POST" onsubmit="return verifAccesNote()" name="formulaire" action="devoirvisu2.php">
