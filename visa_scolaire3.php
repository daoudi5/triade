...
for($i=0;$i<$nb;$i++) {
	...
	$cr=create_comm_scolaire_bull($eleveid,$tri,$com,$anneeScolaire);
	if ($cr) {
		history_cmd($_SESSION["nom"],"BULLETIN","Commentaire Vie Scolaire");
	}
}	
...
?>
<br />
<center><font class=T2>Visa scolaire enregistré</font></center>
<br /><br />
