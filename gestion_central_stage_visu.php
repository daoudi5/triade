...
<td valign=top>
<?php
$url="gestionvisusouhaitcentral.php";
include_once("gestion_central_stage_url.php");
if ($url == "gestionvisusouhaitcentral.php") { $url="$url?id=$id&p=null"; }

if ($_POST["modif"] == "1") { $url.="&m=1"; }
if ($_GET["m"] == "1") { $url.="&m=1"; }
?>

<iframe src="<?php print $url ?>" width='100%' height='100%' name='centralstage' MARGINWIDTH='0' MARGINHEIGHT='0' HSPACE='0' VSPACE='0' FRAMEBORDER='0' SCROLLING='auto' ></iframe>
