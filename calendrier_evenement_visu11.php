...
<?php
     ...
     <?php
       $saisie_annee="2002";
     ?>
<?php include("./librairie_php/lib_calendrier_evenement_visu.php");?>
...
$saisie_annee_moin--;
?>
     <center> <A href="./calendrier_evenement_visu11.php?saisie_annee_choix=<?php print $saisie_annee_moin?>" ><?php print LANCALED1 ?></A> <------> <A href="./calendrier_evenement_visu11.php?saisie_annee_choix=<?php print $saisie_annee_plus?>" ><?php print LANCALED2 ?></A></center>
