...
for($i=0;$i<count($data);$i++)
	...
	<td><input type=button class=BUTTON value="<?php print LANGBT28 ?>" onclick="open('ficheeleve3.php?eid=<?php print $data[$i][1]?>&idclasse=<?php print $saisie_classe?>','_parent','')"></td>
	</tr>
	<?php
	}
      }
