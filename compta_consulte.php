...
<tr id='coulBar0' ><td height="2"><b><font   id='menumodule1' ><?php print "Ajouter un versement" ?></font></b></td></tr>
<tr id='cadreCentral0' >
<td valign='top' >
...
?>
<br>
&nbsp;&nbsp;<font class=T2>Filtre : </font><select name='anneescolairefiltre' > <?php filtreAnneeScolaireSelect($anneescolairefiltre) ?> </select>
</td></tr>

<tr><td id='bordure' height=20 ></td></tr>


<tr><td style="padding-top:0px;" nowrap id='bordure' >
...
</td></tr><tr><td style="padding-top:0px;" id='bordure' ><div id="target" style="width:13.5em;" ></div></td></tr>
...
<script language=JavaScript>buttonMagicRetour("comptaetat.php","_self"); //text,nomInput</script>
</UL></UL></UL>
</div>
 </blockquote>
