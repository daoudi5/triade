...
// Relevé de Partiel Blanc Version 2.0 (22/04/2009) - Par Philippe GISCLON
...
$LCF_date_examen = strip_tags(trim($_POST['date_edition']));
$LCF_titre_releve = strip_tags(trim($_POST['titre_releve']));
?>
...
$typeexamen=stripslashes($LCF_titre_releve);
$typecommentaire="partielblanc";
...
######
	...
	$pdf->SetXY(0,$ycoor0+30);
	$pdf->SetFont('Arial','',16);
	//$pdf->WriteHTML($typeexamen);
	$pdf->Cell(0,40,$typeexamen,0,1,'C');
	// fin titre
