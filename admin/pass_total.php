...
if (isset($_POST["create"])) {
	...
	if ($_POST["initia"] == "0") {
		...
		if ($nb > 0) {
			...
			$message="Aucun mots de passe modifiés";
		}
	}
	if ($_POST["initia"] == "1") { 
...
<tr><td >
<ul><font class="T2">Réinitialisation des mots de passe (parents et élèves)</font></ul><br>
</td></tr>

<tr><td>
&nbsp;<font class='T2'>Année Scolaire : </font><select name='annee_scolaire' > 
...
<tr><td ><input type="radio" name="initia" value="2"  onclick="document.getElementById('passpar').style.visibility='hidden'; document.getElementById('passel').style.visibility='hidden'; document.getElementById('passimp').style.visibility='visible'; document.getElementById('passimp').style.visibility='visible'; document.formulaire.passeldef.value=''; document.formulaire.passpardef.value=''; " > Importer mot de passe. (Parents et Elèves) / sans notion d'année scolaire</td></tr>
