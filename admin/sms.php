...
if (LAN == "oui") {
	if (!file_exists("../common/config-sms.php")) {
		...
		print "<td><script language=JavaScript>buttonMagicSubmit3('Cliquez ICI','http://support.triade-educ.com/support/sms-compte.php?idsms=$idsms&inc=$inc','','width=550,height=600','','');</script></td><td><script language=JavaScript>buttonMagicSubmit3('Réinitialiser votre compte SMS','sms-init.php','_self','','','');</script></td></tr></table>";
	}
}else{
