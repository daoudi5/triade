...
<!--
<tr height=30 align=right>
<td>L'accès à Triade utilise le protocole https :  </td>
<td align=left>
...
<td align=left valign=top>&nbsp;<select name="meteoregion">
		...
		<optgroup label="Afrique">
	    	<option value="IVXX0001:Abidjan" 	class=bouton2 >Abidjan</option>
	    	<option value="CTXX0001:Bangui" 	class=bouton2 >Bangui</option>
	    	<option value="EKXX0001:Bata" 		class=bouton2 >Bata</option>
	    	<option value="CFXX0001:Brazzaville" 	class=bouton2 >Brazzaville</option>
	    	<option value="SGXX0001:Dakar" 		class=bouton2 >Dakar</option>
	    	<option value="CMXX0003:Douala" 	class=bouton2 >Douala</option>
	    	<option value="RWXX0001:Kigali" 	class=bouton2 >Kigali</option>
	    	<option value="CGXX0005:kinshasa" 	class=bouton2 >kinshasa</option>
	    	<option value="GBXX0004:Libreville" 	class=bouton2 >Libreville</option>
	    	<option value="MOXX0014:Oujda" 		class=bouton2 >Oujda</option>
	    	<option value="BNXX0002:Porto-Novo" 	class=bouton2 >Porto-Novo</option>
	    	<option value="CMXX0008:Yaoundé" 	class=bouton2 >Yaoundé</option>



		<optgroup label="Arabi Saoudite">
		<?php
		if (file_exists("./lib/weather.arabi")) {
			$handle=fopen("./lib/weather.arabi","r");
			while (!feof($handle)) {
				$ligne=fgets($handle, 1000); 
				list($code,$ville)= split (":", $ligne, 2);
				$ville=trim($ville);
		...
		<?php
		if (file_exists("./lib/weather.en")) {
			$handle=fopen("./lib/weather.en","r");
			while (!feof($handle)) {
				$ligne=fgets($handle, 1000); 
				list($code,$ville)= split (":", $ligne, 2);
				$ville=trim($ville);
		...
		<?php
		if (file_exists("./lib/weather.be")) {
			$handle=fopen("./lib/weather.be","r");
			while (!feof($handle)) {
				$ligne=fgets($handle, 1000); 
				list($code,$ville)= split (":", $ligne, 2);
				$ville=trim($ville);
		...
		<?php
		if (file_exists("./lib/weather.canada")) {
			$handle=fopen("./lib/weather.canada","r");
			while (!feof($handle)) {
				$ligne=fgets($handle, 1000); 
				list($code,$ville)= split (":", $ligne, 2);
				$ville=trim($ville);
		...
		<?php
		if (file_exists("./lib/weather.egypte")) {
			$handle=fopen("./lib/weather.egypte","r");
			while (!feof($handle)) {
				$ligne=fgets($handle, 1000); 
				list($code,$ville)= split (":", $ligne, 2);
				$ville=trim($ville);
		...
		<?php
		if (file_exists("./lib/weather.es")) {
			$handle=fopen("./lib/weather.es","r");
			while (!feof($handle)) {
				$ligne=fgets($handle, 1000); 
				list($code,$ville)= split (":", $ligne, 2);
				$ville=trim($ville);
		...
		<?php
		if (file_exists("./lib/weather.fr")) {
			$handle=fopen("./lib/weather.fr","r");
			while (!feof($handle)) {
				$ligne=fgets($handle, 1000); 
				list($code,$ville)= split (":", $ligne, 2);
				$ville=trim($ville);
		...
		<?php
		if (file_exists("./lib/weather.fr")) {
			$handle=fopen("./lib/weather.gua","r");
			while (!feof($handle)) {
				$ligne=fgets($handle, 1000); 
				list($code,$ville)= split (":", $ligne, 2);
				$ville=trim($ville);
		...
		<option value="GTXX0002:Guatemala City" class=bouton2 >Guatemala City</option>
		...
		<?php
		if (file_exists("./lib/weather.israel")) {
			$handle=fopen("./lib/weather.israel","r");
			while (!feof($handle)) {
				$ligne=fgets($handle, 1000); 
				list($code,$ville)= split (":", $ligne, 2);
				$ville=trim($ville);
		...
		<optgroup label="Koweit">
		<?php
		if (file_exists("./lib/weather.kuweit")) {
			$handle=fopen("./lib/weather.kuweit","r");
			while (!feof($handle)) {
				$ligne=fgets($handle, 1000); 
				list($code,$ville)= split (":", $ligne, 2);
				$ville=trim($ville);
		...
		<optgroup label="Laos">
		<?php
		if (file_exists("./lib/weather.laos")) {
			$handle=fopen("./lib/weather.laos","r");
			while (!feof($handle)) {
				$ligne=fgets($handle, 1000); 
				list($code,$ville)= split (":", $ligne, 2);
				$ville=trim($ville);
		...
		<optgroup label="Liban">
		<?php
		if (file_exists("./lib/weather.liban")) {
			$handle=fopen("./lib/weather.liban","r");
			while (!feof($handle)) {
				$ligne=fgets($handle, 1000); 
				list($code,$ville)= split (":", $ligne, 2);
				$ville=trim($ville);
		...
		<optgroup label="Mali">
		<?php
		if (file_exists("./lib/weather.mali")) {
			$handle=fopen("./lib/weather.mali","r");
			while (!feof($handle)) {
				$ligne=fgets($handle, 1000); 
				list($code,$ville)= split (":", $ligne, 2);
				$ville=trim($ville);
		...
		<?php
		if (file_exists("./lib/weather.maroc")) {
			$handle=fopen("./lib/weather.maroc","r");
			while (!feof($handle)) {
				$ligne=fgets($handle, 1000); 
				list($code,$ville)= split (":", $ligne, 2);
				$ville=trim($ville);
		...
		<?php
		if (file_exists("./lib/weather.marti")) {
			$handle=fopen("./lib/weather.marti","r");
			while (!feof($handle)) {
				$ligne=fgets($handle, 1000); 
				list($code,$ville)= split (":", $ligne, 2);
				$ville=trim($ville);
		...
		?>
		<optgroup label="Nouvelle Calédonie">
		<?php
		if (file_exists("./lib/weather.nc")) {
			$handle=fopen("./lib/weather.nc","r");
			while (!feof($handle)) {
				$ligne=fgets($handle, 1000); 
				list($code,$ville)= split (":", $ligne, 2);
				$ville=trim($ville);
		...
		<optgroup label="Polynésie Française">
		<?php
		if (file_exists("./lib/weather.pf")) {
			$handle=fopen("./lib/weather.pf","r");
			while (!feof($handle)) {
				$ligne=fgets($handle, 1000); 
				list($code,$ville)= split (":", $ligne, 2);
				$ville=trim($ville);
		...
		<option value="NLXX0002:Amsterdam" 	class=bouton2 >Amsterdam</option>

		<optgroup label="U.S.A">
		<option value="USIL0230:Chicago" 	class=bouton2 >Chicago</option>
		<option value="USNY0998:New York" 	class=bouton2 >New York</option>
		
		<optgroup label="Suisse">
		<?php
		if (file_exists("./lib/weather.suisse")) {
			$handle=fopen("./lib/weather.suisse","r");
			while (!feof($handle)) {
				$ligne=fgets($handle, 1000); 
				list($code,$ville)= split (":", $ligne, 2);
				$ville=trim($ville);
		...
		<?php
		if (file_exists("./lib/weather.viet")) {
			$handle=fopen("./lib/weather.viet","r");
			while (!feof($handle)) {
				$ligne=fgets($handle, 1000); 
				list($code,$ville)= split (":", $ligne, 2);
				$ville=trim($ville);
		...
		<A href='#' onMouseOver="AffBulle2('Si besoin','../image/commun/info.jpg','<font face=Verdana size=1><font color=red>P</font>our ajouter une nouvelle ville,  contactez nous via support@triade-educ.com </FONT>'); window.status=''; return true;" onMouseOut='HideBulle()'><img src='../image/help.gif' align=center border=0></A>
</td></tr>
...
<A href='#' onMouseOver="AffBulle2('Information','../image/commun/info.jpg','<font face=Verdana size=1><font color=red>C</font>hoisissez le nombre de caractère maximum pour les commentaires des bulletins trimestriels ou semestriels pour les enseignants.</FONT>'); window.status=''; return true;" onMouseOut='HideBulle()'><img src='../image/help.gif' align=center border=0></A>
</td></tr>
...
<tr><td align=right >Autorise l'élève a changer son email  : </td>
...
<td align=left>
<input type=radio <?php print $modulenote40oui ?> name="modulenote40" value="oui" class=btradio1  > oui &nbsp;&nbsp;&nbsp;
<input type=radio <?php print $modulenote40non ?> name="modulenote40" value="non" class=btradio1  > non 
</tr>

<tr><td align=right > Notation sur 30 : </td>
<td align=left>
<input type=radio <?php print $modulenote30oui ?> name="modulenote30" value="oui" class=btradio1  > oui &nbsp;&nbsp;&nbsp;
<input type=radio <?php print $modulenote30non ?> name="modulenote30" value="non" class=btradio1  > non 
</tr>


<tr><td align=right > Notation sur 20 : </td>
<td align=left>
<input type=radio <?php print $modulenote20oui ?> name="modulenote20" value="oui" class=btradio1  > oui &nbsp;&nbsp;&nbsp;
<input type=radio <?php print $modulenote20non ?> name="modulenote20" value="non" class=btradio1  > non 
</tr>

<tr><td align=right > Notation sur 15 : </td>
<td align=left>
<input type=radio <?php print $modulenote15oui ?> name="modulenote15" value="oui" class=btradio1  > oui &nbsp;&nbsp;&nbsp;
<input type=radio <?php print $modulenote15non ?> name="modulenote15" value="non" class=btradio1  > non 
</tr>

<tr><td align=right > Notation sur 10 : </td>
<td align=left>
<input type=radio <?php print $modulenote10oui?> name="modulenote10" value="oui" class=btradio1  > oui &nbsp;&nbsp;&nbsp;
<input type=radio <?php print $modulenote10non ?> name="modulenote10" value="non" class=btradio1  > non 
</tr>

<tr><td align=right > Notation sur 5 : </td>
<td align=left>
<input type=radio <?php print $modulenote5oui ?> name="modulenote5" value="oui" class=btradio1  > oui &nbsp;&nbsp;&nbsp;
<input type=radio <?php print $modulenote5non ?> name="modulenote5" value="non" class=btradio1  > non 
</tr>
...
<td align=left>
<select name='intitule_direction' ><option value='direction' id=select1 <?php print $intitule_direction1 ?> >direction</option><option value='administration' id=select1  <?php print $intitule_direction2 ?>  >administration</option></select>
</tr>


<tr><td align=right >Intitulé du compte élève/étudiant  : </td>
<td align=left>
<select name='intitule_eleve' ><option value='élève' id=select1 <?php print $intitule_eleve1 ?> >élève</option><option value='étudiant' id=select1  <?php print $intitule_eleve2 ?>  >étudiant</option></select>
</tr>
...
<input type=radio <?php print $moduleeLearningmoodle ?> name="moduleelearning" value="moodle" class=btradio1  > Moodle 
</tr>
