...
<?php
if (LAN == "oui") {
	print "<iframe src='http://support.triade-educ.com/support/dokeos/index.php?graph=".GRAPH."' width=100% height=400 MARGINWIDTH=0 MARGINHEIGHT=0 HSPACE=0 VSPACE=0 FRAMEBORDER=0 SCROLLING=no ></iframe>";
}else{
