...
if (file_exists($fichier_orig)) {
	$fichier=ereg_replace(".zip","",$_POST["patch_ftp"]);
...
?>
	<br><table>
	<?php if (!ereg('^000-',$fichier)) { ?>
		<tr><td>
		<form method="post" action="http://support.triade-educ.com/support/verifpatch.php" target='_blank' >
