...
<tr id='cadreCentral0'>
<td valign=top>
<i>&nbsp;&nbsp;Afin d'assurer la validité des fichiers Triade, nous vous suggérons d'installer le patch de référence MD5 avant chaque vérification. 
[ <a href="http://support.triade-educ.com/support/recupFichierMd5.php" target='_blank' >Télécharger la référence MD5</a> ] </i>
<br><br>
<ul>
<?php
...
<table border=0 >
<tr><td>
	<img src="./image/commun/stat0.gif" align=center>&nbsp;&nbsp;&nbsp;- Corrigé / réactualiser la page pour valider <br>
	...
	<img src="./image/commun/stat2.gif" align=center>&nbsp;&nbsp;&nbsp;- Erreur non corrigée / contacter le support Triade. &nbsp;&nbsp;<br>
	<img src="./image/commun/stat.gif" align=center>&nbsp;&nbsp;&nbsp;- Extension non implémenté, nécessaire dans certains modules. &nbsp;&nbsp;
</td></tr></table>
...
<tr><td>
&nbsp;&nbsp;&nbsp;
<img src="./image/on1.gif" height=8 width=8 align=center ><font class="T2"> Vérification des patchs  </font> &nbsp;&nbsp;&nbsp;
</td><td>
&nbsp;&nbsp;&nbsp;
<a href="#" id=lienpatch ><img src="./image/commun/stat<?php print $codepatch ?>.gif" align=center id="verifpatch"  border="0"></a>
&nbsp;&nbsp;&nbsp;
</td></tr>
	<script language="JavaScript" src="http://support.triade-educ.com/support/version-patch.php?v=<?php print VERSIONPATCH ?>"></script>
...
<tr><td>
&nbsp;&nbsp;&nbsp;
<img src="./image/on1.gif" height=8 width=8 align=center ><font class="T2"> Vérification fichier MD5 </font>  &nbsp;&nbsp;&nbsp;
</td><td>&nbsp;&nbsp;&nbsp;
	...
	?>
	<script language="JavaScript" src="http://support.triade-educ.com/support/version-md5.php?v=<?php print VERSIONMD5 ?>"></script>
	<script language="JavaScript">
	...
	if (updatemd5 == 1) { 
		...
		document.getElementById("lienmd5").href="http://support.triade-educ.com/support/recupFichierMd5.php";
	}
	</script>
...
<tr><td>
&nbsp;&nbsp;&nbsp;
<img src="./image/on1.gif" height=8 width=8 align=center ><font class="T2"> Vérification des fichiers Triade</font>  &nbsp;&nbsp;&nbsp;
</td><td>
&nbsp;&nbsp;&nbsp;
<?php
if ($codefic == 3) {
...
<tr><td>
&nbsp;&nbsp;&nbsp;
<img src="./image/on1.gif" height=8 width=8 align=center ><font class="T2"> Vérification structure base de donnée  </font> &nbsp;&nbsp;&nbsp;
</td><td>
&nbsp;&nbsp;&nbsp;
...
&nbsp;&nbsp;&nbsp;
	...
	<script language="JavaScript" src="http://support.triade-educ.com/support/verif_structure.php?md5=<?php print $dbbstructureMD5 ?>"></script>
	<script language="JavaScript">
...
<?php 
		...
		print "<img src='../image/commun/warning2.gif' align='left' /><font id='color3'><center>INFORMATION : Vous devez valider l'accès internet via le module [<a href='configuration.php'><font id='color3'>Config. Générale</font></a><font id='color3'>] pour une vérification totale.</font></center><br><br>";
...
<tr><td>
&nbsp;&nbsp;&nbsp;
<img src="./image/on1.gif" height=8 width=8 align=center ><font class="T2"> Vérification des groupes  </font> &nbsp;&nbsp;&nbsp;
</td><td>
&nbsp;&nbsp;&nbsp;
...
<tr><td>
&nbsp;&nbsp;&nbsp;
<img src="./image/on1.gif" height=8 width=8 align=center ><font class="T2"> Optimisation des répertoires </font>  &nbsp;&nbsp;&nbsp;
</td><td>
&nbsp;&nbsp;&nbsp;
...
<tr><td>
&nbsp;&nbsp;&nbsp;
<img src="./image/on1.gif" height=8 width=8 align=center ><font class="T2"> Vérification des répertoires </font>  &nbsp;&nbsp;&nbsp;
</td><td>
&nbsp;&nbsp;&nbsp;
...
<tr><td>
&nbsp;&nbsp;&nbsp;
<img src="./image/on1.gif" height=8 width=8 align=center ><font class="T2"> Vérification des matières</font> &nbsp;&nbsp;&nbsp;
</td><td>
&nbsp;&nbsp;&nbsp;
...
<tr><td>
&nbsp;&nbsp;&nbsp;
<img src="./image/on1.gif" height=8 width=8 align=center ><font class="T2"> Vérification des tables </font>&nbsp;&nbsp;&nbsp;
</td><td>
&nbsp;&nbsp;&nbsp;
...
<tr><td>
&nbsp;&nbsp;&nbsp;
<img src="./image/on1.gif" height=8 width=8 align=center ><font class="T2"> Vérification de l'agenda </font>&nbsp;&nbsp;&nbsp;
</td><td>
&nbsp;&nbsp;&nbsp;
...
<tr><td>
&nbsp;&nbsp;&nbsp;
<img src="./image/on1.gif" height=8 width=8 align=center ><font class="T2"> Vérification de la messagerie </font>&nbsp;&nbsp;&nbsp;
</td><td>
&nbsp;&nbsp;&nbsp;
...
<tr><td>
&nbsp;&nbsp;&nbsp;
<img src="./image/on1.gif" height=8 width=8 align=center ><font class="T2"> Sécurité des répertoires </font>  &nbsp;&nbsp;&nbsp;
</td><td>
&nbsp;&nbsp;&nbsp;
...
<tr><td>
&nbsp;&nbsp;&nbsp;
<img src="./image/on1.gif" height=8 width=8 align=center ><font class="T2"> Vérification des droits d'écritures</font>   &nbsp;&nbsp;&nbsp;
</td><td>
&nbsp;&nbsp;&nbsp;
...
<tr><td>
&nbsp;&nbsp;&nbsp;
<img src="./image/on1.gif" height=8 width=8 align=center ><font class="T2"> Vérification des fichiers de config.</font>   &nbsp;&nbsp;&nbsp;
</td><td>
&nbsp;&nbsp;&nbsp;
