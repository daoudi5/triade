...
if (update == 1) { 
	...
	if (updatemd5 == 1) {
		document.getElementById("infopatch").innerHTML="<font color=red><b>ATTENTION, VOUS DEVEZ INSTALLER LE PATCH MD5,<br /> AVANT D'EFFECTUER CETTE OPERATION, <br />PATCH DISPONIBLE : <a href='http://support.triade-educ.com/support/recupFichierMd5.php' target='_blank' ><font color=red>MODULE \"Triade MD5 \"</font></a></b></font>"; 
		document.formulaire.envoi.disabled=true;
	}
}
