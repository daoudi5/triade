...
if (update == 1) { 
	...
	document.getElementById("infopatch").innerHTML="<font class=T2>Envoyer la structure au support (support@triade-educ.com) <br />en indiquant votre version Triade, et votre N° de patch.</font>";
