...
function top_h(){
	if ((LAN == "oui") && (PUBHAUT != "oui")) {
		if (HTTPS == "oui") {
			...
			$url="http://www.triade-educ.com/sponsor/mactu-h.php?inc=".GRAPH."&https=".HTTPS."&productid=".PRODUCTID."&id=$idpers";
			print "<script src='http://www.triade-educ.com/sponsor/mactu0.php?productid=".PRODUCTID."'></script>";
			print "<script>";
			print "if (ok2) {";
...
function top_d() {
	if (LAN == "oui") {
		if (HTTPS == "oui") {
			...
			$url="http://www.triade-educ.com/sponsor/mactu-d.php?inc=".GRAPH."&https=".HTTPS."&productid=".PRODUCTID;
			print "<script src='http://www.triade-educ.com/sponsor/mactu0.php?productid=".PRODUCTID."'></script>";
			print "<script>";
			print "if (ok2) {";
...
function top_p(){
	if (LAN == "oui") {
		if (HTTPS == "oui") {
			...
			$url="http://www.triade-educ.com/sponsor/mactu-h.php?inc=".GRAPH."&https=".HTTPS."&productid=".PRODUCTID;
			print "<script src='http://www.triade-educ.com/sponsor/mactu0.php?productid=".PRODUCTID."'></script>";
			print "<script>";
			print "if (ok2) {";
