...
if (!file_exists("./common/config-sms.php")) {
	...
	$graph=GRAPH;
	print "<iframe width='100%' height=500 src='http://support.triade-educ.com/support/sms-inscription.php?url=$url&inc=$graph' MARGINWIDTH=0 MARGINHEIGHT=0 HSPACE=0 VSPACE=0 FRAMEBORDER=0 ></iframe>";
}else{
