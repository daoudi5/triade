...
/*Hauteur Mat*/	$hauteurMatiere=11;
		...
		$pdf->MultiCell(30,$hauteurMatiere,"$noteLV2 / 20",1,'R',0);
		$pdf->SetXY($X+=15,$Y);
		$pdf->SetXY($X+=15,$Y);
		...
		$pdf->SetXY($X,$Y+=$hauteurMatiere);
		$pdf->SetFont('Arial','',$policeSizeMatiere);
		$pdf->MultiCell($largeurMatiere,$hauteurMatiere,"Note Vie scolaire",1,'L',0);
		$pdf->SetXY($X+=$largeurMatiere,$Y);
		$pdf->SetFont('Arial','',$policeSizeMatiere-2);
		...
		// Latin ou corse ou histoire des arts ou découverte professionnelle 3h  //
		// ----------------------------------------------- //
		$X=3;
		$pdf->SetXY($X,$Y+=$hauteurMatiere);
		$pdf->SetFont('Arial','',$policeSizeMatiere);
		$pdf->MultiCell($largeurMatiere,$hauteurMatiere,"Corse/Hist.Arts/Latin/Déc.Pro.",1,'L',0);
		$pdf->SetXY($X+=$largeurMatiere,$Y);
		...
		$pdf->SetFont('Arial','',$policeSizeMatiere-2);
		$pdf->MultiCell(30,$hauteurMatiere,"$note",1,'R',0);
		$pdf->SetXY($X+=15,$Y);
		...
		$pdf->MultiCell($largeurMatiere,$hauteurMatiere,"Hist.Géo.-Educ. civique: ",1,'L',0);
		$pdf->SetXY($X+40,$Y);
		$pdf->SetFont('Arial','',$policeSizeMatiere-2);
		...
		$pdf->SetFont('Arial','',$policeSizeMatiere-2);
		$pdf->MultiCell($largeurMatiere,$hauteurMatiere,"",0,'L',0);
		...
		$pdf->SetXY($X+=$largeurMatiere,$Y);
		$pdf->SetFont('Arial','B',$policeSizeMatiere);
		$pdf->MultiCell(30,$hauteurMatiere*2,"",1,'C',0);  // Moyen
		$pdf->SetXY($X+2,$Y);
		$pdf->MultiCell(15,$hauteurMatiere*2,"$noteGlobalLV2",0,'C',0);  // Moyen
		$pdf->SetXY($X+2,$Y+3.5);
		$pdf->SetFont('Arial','B',$policeSizeMatiere-2);
		$pdf->SetFont('Arial','B',$policeSizeMatiere);

		$pdf->SetXY($X+=15,$Y);
		$pdf->MultiCell(15,$hauteurMatiere*2,"$noteGlobalDP6H",0,'C',0);  // DP6h
		$pdf->SetXY($X,$Y);
		$pdf->SetFont('Arial','B',$policeSizeMatiere-1);
		$pdf->MultiCell(15,$hauteurMatiere*2,"sur  220",0,'L',0);
		...
		$pdf->SetXY($X+3,$Y);
		$pdf->MultiCell(70,3,"très favorable",0,'L',0);
		$pdf->SetXY($X,$Y+=7);
		$pdf->MultiCell(3,3,"",1,'C',0);  // avis défavorable
		$pdf->SetXY($X+3,$Y);
		$pdf->MultiCell(70,3,"favorable",0,'L',0);
		$pdf->SetXY($X,$Y+=7);
		$pdf->MultiCell(3,3,"",1,'C',0);  // avis motivé:
		$pdf->SetXY($X+3,$Y);
		$pdf->MultiCell(70,3,"défavorable",0,'L',0);

            $pdf->SetXY($X+30,$Y+15);
		$pdf->MultiCell(70,3,"Le Principal, Mme Chassain Isabelle",0,'r',0);
		...
		$pdf->SetXY($X,$Y+=5);
		$pdf->MultiCell(30,5,"Agl, Itl/Esp",0,'C',0);
		...
		$X=3;
		$pdf->SetXY($X,$Y+=7);
		$pdf->MultiCell($tailleB2I,5,"(*) à cocher; Agl:Anglais Itl:Italien Esp:Espagnol ",1,'L',0);
