...
?>
	<tr><td colspan=3><div id="dhtmlgoodies_control"></div>
		<div style="width:410px;" class="dhtmlgoodies_contentBox" id="box<?php print $i ?>">
			...
			Plan : <a href="#" onclick="open('http://support.triade-educ.com/support/google-map-triade.php?etablissement=<?php print  urlencode($info[0][1])?>&adresse=<?php print urlencode($info[0][3]) ?>&ville=<?php print urlencode($info[0][5]) ?>&pays=<?php print urlencode($info[0][14])?>','_blank','width=450,height=350')" /><img src="image/commun/loupe.png" border="0" /></a><br>
			</font>
			<hr>
