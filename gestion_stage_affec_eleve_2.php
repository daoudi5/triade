...
<tr>
<td align=right width=45%><font class="T2"><?php print "Pour la période : Semestre / Trimestre" ?> :</font></td>
...
<td align=left>Début : <input type=text name="horairedebutjournalier" size=4  value='hh:mm' onKeyPress="onlyChar2(event)" > / Fin <input type=text name="horairefinjournalier" size=4   value='hh:mm' onKeyPress="onlyChar2(event)"  ></td>
</tr>
...
<tr><td colspan='2' align='center' ><span id='alerte' ><font id='color2'>Indiquer le numéro de stage ou du stage personnalisé </font></span></td></tr>
</table>
</form>
</td></tr></table>
<?php
