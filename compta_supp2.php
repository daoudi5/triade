...
?>
	...
	<td bgcolor='yellow' align='center' width=2% >Supprimer</td>
	</tr>
<?php
	...
	for($i=0;$i<count($data);$i++) {
		...
		print "<td valign='top'>&nbsp;".chercheNomVersement($data[$i][1])."</td>";
		print "<td valign='top'>&nbsp;".ereg_replace(' ','&nbsp;',affichageFormatMonnaie($data[$i][2]))."</td>";
		print "<td valign='top'>&nbsp;".nl2br($data[$i][4])."</td>";
		print "<td valign='top' align=center ><input type=button value='Supprimer' class='bouton2' onclick=\"open('compta_supp3.php?idvers=".$data[$i][1]."&date=".$data[$i][3]."&ideleve=".$ideleve."','_parent','')\" /></td>";
		print "</tr>";
