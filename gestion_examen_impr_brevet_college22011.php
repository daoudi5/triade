...
config_param_ajout($histoireart,"histoireart");
config_param_ajout($optionname,"optionname");
...
<option value="SANSDP6H" id='select1'><?php print "Sans DP6H" ?></option>
</select>
<br><br>
