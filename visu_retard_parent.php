...
<tr id='coulBar0' ><td height="2"><b><font   id='menumodule1' ><?php print LANGPARENT6 ?></font></b>
...
<TR>
<TD bgcolor='yellow' align=center width=10%><?php print preg_replace('/ /','&nbsp;',ucwords(LANGABS13)) ?> </td>
<TD bgcolor='yellow' align=center width=10%><?php print ucwords(LANGTE13) ?> </td>
...
?>
        ...
        <TD align=center valign=top><?php print timeForm($data_2[$j][1])?></td>
        <TD align=center valign=top><?php print $data_2[$j][5]?></td>
