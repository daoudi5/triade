...
if (($hashPostVar[membre] == 'administrateur') && $code==1) :
      ...
      enr_trace($nav,$os,$ip,$nom,$prenom,"Administrateur");
   ...
   elseif ($hashPostVar[membre] == 'parent' && $code==1) :
      ...
      enr_trace($nav,$os,$ip,$nom,$prenom,"Parent");
      enr_statUtilisateur($nom,$prenom,$id_pers,"menuparent",$id_session);
      ip_timeout_clear($ip);
      statConecParHeure(dateH());
      header("Location: acces2.php?id");
   ...
   elseif ($hashPostVar[membre] == 'vie scolaire' && $code==1) :
      ...
      $_SESSION["ip"]=$ip;
      $_SESSION["id_session"]=$id_session;
      enr_trace($nav,$os,$ip,$nom,$prenom,"Vie Scolaire");
      enr_statUtilisateur($nom,$prenom,$id_pers,"menuscolaire",$id_session);
      ip_timeout_clear($ip);
      statConecParHeure(dateH());
      setcookie("nom","$nom");
      setcookie("prenom","$prenom");
   ...
   elseif ($hashPostVar[membre] == 'tuteurstage' && $code==1) :
      ...
      $_SESSION["ip"]=$ip;
      $_SESSION["id_session"]=$id_session;
      enr_trace($nav,$os,$ip,$nom,$prenom,"Tuteur Stage");
      enr_statUtilisateur($nom,$prenom,$id_pers,"menututeur",$id_session);
      ip_timeout_clear($ip);
      statConecParHeure(dateH());
      setcookie("nom","$nom");
      setcookie("prenom","$prenom");
 ...
 elseif ($hashPostVar[membre] == 'personnel' && $code==1) :
      ...
      $_SESSION["ip"]=$ip;
      $_SESSION["id_session"]=$id_session;
      enr_trace($nav,$os,$ip,$nom,$prenom,"Personnel");
      enr_statUtilisateur($nom,$prenom,$id_pers,"menupersonnel",$id_session);
      ip_timeout_clear($ip);
      statConecParHeure(dateH());
      setcookie("nom","$nom");
      setcookie("prenom","$prenom");
