...
<font class="T2"><?php print LANGABS5?> :</font>
...
<form method=post action="sms-abs.php"><script language=JavaScript> buttonMagicSubmit3("<?php print "Envoi SMS"?>","sms","<?php print $disabled?>")</script></form></td></tr></table>
</td></tr>

<tr><td align=right>
<font class="T2"><?php print LANGABS6?> :</font>
</td><td align=left><table width="100%"><tr><td>
...
<form method=post action="sms-rtd.php"><script language=JavaScript> buttonMagicSubmit3("<?php print "Envoi SMS"?>","sms","<?php print $disabled?>")</script></form>
</td></tr></table>
</td></tr>
