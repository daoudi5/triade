...
&nbsp;&nbsp;<font class='T2'><?php print LANGMESS355 ?> : </font><input type='button' class="button" value="Consulter" onclick="open('recupComClasse.php?idclasse=<?php print $_POST["saisie_classe"] ?>&tri=<?php print $_POST["saisie_trimestre"] ?>','_self','')" /> 
