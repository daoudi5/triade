...
<?php print "Le fichier excel à transmettre DOIT contenir 12 champs" ?>
<BR>
<BR>
...
<table width="100%" border="1" bgcolor="#FCE4BA" bordercolor=#000000 >
        <tr bgcolor="#FFCC00">
          <td valign=top >1) <?php print "Email Etudiant" ?></td>
          <td valign=top >2) <?php print "Nom société" ?></td>
	  <td valign=top >3) <?php print "Adresse société" ?></td>
	  <td valign=top >4) <?php print "Code Postal société" ?></td>
	</tr><tr bgcolor="#FFCC00" >
	  <td valign=top >5) <?php print "Ville société" ?></td>
	  <td valign=top >6) <?php print "Civilité Tuteur Stage" ?></td>
	  <td valign=top >7) <?php print "Nom Tuteur Stage" ?></td>
          <td valign=top >8) <?php print "Prénom Tuteur Stage" ?></td>
	</tr><tr bgcolor="#FFCC00" >
          <td valign=top >9) <?php print "Téléphone Société" ?></td>
          <td valign=top >10) <?php print "Email Tuteur Stage" ?></td>
          <td valign=top >11) <?php print "Mot de passe Tuteur Stage" ?></td>
          <td valign=top >12) <?php print "N° de Stage" ?></td>
	</tr>
...
&nbsp;&nbsp;&nbsp;
<input type=button class="BUTTON" value='<?php print "Exemple fichier xls" ?>' onclick="open('./librairie_php/import-entreprise-pigier.xls','_blank','')" />
&nbsp;&nbsp;&nbsp;
