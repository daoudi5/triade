...
<br><br>
<ul>
<table><tr><td><script language="JavaScript" >buttonMagicSubmit3('<?php print LANGAGENDA28 ?>','createmail','')</script></td>
<td><script language="JavaScript" >buttonMagicRetour('gestion_central_stage.php','_top')</script></td>
<td><?php print $messagetitre ?></td></tr></table></ul></form>
</body>
</html>
