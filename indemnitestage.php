...
<td ><br>
     <!-- // fin  -->
<font class="T2"><?php print "Moyenne indemnité de stage" ?> :
<br><br>
<table width="100%" border="1" align="center">
<tr>
<td bgcolor='yellow' ><font class="T2"><?php print "Classe" ?></font></td>
<td bgcolor='yellow' width='5'><font class="T2">&nbsp;Moyenne&nbsp;</font></td>
</tr>
<?php
...
for($i=0;$i<count($data);$i++) {
	...
	print "<td><b>&nbsp;".$val." ".unitemonnaie()."</b> </td>";
	print "</tr>";
?>
</table>
