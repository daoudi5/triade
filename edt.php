...
<tr><td align='right'><font class="T2"><?php print LANGEDT7 ?> :</td><td><input type=button class="bouton2" onclick="open('edt_visu.php','edt','width=1050,height=650,resizable=yes,personalbar=no,toolbar=no,statusbar=no,locationbar=no,menubar=no,scrollbars=yes')" value="<?php print LANGBREVET1  ?>" />
</td></tr>
