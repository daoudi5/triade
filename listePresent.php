...
<td ><br><br>
     <!-- // fin  -->
<form method=post name=formulaire  action="listePresent2.php">
...
<script language=JavaScript>buttonMagicRetour('gestion_abs_retard.php','_parent') //text,nomInput</script>
