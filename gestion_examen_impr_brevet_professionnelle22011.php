...
if ($typebull == "brevetcollege") {   // brevet série college
	...
	$bull="brevet_construction02.php"; 
	$retour="gestion_examen_impr_brevet_college.php";  
}
if ($typebull == "brevetprofessionnelle") {   // brevet série pro
	validerequete("menuadmin"); 
	$bull="brevet_construction03.php"; 
	$retour="gestion_examen_impr_brevet_professionnelle_2011.php";  
}
//-----------------------------------------------
?>
...
<?php print $_COOKIE["anneeScolaire"] ?><br><br>
...
if ($matphychi == "1") $checkmatphychi="checked='checked'";
if ($matmusic == "1") $checkmatmusic="checked='checked'";
if ($matsvt == "1") $checkmatsvt="checked='checked'";
?>
<br><br>
<font class=T2>Note arrondi au demi-point supérieur : </font><input type="checkbox" name=arrondi value="1" checked="checked" /> (oui)
<br><br>
<font class=T2>Toutes les notes enregistrées sont sur 20 : </font><input type="checkbox" name='noteformat' value="1" checked="checked" /> (oui)
<br><br>
<font class=T2>Afficher la matière S.V.T : </font><input type="checkbox" name='matsvt' value="1" <?php print $checkmatsvt ?> /> (oui)
<br><br>
<font class=T2>Afficher la matière Physique-Chimie : </font><input type="checkbox" name='matphychi' value="1"  <?php print $checkmatphychi ?> /> (oui)
<br><br>
<font class=T2>Afficher la matière Education musicale : </font><input type="checkbox" name='matmusic' value="1"  <?php print $checkmatmusic ?> /> (oui)
<br><br>
...
<br><br>
<font class=T2>Prise en compte des notes correctifs Notanet : </font><input type='checkbox' name="recupNoteNotanet" value='1' <?php print $recupNoteNotanet ?> /> <i>(oui)</i>
<br><br><br>
