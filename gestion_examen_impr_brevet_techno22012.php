...
$cadredubas=$_POST["cadredubas"];
if ($cadredubas == "") $cadredubas=0;
config_param_ajout($cadredubas,"cadredubas");
...
if ($typebull == "brevetcollege") {   // brevet série college
	...
	$bull="brevet_construction04.php"; 
	$retour="gestion_examen.php";  
}
//-----------------------------------------------
?>
...
<input type=hidden name='option' value="<?php print $_POST["option"];?>" >
<input type=hidden name='viescolaire' value="<?php print $_POST["viescolaire"];?>" >
<input type=hidden name='examenEPS' value="<?php print $_POST["examenEPS"];?>" >
<input type=hidden name='examenPREV_SANTE_ENV' value="<?php print $_POST["examenPREV_SANTE_ENV"];?>" >
<input type=hidden name='type_colonne' value="STA" >
