...
if (lan == "oui") {
	document.write("<img src='./image/cube.gif' width='4' height='4'> <a id='menumodule0' href='#' onClick=\"open('http://support.triade-educ.com/support/triade-shop.php','triadeshop','width=800,height=600,resizable=no,personalbar=no,toolbar=no,statusbar=no,locationbar=no,menubar=no,scrollbars=yes');\" >"+langmenuadmin526+"</a><br>");
}
document.write(" </p>");
document.write("</td>");
document.write("</tr>")
...
if (moduleparentabsence == "oui") {  document.write("<img src='./image/cube.gif' width='4' height='4'> <a  id='menumodule0' href='./visu_absence_parent.php'>"+langmenuparent23+"</a><br>"); }
if (moduleparentgestionsavoiretre == "oui") document.write("<img src='./image/cube.gif' width='4' height='4'> <a id='menumodule0' href='./savoiretrevisu.php'>"+langmenuadmin912+"</A><br>");
if (moduleparentdispence == "oui") { document.write("<img src='./image/cube.gif' width='4' height='4'> <a  id='menumodule0' href='./visu_dispence_parent.php'>"+langmenuparent24+"</a><br>"); }
...
document.write("<img src='./image/cube.gif' width='4' height='4'> <a id='menumodule0' href='#' onclick=\"open('edt_visu_el.php','edt_el','width=1050,height=650,resizable=yes,personalbar=no,toolbar=no,statusbar=no,locationbar=no,menubar=no,scrollbars=yes')\">"+langmenuparent31+"</a><br>");
document.write("<img src='./image/cube.gif' width='4' height='4'> <a id='menumodule0' href='./circulaire_liste.php'>"+langmenuparent32+"</a><br>");
document.write("<img src='./image/cube.gif' width='4' height='4'> <a id='menumodule0' href='./delegue_visu.php'>"+langmenuparent33+"</a><br>");
if (moduleparentstage == "oui") {  document.write("<img src='./image/cube.gif' width='4' height='4'> <a id='menumodule0' href='./gestion_stage_el.php'>"+langmenueleve517+"</a><br>"); }
if (moduleplanningparent == "oui") { document.write("<img src='./image/cube.gif' width='4' height='4'> <a id='menumodule0' href='./calendrier_evenement_visu_readonly.php'>"+langmenuparent34bis+"</a><br>");}
