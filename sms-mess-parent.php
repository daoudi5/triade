...
for($i=0;$i<count($data);$i++)
	...
	<td bgcolor="#FFFFFF"><a style="text-decoration:underline" href="sms-mess.php?eid=<?php print $data[$i][3]?>" onMouseOver="AffBulle('<font face=Verdana size=1><?php print LANGSMS8 ?></FONT>'); window.status=''; return true;" onMouseOut='HideBulle()'><?php print strtoupper($data[$i][1])?></a></td>
