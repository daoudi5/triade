...
<form action='./base_de_donne_importation1.php'  method="post">
<tr>
...
<form action='./base_de_donne_importation10.php'  method="get">
...
<form action='./base_de_donne_importation10.php'  method="get">
<input type='hidden' name='id' value='scolaire' /> 
<tr>
...
<form action='./base_de_donne_importation10.php'  method="get">
<input type='hidden' name='id' value='administration' /> 
<tr>
<td align=right><font class="T2"><?php print "Import du personnel de direction : " ?></font></td>
<td align=left><script language=JavaScript>buttonMagicSubmit("<?php print CLICKICI ?>","rien");</script></td>
</tr>
</form>
<tr><td></td></tr>
...
<tr>
<td align=right><font class="T2"><?php print "Import des comptes du personnel : " ?></font></td>
<td align=left><script language=JavaScript>buttonMagicSubmit("<?php print CLICKICI ?>","rien");</script></td>
</tr>
</form>
<tr><td></td></tr>
