...
if (!defined('INTITULEELEVE')) { define("INTITULEELEVE","ÈlËve"); }
...
print "	       $rev";
print "        <br /> Tous droits rÈservÈs <br />";
...
droit();
print "</textarea>";
print "        <hr /><table width=95%><tr><td align=left> <font size=2 ><a href='http://www.triade-educ.com' target='_blank' >Triade©</a>, ".DATEOUT." </font></td><td align=right><input type=button value='Fermer FenÍtre' onclick='masque_menu()' class='bouton2' ></td></tr></table>";
print "<br /></div></div>";
print "<script type=\"text/javascript\">";
...
function TextNoAccentLicence($Text){
