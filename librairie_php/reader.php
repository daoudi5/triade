    ...
    */
    ...
    function read($sFileName) {
        ...
        if($res === false) {
        	...
        	// bad file
			print "<font size=3><b><font color=red>ATTENTION</font> le fichier n'est pas au bon format. <br>Merci de bien vouloir vérifier si le fichier est bien enregistré au format type Excel et non DBF <br> Pour cela ouvrer le fichier Inscriptions_SAP.xls et l'enregistrer au format type : <u>Classeur Microsoft Excel(*.xls)</u> <br><br></b>" ;
