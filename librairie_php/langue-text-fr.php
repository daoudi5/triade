...
define("LANGMESS4","Message à un enseignant : ");
...
define("LANGPER10","ATTENTION ce module est à utiliser lors d'une nouvelle affectation,<br> il détruit toutes les notes des ".INTITULEELEVE."s  des classes affectées."); //
...
define("LANGBULL4","<a href=\"#\" onclick=\"open('./accrobat.php','acro','width=500,height=350')\"><b><FONT COLOR=red>ATTENTION</FONT></B> Besoin de l'outil <B>Adobe Acrobat Reader</B>.  Logiciel et téléchargement gratuits  cliquez <B>ICI</B></A>");
// -----------------------------------------------------------------------------------------------------------------------
...
define("LANGCHAN1","ATTENTION: ce module est à utiliser <br>lorsque vous souhaitez effectuer <br> un changement de classe pour les ".INTITULEELEVE."s");
define("LANGCHAN3","ATTENTION, des données de l\'".INTITULEELEVE." \\n ou des ".INTITULEELEVE."s concerné(s) par le changement de classe seront supprimées");
//----------------------------------------------------------------------//
...
define("LANGaffec_mod_key3","ATTENTION ce module est à utiliser lors de modification  d'affectation,<br> il détruit toutes les notes des ".INTITULEELEVE."s  des classes modifiées. ");
...
define("LANGBASE16"," Les colonnes sont représentées sous la forme : <b>nom de login ; prénom de login ; mot de passe Parent ; mot de passe ".ucfirst(TextNoAccentLicence2(INTITULEELEVE))." en clair ; classe de l'".INTITULEELEVE." </b>");
...
define("LANGPARAM5","Le certificat de scolarité des ".INTITULEELEVE."s de la classe ");
...
define("LANGETUDE35","Indiquer les classes pour l'affectation des ".INTITULEELEVE."s à cette étude");
...
define("LANGBASE8bis","pour les ".INTITULEELEVE."s <u>affectés</u> et <u>sans classe</u>");
...
define("LANGAFF8","ATTENTION ce module est à utiliser lors de la suppression d'affectation,<br> il détruit toutes les notes des ".INTITULEELEVE."s  des classes supprimées.");
...
define("LANGMESS79","Notes visibles aux élèves le ");
