...
define("LANGDONENR","Donnée enregistrée");
...
// titre
//-------------------------------
define("LANGTITRE1","Actualité - Evènement(s) du mois");
define("LANGTITRE2","Actualité - News");
...
define("LANGTITRE6","Création d'un compte administrateur");
define("LANGTITRE7","Création d'un compte vie scolaire");
define("LANGTITRE8","Création d'un compte enseignant");
define("LANGTITRE9","Création d'un compte suppléant");
define("LANGTITRE10","Création d'un compte élève");
define("LANGTITRE11","Création d'un groupe"); //
define("LANGTITRE12","Création d'une classe"); //
define("LANGTITRE13","Création d'une matière"); //
define("LANGTITRE14","Création d'une sous-matière"); //
define("LANGTITRE15","Mise en place des professeurs principaux");
define("LANGTITRE16","Création d'affectation");
define("LANGTITRE17","Création d'affectation pour la classe");
...
define("LANGTITRE30","Recherche d'un élève");
define("LANGTITRE31","Importation du fichier GEP");
define("LANGTITRE32","Trombinoscope des élèves");
...
//------------------------------
define("LANGFETE","Bonne Fête ");
define("LANGFEN1","Evènement du jour");
...
define("LANGMESS2","Envoyer un message à l'administration : ");
define("LANGMESS3","Envoyer un message à la vie scolaire : ");
define("LANGMESS4","Envoyer un message à un enseignant : ");
define("LANGMESS5","Envoyer un message à un parent d'élève en classe : ");
define("LANGMESS6","Message envoyé");
define("LANGMESS7","Actualité enregistrée");
define("LANGMESS8","Message envoyé");
define("LANGMESS9","Répondre au message - le ");
define("LANGMESS10",'Les dates trimestrielles ne sont pas enregistrées.');
define("LANGMESS11",'Veuillez prévenir l\'administration.');
...
define("LANGMESS14",'Les affectations de cette classe  ne sont pas enregistrées.');
...
define("LANGMESS22","Envoyer un message à un groupe mail : ");
...
define("LANGBT8","Liste des administrateurs / Trombinoscope");
define("LANGBT9","Liste de la Vie Scolaire  / Trombinoscope");
define("LANGBT10","Liste des enseignants / Trombinoscope");
...
define("LANGBT26","Créer une classe"); //
...
define("LANGBT31","Entrer dans la classe");
...
define("LANGBT42","Valider les élèves non enregistrés");
...
define("LANGELE28","Elève créé -- L'équipe Triade"); //
define("LANGELE29","Elève déjà existant  -- L'équipe Triade"); //
//------------------------------------------------------------
define("LANGGRP1","Intitulé du groupe"); //
define("LANGGRP2","Indiquez les classes pour la création du groupe"); //
define("LANGGRP3","Sélectionnez les différentes classes en maintenant la touche"); //
...
define("LANGGRP7","Nouvelle classe créée -- L'équipe Triade"); //
...
define("LANGAFF2","!! La création d'affectation <u>supprime</u> toutes les notes de la classe !!</u>"); //
...
define("LANGPER7","professeur principal en "); //
define("LANGPER8","en classe de "); //
define("LANGPER9","Module d'affectation des classes."); //
define("LANGPER10","ATTENTION ce module est à utiliser lors d'une nouvelle affectation,<br> il détruit toutes les notes des élèves  des classes affectées."); //
define("LANGPER11","ATTENTION, les notes des classes sélectionnées  seront supprimées. \\n Souhaitez-vous continuer ? \\n\\n Equipe Triade"); //
define("LANGPER12","Indiquez le code d'accès.");
define("LANGPER13","Vérification du code");
define("LANGPER14","Nombre de matières");
define("LANGPER15","Création d'affectation pour la classe");
define("LANGPER16","Nb");
define("LANGPER17","Matière");
...
define("LANGIMP6","Le fichier à transmettre <FONT color=RED><B>DOIT</B></FONT> contenir <FONT COLOR=red><B>36</B></FONT> champs <I>(vides ou non vides)</I> séparés par un même séparateur le \"<FONT color=red><B>;</B></font>\" <I>Soit la présence de 35 fois le caractère \"<FONT color=red><B>;</B></font>\"</I>");
...
define("LANGIMP29","Numéro élève");
define("LANGIMP30","ATTENTION, la destruction de la base sera automatique. \\n Souhaitez-vous continuer ? \\n\\n L\'Equipe Triade");
define("LANGIMP31","ATTENTION : ce module est à utiliser lors de la première utilisation,<br> il détruit toutes les informations des élèves (notes, bulletins, vie scolaire).<br /> * champ obligatoire");
define("LANGIMP39","Indiquer le fichier à transmetre ");
define("LANGIMP40","Fichier transmis -- L'équipe Triade ");
define("LANGIMP41","Le nombre de champs n'est pas respecté ");
define("LANGIMP42","Indiquer pour chaque référence la classe correspondante ");
define("LANGIMP43","Fichier non enregistré ");
// ------------------------------------------------------------------------------
define("LANGABS1","Gestion absences - retards du jour");
define("LANGABS2","Plannifier une absence ou retard");
define("LANGABS3","Indiquer le nom de l'élève");
define("LANGABS4","Lister les absences ou retards non justifiés");
define("LANGABS5","Liste des <b>absences</b> non justifiées");
define("LANGABS6","Liste des <b>retards</b> non justifiés");
define("LANGABS7","Visualiser et/ou modifier une absence ou retard");
define("LANGABS8","Indiquer le nom de l'élève");
...
define("LANGABS26","Gestion Absence - Retard  Plannification");
define("LANGABS27","Enregistrer la donnée de ");
define("LANGABS28","Donnée Enregistrée ");
...
define("LANGABS32bis","etard à "); //suite
define("LANGABS33","en");
define("LANGABS34","de");
...
define("LANGPROJ6","<font class=T2>Aucun élève dans cette classe</font>");
define("LANGPROJ7","Nombre de retards");
define("LANGPROJ8"," Cumul");
define("LANGPROJ9","Discipline");
define("LANGPROJ10","minutes");
define("LANGPROJ11","Nombre de retenues");
define("LANGPROJ12","attribué par ");
define("LANGPROJ13","Liste");
define("LANGPROJ14","Moy Elève");
define("LANGPROJ15","Moy Classe");
define("LANGPROJ16","Moyenne Elève");
// ----------------------------------------------------------------------------
define("LANGDISP1","<font class=T2>aucun élève à ce nom</font>");
...
define("LANGASS31","TRIADE est un produit unique et in&eacute;dit, aussi, n'hésitez pas à nous transmettre vos conseils et suggestions afin que le site r&eacute;pondre aux attentes r&eacute;elles des utilisateurs ! Merci &agrave; vous :-)");
...
// -----------------------------------------------------------------------------
define("LANGRECH1","<font class=T2>aucun élève dans la classe</font>");
define("LANGRECH2","Recherche de ");
define("LANGRECH3","<font class=T2>aucun élève pour cette recherche</font>");
define("LANGRECH4","Information / Modification");
// ---------------------------------------------------------------------------------
define("LANGBASE1","ATTENTION : ce module est à utiliser lors de la première utilisation,<br> il détruit toutes les informations des élèves  (notes, bulletins, vie scolaire).");
...
define("LANGBASE6","Total d'élèves dans le fichier DBF ");
define("LANGBASE7","Total d'élèves en classe ");
define("LANGBASE8","Total d'élèves sans classe ");
...
define("LANGBULL4","<b><FONT COLOR=red>ATTENTION</FONT></B> Besoin de l'outil <B>Adobe Acrobat Reader</B>.  Logiciel et téléchargement gratuits  cliquez <a href=\"#\" onclick=\"open('./accrobat.php','acro','width=500,height=300')\"><B>ICI</B></A>");
// -----------------------------------------------------------------------------------------------------------------------
define("LANGPARENT1","aucun message");
define("LANGPARENT2","Aucun délégué affecté pour le moment");
define("LANGPARENT3","Elève(s) délégué(s)");
define("LANGPARENT4","Parent(s) délégué(s)");
define("LANGPARENT5","Liste des délégués");
//----------------------------------------------------------------------//
define("LANGPURG1","Module de mise à zéro de la base");
define("LANGPUR2","Module de mise à zéro de la base");
define("LANGPUR3","ATTENTION: ce module est à utiliser <br>lorsque vous souhaitez effacer les données de la base.");
...
define("LANGPUR6","Information : La sélection \"Elèves\" implique automatiquement la suppression des notes, absences, disciplines, dispenses, retards");
define("LANGPUR7","Indiquer l'élément ou les éléments  à  détruire : ");
define("LANGPUR8","A conserver");
define("LANGPUR9","A Supprimer");
//----------------------------------------------------------------------//
define("LANGCHAN0","Module pour le changement de classe d'un ou de plusieurs élèves");
define("LANGCHAN1","ATTENTION: ce module est à utiliser <br>lorsque vous souhaitez effectuer un changement de classe pour les élèves");
define("LANGCHAN3","ATTENTION, l\'ensemble des données de l\'élève ou des élèves concerné(s) par le changement de classe sera supprimé");
//----------------------------------------------------------------------//
...
//----------------------------------------------------------------------//
define("LANGPROFR1",'Indiquez des élèves en retard');
...
//----------------------------------------------------------------------//
// Module Stage Pro
define("LANGSTAGE1","Plannification des stages ");
...
define("LANGSTAGE13","Gestion des élèves ");
define("LANGSTAGE14","Visualiser les élèves en entreprise ");
define("LANGSTAGE15","Affecter un élève à une entreprise ");
define("LANGSTAGE16","Modifier les caractéristiques d'un élève ");
define("LANGSTAGE17","Supprimer l'attribution d'un élève ");
...
define("LANGCALEN9","Devoir Sur Table d'aujourd'hui");
//----------------------------------------------------------------------//
//module reservation
...
define("LANGRESA18","Information complémentaire");
...
define("LANGTPROBL11","Merci de votre question -- L'équipe Triade");
...
define("LANGFORUM1","Forum - Liste des messages");
...
define("LANGPROF26","Information sur l'élève");
define("LANGPROF27","Renseignement administratif");
define("LANGPROF28","Informations sur la vie scolaire");
define("LANGPROF29","Informations médicaux");
...
define("LANGTP23"," ATTENTION - Demande de réservation salle ou équipement  - RUBRIQUE");
...
define("LANGIMP52","mot de passe élève");
...
define("LANGacce_ref3","Pour acc&eacute;der &agrave; votre compte, vous devez vous connecter.");
define("LANGacce1","L'élève ");
...
define("LANGacce3","L'élève ");
define("LANacce31","ne s'est pas présenté</b></font> à la vie scolaire (CPE), <b>pour la retenue</b>,  suite à la categorie :");
...
define("LANGaccrob11","T&eacute;l&eacute;chargement du Logiciel Adobe Acrobat Reader 5.1 fr");
define("LANGaccrob2","71011 Mo  pour Windows NT/95/98");
define("LANGaccrob3","Temps du téléchargement :");
define("LANGaccrob4","en 56 K : 20 min et 53.4 s.");
define("LANGaccrob5","en 33 K : 35 min et 31.2 s.");
define("LANGaccrob6","en 512K : 2 min et 16.2 s.");
define("LANGaccrob7","T&eacute;l&eacute;chargement du Logiciel Adobe Acrobat Reader 6.O.1 fr");
...
define("LANGaccrob11","en 512K : 0 min et 6.6 s ");
define("LANGaffec_cre21","Création d'affectation pour la classe ");
...
define("LANGaffec_mod_key3","ATTENTION ce module est à utiliser lors de modification  d'affectation,<br> il détruit toutes les notes des élèves  des classes modifiées. ");
define("LANGaffec_mod_key4","ATTENTION, la destruction des notes des classes sélectionnées  seront supprimées. \\n Souhaitez-vous continuer ? \\n\\n L\'équipe Triade");
define("LANGattente1","Attente - Triade");
define("LANGattente2","Veuillez Patientez S.V.P ....");
...
define("LANGbasededon31","Indiquer pour chaque référence la classe correspondante");
define("LANGbasededon32","Choix ...");
define("LANGbasededon33","aucun");
define("LANGbasededon34","L'envoi du fichier peut durer de <b>2 à 4 minutes</b> en fonction du nombre d'élèves.");
define("LANGbasededon35","Le fichier doit être au format <b>dbf</b> et doit être <b>F_ele.dbf</b>");
define("LANGbasededon41","Erreur sur le nombre de classes !!! - Contacter l'équipe Triade <br /><br /> support@triade-educ.com</center>");
define("LANGbasededon42","Erreur sur la saisie des classes, une classe est répétée plusieurs fois -- L'équipe Triade");
...
define("LANGbasededoni33","Import des élèves : ");
...
define("LANGbasededoni92","Erreur sur le nombre de classes !!! - Contacter le l'équipe Triade <br />");
define("LANGbasededoni93","Erreur sur la saisie des classes, une classe est répétée plusieurs fois -- L'équipe Triade");
define("LANGbasededoni94","Donnée de la base traitée -- L'équipe Triade<br />");
define("LANGbasededoni95","Total d'élève  enregistré dans la base : ");
define("LANGPIEDPAGE","<p> La <b>T</b>ransparence et la <b>R</b>apidité de l'<b>I</b>nformatique <b>A</b>u service <b>D</b>e l'<b>E</b>nseignement<br>Pour visualiser ce site de façon optimale :  résolution minimale : 800x600 <br>  © 2000 - 2006 Triade - Tous droits réservés");

define("LANGAPROPOS1","Version");
define("LANGAPROPOS2","Tous droits réservés");
...
define("LANGBASE16"," Les colonnes sont représentées sous la forme : <b>nom de login ; prénom de login ; mot de passe Parent ; mot de passe Elève en clair</b>");
...
define("LANGSUPP14","Suppression d'un élève dans la  classe");
define("LANGSUPP15","Cliquer sur l'élève à supprimer");
define("LANGSUPP16","Suppression d'un élève");
define("LANGSUPP17","va être supprimé de la base");
define("LANGSUPP18","Toutes les informations sur cet élève vont être supprimées, à savoir : <br> (notes, absences, retards, dispences, sanctions, informations, messageries, ...)");
...
define("LANGADMIN","Administrateur");
...
define("LANGGRP13","Liste Elèves");
define("LANGGRP14","Liste des groupes");
define("LANGGRP15","Création d'un groupe");
define("LANGGRP16","Indiquez les élèves dans le groupe");
...
define("LANGGRP22","Indiquer une classe pour la création du groupe S.V.P. \\n\\n L'équipe Triade");
define("LANGGRP23","Liste des élèves du groupe");
...
define("LANGCHER4","Effectuer la recherche d'un élève à partir du nom : <b>cliquez ici</b>");
...
define("LANGCONFIG3","Indiquer la liste des parents d'élèves qui recevront un courrier");
...
define("LANGERROR03","Accès impossible à la base pour cette action . <BR><BR>Un mail a été envoyé automatiquement à l'auto-support TRIADE.");

define("LANGABS54","est déjà noté absent pour cette date");
define("LANGABS55","est déjà noté en retard pour cette date");
...
define("LANGPARAM16","Enregistrement effectué -- Equipe Triade");

define("LANGCERTIF1","Le certificat de scolarité de ");
define("LANGCERTIF1bis","est disponible, au format PDF");


define("LANGRECHE1","Informations sur l'élève");

define("LANGBT52","Modifier les données");

define("LANGEDIT1","Données introuvables");

define("LANGMODIF1","Mise à jour d'un compte Elève");
define("LANGMODIF2","Renseignements sur l'élève");
...
define("LANGBULL10","Indiquez le numéro de la période");
...
define("LANGBULL16","Nom de l'élève");
...
define("LANGBULL39","Assiduité et comportement au sein d'établissement : ");
...
define("LANGBULL43","ANN&Eacute;E SCOLAIRE");
...
define("LANGDISC13","<font color=red>C</font></B>ochez la case si l\'élève est soit en retenue soit sanctionné.");
...
define("LANGDISC33","ATTENTION l'élève ");
...
define("LANGCIRCU11","<font face=Verdana size=1><B><font color=red>C</font></B>irculaire au format : <b> doc</b>, <b>pdf</b>, <b>txt</b>.</FONT>");
...
define("LANGPROFP5","Informations sur l'élève");
...
define("LANGPROFP16","Elève délégué");
define("LANGPROFP17","Parent(s) délégué(s)");
define("LANGPROFP18","Elève(s) délégué(s)");
define("LANGPROFP19","Tél."); // pour téléphone
define("LANGPROFP20","Mail");
define("LANGPROFP21","Complément d'informations médicales sur l'élève");

define("LANGETUDE1","Gestion des études");
define("LANGETUDE2","Affectation des élèves à l'étude");
...
define("LANGETUDE8","Affecter un élève à une étude");
define("LANGETUDE9","Modifier un élève à une étude");
define("LANGETUDE10","Supprimer un élève d'une étude");
...
define("LANGETUDE30","L'étude posséde des élèves. Supprimer la liste des élèves de l'étude avant de supprimer l'étude");
define("LANGETUDE31","Liste élève");
define("LANGETUDE32","Liste des élèves");
define("LANGETUDE33","Affectation d'un élève à une étude");
define("LANGETUDE34","Choix de l'étude");
define("LANGETUDE35","Indiquer les classes pour l'affectation des élèves à cette étude");
define("LANGETUDE36","Intitulé de l'étude");
define("LANGETUDE37","Indiquez les élèves dans cette étude");
define("LANGETUDE38","autorisé à sortir");
define("LANGETUDE39","Enregistrer l'étude");
define("LANGETUDE40","Autre étude");
define("LANGETUDE41","Modifier l'étude d'un élève");
define("LANGETUDE42","Elève en étude");
define("LANGETUDE43","Enregister les modifications");
define("LANGETUDE44","Sortie autorisée");
define("LANGETUDE45","Supprimer l'étude d'un élève");
...
define("LANGTRONBI1","Visualisation Trombinoscope");
define("LANGTRONBI2","Modifier Trombinoscope");
define("LANGTRONBI3","Attention format du fichier non conforme");
define("LANGTRONBI4","Impossible photo de taille non conforme");
define("LANGTRONBI5","Nom élève");
define("LANGTRONBI6","Prénom élève");
define("LANGTRONBI7","la photo");
define("LANGTRONBI8","ajouter photo");


define("LANGBASE19","Le fichier sélectionné n'est pas valide");
define("LANGBASE20","Elève sans classe");
define("LANGBASE21","Nombre d'élèves sans classe");
define("LANGBASE22","Affichage des 30 premiers");
define("LANGBASE23","Changement de classe pour les élèves");
define("LANGBASE24","Changement Terminé");
define("LANGBASE25","AVANT TOUTES MODIFICATIONS CONSULTER NOTRE AIDE");
define("LANGBASE26","Changement de classe pour les élèves de la classe");
define("LANGBASE27","Information sur le changement de classe d'un élève");
define("LANGBASE28","<b>Pas de changement.</b> <i>(Avec l'option 'choix ...')</i>");
define("LANGBASE29","Aucune suppression d'information de l'élève n'est réalisée.");
define("LANGBASE30","<b>Le changement de classe.</b> <i>(Avec indication d'une classe)</i>");
define("LANGBASE31","Suppression notes, abs, retards, disciplines, dispenses  de l'élève.");
define("LANGBASE32","<b>Quitte l'école.</b>  <i>(Avec l'option 'Quitte l'école')</i>");
define("LANGBASE33","Suppression de l'élève dans la base.");
define("LANGBASE34","Suppression notes, abs, retards, disciplines, dispenses de l'élève.");
...
define("LANGAGENDA9","Afficher le d&eacute;tail");
define("LANGAGENDA10","Note personnelle");
define("LANGAGENDA11","Note affect&eacute;e");
define("LANGAGENDA12","Note Active");
define("LANGAGENDA13","Note Termin&eacute;e");
define("LANGAGENDA14","Jour courant");
define("LANGAGENDA15","Jour f&eacute;ri&eacute;");
define("LANGAGENDA16","Cr&eacute;er une note");
...
define("LANGAGENDA45","Votre session a expir&eacute; !");
define("LANGAGENDA46","Ce login est d&eacute;j&agrave; utilis&eacute;");
define("LANGAGENDA47","Ancien mot de passe erron&eacute;");
define("LANGAGENDA48","Veuillez vous identifier pour utiliser Phenix");
define("LANGAGENDA49","La connexion au serveur SQL a &eacute;chou&eacute;");
define("LANGAGENDA50","Profil modifi&eacute;");
define("LANGAGENDA51","Note enregistr&eacute;e");
define("LANGAGENDA52","Note mise &agrave; jour");
define("LANGAGENDA53","Note supprim&eacute;e");
define("LANGAGENDA54","Occurence de la note supprim&eacute;e");
define("LANGAGENDA55","Anniversaire enregistr&eacute;");
define("LANGAGENDA56","Anniversaire mis &agrave; jour");
define("LANGAGENDA57","Anniversaire supprim&eacute;");
define("LANGAGENDA58","Compte cr&eacute;&eacute;, vous pouvez vous connecter");
define("LANGAGENDA59","L'enregistrement a &eacute;chou&eacute;");
define("LANGAGENDA60","Tous les champs");
define("LANGAGENDA61","Soci&eacute;t&eacute;");
define("LANGAGENDA62","Nom + Pr&eacute;nom");
define("LANGAGENDA63","Adresse");
define("LANGAGENDA64","Num&eacute;ro de t&eacute;l&eacute;phone");
define("LANGAGENDA65","Adresse Email");
define("LANGAGENDA66","Commentaires");
define("LANGAGENDA67","Lancer la recherche");
define("LANGAGENDA68","Soci&eacute;t&eacute;");
define("LANGAGENDA69","Nom");
define("LANGAGENDA70","Pr&eacute;nom");
define("LANGAGENDA71","Adresse");
define("LANGAGENDA72","Ville");
define("LANGAGENDA73","Pays");
define("LANGAGENDA74","T&eacute;l. Domicile");
define("LANGAGENDA75","T&eacute;l. Travail");
...
define("LANGAGENDA87","Import termin&eacute;");
define("LANGAGENDA88","contact(s) ajout&eacute;(s)");
...
define("LANGAGENDA91","<LI>Choisir <I>Fichier texte (valeurs s&eacute;par&eacute;es par des virgules)</I> puis <I>Exporter</I></LI>");
define("LANGAGENDA92","<LI>Choisir l'endroit o&ugrave; le fichier sera sauvegard&eacute; puis <I>Suivant</I></LI>");
define("LANGAGENDA93","<LI>Dans la liste des champs &agrave; exporter, s&eacute;lectionner :<BR>");
define("LANGAGENDA94","<I>Pr&eacute;nom, Nom, Adresse de messagerie, Rue (domicile), Ville (domicile), Code Postal (domicile), Pays/r&eacute;gion (domicile), T&eacute;l&eacute;phone personnel, T&eacute;l&eacute;phone mobile, T&eacute;l&eacute;phone professionnel, T&eacute;l&eacute;copie professionnelle, Soci&eacute;t&eacute;</I> puis cliquer sur <I>Terminer</I></LI>");
define("LANGAGENDA95","<LI>R&eacute;cup&eacute;rer le fichier ainsi cr&eacute;&eacute; dans le formulaire ci-dessous et cliquer sur <I>Importer</I></LI>");
define("LANGAGENDA96","Veuillez entrer une soci&eacute;t&eacute; pour la recherche");
define("LANGAGENDA97","Veuillez entrer un nom ou un pr&eacute;nom pour la recherche");
define("LANGAGENDA98","Veuillez entrer une adresse pour la recherche");
define("LANGAGENDA99","Veuillez entrer un num&eacute;ro de t&eacute;l&eacute;phone pour la recherche");
...
define("LANGAGENDA102","Veuillez entrer au moins un crit&egrave;re pour la recherche");
define("LANGAGENDA103","Etes-vous sûr de vouloir effacer ce contact ?");
define("LANGAGENDA104","Ann&eacute;e");
define("LANGAGENDA105","Pas de p&egrave;re");
define("LANGAGENDA106","Liste des personnes<BR>&agrave; qui vous pouvez<BR>affecter une note");
define("LANGAGENDA107","Personne(s) possible(s)");
define("LANGAGENDA108","Personne(s) s&eacute;lectionn&eacute;e(s)");
define("LANGAGENDA109","Pr&eacute;cision d'affichage");
define("LANGAGENDA110","Tranche de 30mn");
define("LANGAGENDA111","Tranche de 15mn");
define("LANGAGENDA112","Heure de d&eacute;but");
define("LANGAGENDA113","Heure de fin");
define("LANGAGENDA114","Occup&eacute;");
define("LANGAGENDA115","Partiel");
define("LANGAGENDA116","Libre");
define("LANGAGENDA117","Cr&eacute;er une note entre ");
define("LANGAGENDA118","D&eacute;tail par utilisateur de cette journ&eacute;e");
...
define("LANGAGENDA126","Disponibilit&eacute;s de vos contacts pour le ");
...
define("LANGAGENDA130","Pr&eacute;cision d'affichage");
...
define("LANGAGENDA134","Impression en mode paysage conseill&eacute;e");
define("LANGAGENDA135","Semaine pr&eacute;c&eacute;dente ");
...
define("LANGAGENDA146","Journ&eacute;e type");
define("LANGAGENDA147","Termine &agrave;");
define("LANGAGENDA148","T&eacute;l&eacute;phone VF");
define("LANGAGENDA149","Interface");
define("LANGAGENDA150","Planning par d&eacute;faut");
...
define("LANGAGENDA158","S&eacute;lection automatique de l'heure de fin d'une note");
define("LANGAGENDA159","Partage du planning<BR>en consultation");
define("LANGAGENDA160","Personnes autoris&eacute;es à consulter mon planning");
define("LANGAGENDA161","Non partag&eacute;");
...
define("LANGAGENDA166","M'informer par mail lorsqu'une note m'est affect&eacute;e");
define("LANGAGENDA167","Supprimer cette note que j'ai cr&eacute;&eacute;e");
define("LANGAGENDA168","Supprimer cette note que l'on m'a affect&eacute;e");
define("LANGAGENDA169","M'approprier cette note qui m'a &eacute;t&eacute; affect&eacute;e");
define("LANGAGENDA170","Toute la journ&eacute;e");
define("LANGAGENDA171","Choix du libell&eacute;");
define("LANGAGENDA172","Nouveau libell&eacute;");
define("LANGAGENDA173","Intitul&eacute;");
define("LANGAGENDA174","Dur&eacute;e moyenne");
...
define("LANGAGENDA184","La note que vous souhaitez modifier appartient &agrave; une série r&eacute;currente");
define("LANGAGENDA185","Souhaitez-vous modifier toute la s&eacute;rie ou uniquement cette occurence ?");
define("LANGAGENDA186","Toute la s&eacute;rie");
define("LANGAGENDA187","Uniquement cette occurence");
define("LANGAGENDA188","Note couvrant toute la journ&eacute;e");
define("LANGAGENDA189","Afficher le calendrier");
define("LANGAGENDA190","Toute la journ&eacute;e");
define("LANGAGENDA191","D&eacute;bute &agrave;");  // Début à
define("LANGAGENDA192","Personne<BR>concern&eacute;e");
define("LANGAGENDA193","Apparence de la note");
define("LANGAGENDA194","Note publique");
define("LANGAGENDA195","note détaill&eacute;e dans le partage de planning");
define("LANGAGENDA196","mention \"Occup&eacute;\" dans le partage de planning");
define("LANGAGENDA197","Note priv&eacute;e");
define("LANGAGENDA198","Occup&eacute;(e)");
define("LANGAGENDA199","consid&eacute;rer comme <B>non disponible</B> dans le module des disponibilit&eacute;s");
define("LANGAGENDA200","Libre");
define("LANGAGENDA201","consid&eacute;rer comme <B>libre</B> dans le module des disponibilit&eacute;s");
...
define("LANGAGENDA208","&agrave; l'avance");  // à l'avance
define("LANGAGENDA209","P&eacute;riodicit&eacute;");
...
define("LANGAGENDA224","deuxi&egrave;me");
define("LANGAGENDA225","troisi&egrave;me");
define("LANGAGENDA226","quatri&egrave;me");
...
define("LANGAGENDA231","Fin apr&egrave;s"); // Fin après
...
define("LANGAGENDA240","R&eacute;p&eacute;tition"); // répétition
...
define("LANGAGENDA249","Note r&eacute;curente");
define("LANGAGENDA250","Supprimer cette note que j'ai cr&eacute;&eacute;e");
define("LANGAGENDA251","M'approprier cette note qui m'a &eacute;t&eacute; affect&eacute;e");
define("LANGAGENDA252","Filtrer");
define("LANGAGENDA253","Imprimer ce planning");
define("LANGAGENDA254","Impression en mode paysage conseill&eacute;e");
define("LANGAGENDA255","Note cr&eacute;&eacute;e par ");
define("LANGAGENDA256","Changer le statut");
define("LANGAGENDA257","Supprimer cette occurence");
define("LANGAGENDA258","Supprimer cette note que j'ai cr&eacute;&eacute;e");
define("LANGAGENDA259","Supprimer cette note que l'on m'a affect&eacute;e");
define("LANGAGENDA260","une note");
define("LANGAGENDA261","un anniversaire");
define("LANGAGENDA262","un contact");
define("LANGAGENDA263","A l'utilisateur sélectionn&eacute; ci-dessous");
define("LANGAGENDA264","Ajouter une note");
define("LANGAGENDA265","Recherche");
define("LANGAGENDA266","Disponibilit&eacute;s");
define("LANGAGENDA267","Contacts");
define("LANGAGENDA268","M&eacute;mo");
define("LANGAGENDA269","Libell&eacute;s");
...
define("LANGMOIS22","F&eacute;v"); 		// mois abregé
...
define("LANGMOIS212","D&eacute;c"); 	// mois abregé



define("LANGPROFP22","Cet enseignant est déjà assigné comme professeur principal. \\n\\n L'Equipe Triade");
...
define("LANGSTAGE44","Plannification des stages");
...
define("LANGSTAGE60","Consulter les entreprises par activité");
...
define("LANGSTAGE69","Visualisation d'un élève à un stage");
define("LANGSTAGE70","Imprimer le stage numéro");
define("LANGSTAGE71","Visualisation d'un élève aux stages");
define("LANGSTAGE72","&nbsp;Date&nbsp;du&nbsp;Stage&nbsp;"); // respecter les &nbsp;
define("LANGSTAGE73","Retour");
define("LANGSTAGE74","Entreprise");
define("LANGSTAGE75","Affectation d'un élève à un stage");
...
define("LANGSTAGE81","Passage dans plusieurs services");
define("LANGSTAGE82","Raison du changement de service");
define("LANGSTAGE83","Informations complémentaires");
define("LANGSTAGE84","Création enregistrée \\n \\n L'Equipe Triade");
define("LANGSTAGE85","Date de la visite");
define("LANGSTAGE86","Modification d'un élève à un stage");
define("LANGSTAGE87","Informations enregistrées");
define("LANGSTAGE88","Suppression d'un élève à un stage");
...
define("LANGABS57","Mise à jour réalisée pour cette liste d'élèves");




define("LANGSANC1","Sanction créée -- L'Equipe Triade");
define("LANGSANC2","Catégorie non supprimée. Cette catégorie est déjà affectée à une sanction ou un élève -- Equipe Triade");
...
define("LANGSANC9","Avertissement d'un message  lorsque l'élève  a atteint la limite autorisée.");
...
// define("LANGPARAM1","<font class=T1>Composez votre texte pour le contenu du message de l'absence pour l'envoi du courrier aux parents d'élève. Pour une prise en compte du nom et du prénom de l'élève automatiquement dans chaque document, veuillez présiser la chaîne <b>NomEleve</b> et <b>PrenomEleve</b> à l'emplacement désiré. De même possibilité d'indiquer la classe avec le mot clef <b>ClasseEleve</b>, ou la date de l'absence ABSDEBUT ou ABSFIN ainsi que la durée ABSDUREE </font><br><br>");
// define("LANGPARAM2","<font class=T1>Composez votre texte pour le contenu du message de retard pour l'envoi du courrier aux parents. Pour une prise en compte du nom et du prénom de l'élève automatiquement dans chaque document, veuillez présiser la chaîne <b>NomEleve</b> et <b>PrenomEleve</b> à l'emplacement désiré. De même possibilité d'indiquer la classe avec le mot clef <b>ClasseEleve</b>, ou la date du retard RTDDATE , l'heure RTDHEURE ainsi que le durée RTDDUREE </font><br><br>");


define("LANGMODIF4","Modification d'un compte");
define("LANGMODIF5","Information de connexion");
define("LANGMODIF6","Photo d'identité");
define("LANGMODIF7","Cordonnées du compte");
define("LANGMODIF8","Adresse");
define("LANGMODIF9","Code Postal");
define("LANGMODIF10","Commune");
define("LANGMODIF11","Tél.");
...
define("LANGGRP25","Gestion des groupes");
define("LANGGRP26","Liste des groupes");
define("LANGGRP27","Ajouter un élève dans un groupe");
define("LANGGRP28","Supprimer un élève d'un groupe");
define("LANGGRP29","Nom du Groupe");
define("LANGGRP30","Classe(s) concernée(s)");
define("LANGGRP31","Modifier liste");
define("LANGGRP32","Ajouter des élèves dans le groupe");
define("LANGGRP33","Ajouter un élève dans ce groupe");
define("LANGGRP34","Elève en classe de ");
define("LANGGRP35","Elève dans le groupe");
define("LANGGRP36","Valider le groupe");
define("LANGGRP37","Groupe modifié -- Equipe Triade ");
define("LANGGRP38","Liste des élèves du groupe ");
define("LANGGRP39","Aucun élève dans ce groupe");

define("LANGCARNET1","Carnet de notes");
define("LANGCARNET2","Indiquer la classe de l'élève");
define("LANGCARNET3","Cliquez sur le <b>nom</b> de l'élève");
...
define("LANGMEDIC1","Dossier médical d'un élève");
...
define("LANGBASE6bis","Total d'élèves dans le fichier ");
...
define("LANGABS66","Mise à jour effectuée pour cette liste d'élèves");
define("LANGABS6bis","Liste des retards non justifiés");
define("LANGABS4bis","Lister les absences ou retards");
define("LANGABS67","<font class=T2>Aucun éléve dans cette classe</font>");
define("LANGABS68","Liste des abs/rtds d'une classe");
define("LANGABS69","Cumul des abs/rtds des élèves");
...
define("LANGBASE10_2","Indiquez les enseignants à ajouter.");
...
define("LANGSTAFE91","Liste des élèves en entreprise");
define("LANGSTAGE92","Liste des élèves en entreprise");
define("LANGPASSG4","Le mot de passe doit être de <b>8 caractères</b> minimum <br /><b>alphanumérique</b>.");
define("LANGPASSG5","Le mot de passe doit être de <b>8 caractères</b> minimum.");
define("LANGPASSG6","Le mot de passe n'est pas correct. \\n Le mot de passe doit comporter : \\n\\n -> 8 caractères minimum, \\n -> alphanumérique \\n\\n L\\'Equipe Triade");
define("LANGPASSG7","Le mot de passe n'est pas correct. \\n Le mot de passe doit comporter : \\n\\n -> 8 caractères minimum. \\n\\n L\\'Equipe Triade");

define("LANGMODIF22_1","Mot de passe : 8 caractères");
...
define("LANGBASE41","Supprimer tous les élèves avant l'import");
define("LANGBASE7bis","Elève déjà affecté");
define("LANGBASE8bis","pour les élèves <u>affectés</u> et <u>sans classe</u>");

define("LANGPER21bis","Langue&nbsp;/&nbsp;option");

define("LANGASS6ter","Elève");
...
define("LANGBULL1pp","Imression bulletin trimestriel ou semestriel");
...
define("CUMUL01","Cumul des absences et retards d'une classe par élève");
define("CUMUL02","Cumul des sanctions d'une classe par élève");
define("CUMUL03","Cumul des sanctions d'un élève");
...
define("PASSG9","Le mot de passe de l'élève ");
...
define("LANGAFF8","ATTENTION ce module est à utiliser lors de la suppression d'affectation,<br> il détruit toutes les notes des élèves  des classes supprimées.");
define("LANGAFF9","ATTENTION, les notes des classes sélectionnées  seront supprimées. \\n Souhaitez vous continuer ? \\n\\n Equipe Triade");
define("LANGCREAT2","Supprimer un compte");


define("LANGPROF37","Cahier de texte.");
...
define("LANGPROFP26","Suivi d'un élève");
...
define("LANGPROFP31","Tableau des moyennes des élèves");
define("LANGPROFP32","Bulletin graphique des élèves");
...
define("LANGRESA73","à");
define("LANGRESA74","Information complémentaire");
...
define("LANGNA3ter","Mot de passe élève "); //
...
define("LANGGRP41","Voici la liste des élèves non enregistrés");
...
// FAUTES CORRIGEES ---> 01/07/2007


define("LANGPARAM37","Accadémie");
...
define("LANGEDT1bis","ichier au format <b>xml</b><br>Taille maximum du fichier : ");
...
define("LANGGRP58","Attention, les notes des ".INTITULEELEVE."s sélectionnés à la suppression <br /> seront supprimées dans toutes les classes utilisant ce groupe !!!");
...
define("LANGBULL45","Envoyer un message à tous les enseignants cochés pour les prévenir de remplir leurs bulletins.");
