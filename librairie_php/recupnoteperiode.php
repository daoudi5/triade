...
function ordre_matiere($idClasse,$anneeScolaire='') {
	global $cnx;
	global $prefixe;
...
function ordre_matiere_visubull($idClasse,$anneeScolaire='') {
	global $cnx;
	global $prefixe;
	if ($anneeScolaire == "") $anneeScolaire=$_COOKIE["anneeScolaire"];
$sql=<<<SQL
...
function ordre_matiere_visubull_btsblanc($idClasse,$anneeScolaire='') {
	global $cnx;
	global $prefixe;
	if ($anneeScolaire == "") $anneeScolaire=$_COOKIE["anneeScolaire"];
$sql=<<<SQL
...
function ordre_matiere_visubull_trim($idClasse,$trim,$anneeScolaire='') {
        global $cnx;
        global $prefixe;
	if ($anneeScolaire == "") $anneeScolaire=$_COOKIE["anneeScolaire"];
$sql=<<<SQL
...
function verifMatierAvecGroupeRecupId($idMatiere,$idEleve,$idClasse,$ordreaffich,$anneeScolaire='') {
	global $cnx;
	global $prefixe;
	if ($anneeScolaire == "") $anneeScolaire=$_COOKIE["anneeScolaire"];
...
function verifMatiereGroupe($idMatiere,$idEleve,$idClasse,$ordreaffich,$anneeScolaire='') {
        global $cnx;
        global $prefixe;
	if ($anneeScolaire == "") $anneeScolaire=$_COOKIE["anneeScolaire"];
...
function verifMatierAvecGroupeRecupId2($idMatiere,$idClasse,$ordreaffich,$anneeScolaire='') {
	global $cnx;
	global $prefixe;
	if ($anneeScolaire == "") $anneeScolaire=$_COOKIE["anneeScolaire"];
	$sql="SELECT code_matiere,code_groupe FROM ${prefixe}affectations WHERE code_matiere='$idMatiere' AND code_classe='$idClasse' AND ordre_affichage='$ordreaffich' AND annee_scolaire='$anneeScolaire' ";
...
function recherche_prof($idMatiere,$idClasse,$ordre,$anneeScolaire='',$trimestre=''){
	global $cnx;
	global $prefixe;
	if ($anneeScolaire == "") $anneeScolaire=$_COOKIE["anneeScolaire"];
...
function verifMatiereAvecGroupe3($idMatiere,$idEleve,$idClasse,$ordreaffich,$anneeScolaire='') {
	global $cnx;
	global $prefixe;
	if ($anneeScolaire == "") $anneeScolaire=$_COOKIE["anneeScolaire"];
	$sql="SELECT code_matiere,code_groupe,code_classe,ordre_affichage FROM ${prefixe}affectations WHERE code_matiere='$idMatiere' AND code_classe='$idClasse' AND ordre_affichage='$ordreaffich' AND annee_scolaire='$anneeScolaire' ";
	...
	$liste_eleves=ereg_replace("\}","",$liste_eleves); $liste[$cc][1] /= 4; 
...
function verifMatiereAvecGroupe2($idMatiere,$idEleve,$idClasse,$ordreaffich,$anneeScolaire='') {
	global $cnx;
	global $prefixe;
	if ($anneeScolaire == "") $anneeScolaire=$_COOKIE["anneeScolaire"];
	$sql="SELECT code_matiere,code_groupe,code_classe,ordre_affichage FROM ${prefixe}affectations WHERE code_matiere='$idMatiere' AND code_classe='$idClasse' AND ordre_affichage='$ordreaffich' AND annee_scolaire='$anneeScolaire'  ";
...
function verifMatiereAvecGroupe($idMatiere,$idEleve,$idClasse,$ordreaffich,$anneeScolaire='') {
	global $cnx;
	global $prefixe;
	if ($anneeScolaire == "") $anneeScolaire=$_COOKIE["anneeScolaire"];
	$sql="SELECT code_matiere,code_groupe,code_classe,ordre_affichage FROM ${prefixe}affectations WHERE code_matiere='$idMatiere' AND code_classe='$idClasse' AND ordre_affichage='$ordreaffich' AND annee_scolaire='$anneeScolaire'  ";
...
function verifMatiereOPT4($idmatiere,$idClasse,$ordre,$anneeScolaire='') {
	global $cnx;
        global $prefixe;
	if ($anneeScolaire == "") $anneeScolaire=$_COOKIE["anneeScolaire"];
...
function verifMatiereAvecGroupeUE($idMatiere,$idEleve,$idClasse,$ordre,$anneeScolaire='') {
         global $cnx;
         global $prefixe;
	 if ($anneeScolaire == "") $anneeScolaire=$_COOKIE["anneeScolaire"];
...
function recupECTS($idmatiere,$idClasse,$trim,$anneeScolaire='') {
	global $cnx;
	global $prefixe;
	if ($anneeScolaire == "") $anneeScolaire=$_COOKIE["anneeScolaire"];
	if ($trim == "T4") {
...
function recupCoefUE($idmatiere,$idClasse,$trim,$anneeScolaire='') {
	global $cnx;
	global $prefixe;
	if ($anneeScolaire == "") $anneeScolaire=$_COOKIE["anneeScolaire"];
...
function recupCoefUEviaGrp($idmatiere,$idClasse,$trim,$idgroupe,$anneeScolaire='') {
        global $cnx;
        global $prefixe;
	if ($anneeScolaire == "") $anneeScolaire=$_COOKIE["anneeScolaire"];
...
function recupNoteBull($nbNote,$idEleve,$idMatiere,$dateDebut,$dateFin,$idprof,$idgroupe)  {
	...
	for($i=0;$i<count($liste);$i++) {
		if ($liste[$i][0] < 0) {
			$liste[$i][0]=ereg_replace('.00','',$liste[$i][0]);
			$liste[$i][0]=ereg_replace('-1','abs',$liste[$i][0]);
			$liste[$i][0]=ereg_replace('-2','disp',$liste[$i][0]);
			$liste[$i][0]=ereg_replace('-3',' ',$liste[$i][0]);
			$liste[$i][0]=ereg_replace('-4','DNN',$liste[$i][0]);
			$liste[$i][0]=ereg_replace('-5','DNR',$liste[$i][0]);
			$liste[$i][0]=ereg_replace('-6','VAL',$liste[$i][0]);
		}
		$l.=$liste[$i][0]." ";
	}
	return $l;
...
function coeffMatiere($idMatiere,$idClasse,$anneeScolaire=''){
	global $cnx;
	global $prefixe;
	if ($anneeScolaire == "") $anneeScolaire=$_COOKIE["anneeScolaire"];
...
function recupCoeff($idMatiere,$idClasse,$ordre,$anneeScolaire='') {
	global $cnx;
	global $prefixe;
	if ($anneeScolaire == "") $anneeScolaire=$_COOKIE["anneeScolaire"];
...
function profAff($idMatiere,$idClasse,$ordre,$anneeScolaire='',$trim='') {
	global $cnx;
	global $prefixe;
	if ($anneeScolaire == "") $anneeScolaire=$_COOKIE["anneeScolaire"];
...
function calculMoyenClasseBlancAFTEC($idClasse,$eleveT,$dateDebut,$dateFin,$ordre,$examen){
        global $cnx;
        global $prefixe;
        ...
        for($j=0;$j<count($eleveT);$j++) {  // premiere ligne de la creation PDF
                ...
                foreach ($tabmatiere as $key => $value)  {
                        list($num_ordre,$idMatiere)=split("##",$value);
			...
			// mise en place des coeff
                        if ($examen == "BTS Blanc") { $typeexamen="bull0101b"; }  // BTS Blanc
                ...
                if (trim($moyenEleve) != "") {
                        $moyenEleve=ereg_replace(',','.',$moyenEleve);
...
function calculNoteVieScolaireEns($idEleve,$trimestre) {
	...
	$moyenEleve=moyGenEleve($noteMoyEleG,$coefEleG);
	if (trim($moyenEleve) != "") {
		$moyenClasseGen=ereg_replace(',','.',$moyenEleve);
...
function moyenEleveMat2($idEleve,$idMatiere,$dateDebut,$dateFin,$idclasse,$ordre) {
	...
	$noteaff=ereg_replace (",",".",$noteaff);
	return $noteaff;
}


function verifMatiereAvecGroupeSansEleve($idMatiere,$idClasse,$ordreaffich,$anneeScolaire='') {
        global $cnx;
        global $prefixe;
	if ($anneeScolaire == "") $anneeScolaire=$_COOKIE["anneeScolaire"];
...
function recupCoeffViaTrim($idMatiere,$idClasse,$ordre,$tri,$anneeScolaire='') {
	global $cnx;
	global $prefixe;
	if ($anneeScolaire == "") $anneeScolaire=$_COOKIE["anneeScolaire"];
...
function nombreDeNote($idEleve,$idMatiere,$dateDebut,$dateFin,$idprof) {
        global $cnx;
        global $prefixe;
        $dateDebut=dateFormBase($dateDebut);
        $dateFin=dateFormBase($dateFin);
