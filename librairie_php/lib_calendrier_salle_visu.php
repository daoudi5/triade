        ...
        for(var i=0;i<6;i++) {
                ...
                for (j=0;j<7;j++) {
					...
					if (estConseil(jour,m)) {
                                     ...
                                     disp("<TD width='10' bgcolor='pink'  align='center'><FONT face='Arial' size='-1' color='#0000CC'><A href='#' onMouseOver=\"AffBulle('<font face=Georgia, Times New Roman, Times, serif>"+dstT[ii]+" </FONT>');\"  onMouseOut='HideBulle()' onclick=\"PopupCentrer('resr_salle2.php?saisiejour="+aff_j+"&saisiemois="+mois[d.getMonth()]+"&saisieannee="+a+"','600','400','scrollbars=yes','calendrier');\">"+aff_j+"</A></FONT></TD>");
					ii++;
                                        }else {
                                    ...
                                    disp("<TD width='10' bgcolor='#FFFFFF' align='center'><FONT face='Arial' size='-1' color='#0000CC'><A href='#' onclick=\"PopupCentrer('resr_salle2.php?saisiejour="+aff_j+"&saisiemois="+mois[d.getMonth()]+"&saisieannee="+a+"','600','400','','calendrier')\";>"+aff_j+"</A></FONT></TD>");
				}
                        }
                        else
