...
if(autorisation_module()) {
	...
	if($operation == "enregistrer") {
		...
		$sql= "INSERT INTO ".CHA_TAB_CHAMBRE." (batiment_id, numero, libelle, type_chambre_id, etage_id) ";
		$sql.="VALUES(" . $batiment_id . ", '".esc($numero)."', '".esc($libelle)."', ".$type_chambre_id.", ".$etage_id."); ";
	...
	$disabled = '';
	if($res_batiments->numRows() == 0) {
		$disabled = 'disabled="disabled"';
		msg_util_ajout(LANG_CHA_CHAM_102, 'avertissement');
	}
	...
	<body id='bodyfond' marginheight="0" marginwidth="0" leftmargin="0" topmargin="0">
		...
		<table border="0" cellpadding="3" cellspacing="1" width="100%" bgcolor="#0B3A0C" height="85">
			<tr id="coulBar0">
				<td height="2" align="left">
					<b><font id="menumodule1" ><?php echo LANG_CHA_CHAM_003; ?></font></b>
				</td>
			</tr>
			<tr id="cadreCentral0">
				<td valign="top" align="center">
								...
								<td valign=top align="center">
									...
									<table width="100%" border="0" cellpadding="0" cellspacing="0" align="center">
										...
										<tr>
											...
											<td valign="top">&nbsp;</td>
											<td valign="top" align="left">
												<input type="text" name="numero" id="numero" size="5" maxlength="5" <?php echo $disabled; ?>>
											</td>
										</tr>
										<tr>
											...
											<td valign="top" align="left">
												...
												<?php
													for($i=0; $i<$res_types_chambre->numRows(); $i++) {
														...
														$selected = '';
														if($une_option[0] == $type_chambre_id) {
															$selected = 'selected';
														}
										...
										<tr>
											...
											<td valign="top">&nbsp;</td>
											<td valign="top" align="left">
												<input type="text" name="libelle" id="libelle" size="30" maxlength="64" <?php echo $disabled; ?>>
											</td>
										</tr>
									</table>
								</td>
							...
							<tr>
								<td align="center" colspan="3">
									<table border="0" align="center" cellpadding="4" cellspacing="0">
												...
												<table border="0" align="center" cellpadding="0" cellspacing="0">
													<tr>
														<td align="center">
															...
															if($res_batiments->numRows() > 0) {
															?>
															<script language="javascript">buttonMagic3("<?php print LANG_CHA_CHAM_008?>","valider_le_formulaire()");</script>
																
															<?php
															} else {
															?>
															<script language="javascript">buttonMagic3("<?php print LANG_CHA_CHAM_008?>","onclick_pas_de_batiments()");</script>
															<?php
															}
															?>
										...
										<tr>
											<td align="center">
												<script language="javascript">buttonMagic3("<?php print LANG_CHA_CHAM_004?>","onclick_liste()");</script>
											</td>
											<td align="center">
												<script language="javascript">buttonMagic3("<?php print LANG_CHA_CHAM_005?>","onclick_supp()");</script>
											</td>
										</tr>
										<tr>
											<td align="center" colspan="2">
					...
					<script language="javascript">
						...
						function onclick_pas_de_batiments() {
							alert("<?php echo LANG_CHA_CHAM_102; ?>");
						}	
						
						function valider_le_formulaire_v0() {
							var valide = true;
							var obj;
							var message_erreur = '';
							var separateur = '';
					...
					<form name="formulaire_liste" id="formulaire_liste" action="<?php echo $g_chemin_relatif_module; ?>chambre_liste.php" method="post">
					</form>
					<form name="formulaire_supp" id="formulaire_supp" action="<?php echo $g_chemin_relatif_module; ?>chambre_supp.php" method="post">
					</form>
		...
		<script language="javascript" type="text/javascript">
			...
			function initialisation_page() {
				...
				// On met le focus sur le libelle par defaut
