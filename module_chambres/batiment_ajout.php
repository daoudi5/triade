...
if(autorisation_module()) {
	...
	if($operation == "enregistrer") {
		...
		$sql= "INSERT INTO ".CHA_TAB_BATIMENT." (libelle, adresse_1, adresse_2, adresse_3, code_postal, ville) ";
		$sql.="VALUES('".esc($libelle)."', '".esc($adresse_1)."', '".esc($adresse_2)."', '".esc($adresse_3)."', '".esc($code_postal)."', '".esc($ville)."'); ";
		...
		<table border="0" cellpadding="3" cellspacing="1" width="100%" bgcolor="#0B3A0C" height="85">
			<tr id="coulBar0">
				<td height="2" align="left">
					<b><font id="menumodule1" ><?php echo LANG_CHA_BATI_003; ?></font></b>
				</td>
			</tr>
			<tr id="cadreCentral0">
				<td valign="top" align="center">
								...
								<td valign=top align="center">
									...
									<table width="100%" border="0" cellpadding="0" cellspacing="0" align="center">
										...
										<tr>
											...
											<td valign="top" align="left">
												<table border="0" cellspacing="0" cellpadding="0" align="left">
													<tr>
														<td valign="middle">
															<input type="text" name="adresse_1" id="adresse_1" size="30" maxlength="64">
														</td>
													</tr>
													<tr>
														<td valign="middle">
															<input type="text" name="adresse_2" id="adresse_2" size="30" maxlength="64">
														</td>
													</tr>
													<tr>
														<td valign="middle">
															<input type="text" name="adresse_3" id="adresse_3" size="30" maxlength="64">
														</td>
													</tr>
												</table>											
											</td>
										...
										<tr>
											...
											<td valign="top">&nbsp;</td>
											<td valign="top" align="left">
												<input type="text" name="code_postal" id="code_postal" size="5" maxlength="5">
											</td>
										</tr>
										<tr>
											...
											<td valign="top">&nbsp;</td>
											<td valign="top" align="left">
												<input type="text" name="ville" id="ville" size="30" maxlength="64">
											</td>
										</tr>
									</table>
								</td>
							...
							<tr>
								<td align="center" colspan="3">
									<table border="0" align="center" cellpadding="4" cellspacing="0">
										<tr>
											<td align="center" colspan="2">
												<table border="0" align="center" cellpadding="0" cellspacing="0">
													<tr>
														<td align="center">
															<script language="javascript">buttonMagicSubmit("<?php print LANG_CHA_BATI_008?>","create"); //text,nomInput</script>
														</td>
													</tr>
												</table>
											</td>
										...
										<tr>
											<td align="center">
												<script language="javascript">buttonMagic3("<?php print LANG_CHA_BATI_004?>","onclick_liste()");</script>
											</td>
											<td align="center">
												<script language="javascript">buttonMagic3("<?php print LANG_CHA_BATI_005?>","onclick_supp()");</script>
											</td>
										</tr>
										<tr>
											<td align="center" colspan="2">
					...
					<form name="formulaire_liste" id="formulaire_liste" action="<?php echo $g_chemin_relatif_module; ?>batiment_liste.php" method="post">
					</form>
					<form name="formulaire_supp" id="formulaire_supp" action="<?php echo $g_chemin_relatif_module; ?>batiment_supp.php" method="post">
					</form>
