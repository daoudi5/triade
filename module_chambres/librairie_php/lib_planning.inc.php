		...
		<table border="0" cellpadding="0" cellspacing="0" align="center" class="planning">
			...
			print "
				<td align='center' class='ajout' nowrap='nowrap'>
					...
					onclick=\"window.open('planning_calendrier.php?operation=$operation&chambre=$chambre_id&annee=$annee','','toolbar=0,menubar=0,location=0,scrollbars=1,width=840,height=800')\">
