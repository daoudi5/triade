...
if(autorisation_module()) {
	...
	$prenom_defaut = $_SESSION[CHA_REP_MODULE]['reservation_liste']['prenom'];
	$nom_defaut = $_SESSION[CHA_REP_MODULE]['reservation_liste']['nom'];
	...
	if($operation == "enregistrer") {
        ...
        {
			header('Location: reservation_liste_suite.php');
										...
										<table border="0" cellpadding="0" cellspacing="0" align="center">
											...
											<tr>
												...
												<td align="left">
													<table border="0" cellpadding="0" cellspacing="0" align="left">
														...
														<tr>
															<td align="left" id=""><img src="<?php echo "./" . $g_chemin_relatif_module . "images/espaceur.gif"; ?>" border="0" width="130" height="1"></td>
															<td align="left">
											...
											<tr>
												...
												<td align="left" id="conteneur_chambre_id">
													<select name="chambre_id" id="chambre_id" onChange="recuperer_calendrier()">
														<?php
															$selected = '';
												...
												<td align="left" id="conteneur_calendrier">
						...
						<tr>
							<td align="center" valign="top">
								...
								<script language="javascript">
									...
									function init_conteneur_calendrier_id(mode, donnees) {
										switch(mode) {
											case 'attente_ajax':
												document.getElementById("conteneur_calendrier").innerHTML = '<img src="image/temps1.gif" border=0>';
												break;
											case 'donnees':
												document.getElementById("conteneur_calendrier").innerHTML = donnees;
												break
											default:;
												document.getElementById("conteneur_calendrier").innerHTML = '&nbsp;';
												break;
										}
									}
									...
									var ajax_recuperer_calendrier;
			
									function recuperer_calendrier() {
										var ajax_recuperer_calendrier = new Ajax();
										
										init_conteneur_calendrier_id('attente_ajax', '');
									
										var form = document.getElementById("formulaire");
										var chambre_id = form.chambre_id.options[form.chambre_id.selectedIndex].value;
								
										// Parametres de l'Ajax
										ajax_recuperer_calendrier.setParam ({
											url : "<?php echo url_module(); ?>ajax_calendrier_recherche.php",
											returnFormat : "txt",
											method : "POST",
											data : {
												mode_page : mode_page,
											...
											asynchronus : true,
											onComplete : "recuperer_calendrier_reussite(response)",
											onFailure : "recuperer_calendrier_echec(errorCode)"
										});
															
										// Appeler l'Ajax
										ajax_recuperer_calendrier.execute();
			
									}

									function recuperer_calendrier_reussite(response) {
										var donnees = new String(response);
										...
										switch(donnees_decoupees[0]) {
											case '0': // Pas d'erreur
												init_conteneur_calendrier_id('donnees', donnees_decoupees[2]);
												mode_page = 'normal';
												break;
									...
									function recuperer_calendrier_echec(errorCode) {
										msg_util_attente_cacher();
										alert("<?php echo LANG_CHA_AJAX_003; ?>");
									}
								...
								<form name="formulaire_annuler" id="formulaire_annuler" action="<?php echo $g_chemin_relatif_module; ?>reservation_liste_suite.php" method="post">
								</form>
