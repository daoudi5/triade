...
<html>
	...
	<script language="javascript">
		...
		<form name="formulaire_inscrire" id="formulaire_inscrire" action="<?php echo $g_chemin_relatif_module; ?>reservation_liste_suite.php" method="post">
			...
			<input type="hidden" name="nom_eleve" id="nom_eleve" value="<?php echo $nom_eleve; ?>">
			<input type="hidden" name="prenom_eleve" id="prenom_eleve" value="<?php echo $prenom_eleve; ?>">
		</form>
