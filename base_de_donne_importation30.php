...
<tr id='coulBar0' ><td height="2"><b><font id='menumodule1'><?php print "Importation de fichier "?></font></b></td></tr>
<tr id='cadreCentral0'>
<td>
<!-- // fin  -->
<ul>
...
<font class="T2"><?php print LANGBULL3?> : </font><select name="annee_scolaire" size="1" onChange="document.getElementById('file').disabled=false;" >
<?php
...
<br />
<img src='image/on1.gif' height=8 width=8 > <?php print LANGBASE41 ?> : <input type=checkbox name="vide_eleve" value="oui"  > (<?php print LANGOUI ?>) ( <i>Pas d'archivage possible</i> )
<br />
<!-- <img src='image/on1.gif' height=8 width=8 > <?php print "Pas de contrôle sur date de naissance lors de la mise à jour" ?> : <input type=checkbox name="noncontroledatenaissance" value="oui"  > (<?php print LANGOUI ?>) -->
<br />
<?php
$annee=date("Y")-1;
$annee=$annee."-".date("Y");
