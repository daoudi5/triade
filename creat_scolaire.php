...
<tr id='coulBar0' ><td height="2"><b><font   id='menumodule1' ><?php print LANGTITRE37?></font></b></td></tr><tr id='cadreCentral0'><td >
...
<script language=JavaScript>buttonMagic("<?php print LANGCREAT2 ?>","suppression_compte_scolaire.php","_parent","","");</script>&nbsp;&nbsp;</td></tr></table>
</td></tr></table>
<br />
<?php
...
<form method=post action="creat_scolaire.php" onsubmit="return verifcommun('<?php print $txt2?>')" name="formulaire">
<table border="0" cellpadding="3" cellspacing="1" width="100%" bgcolor="#0B3A0C" height="85">
<tr id='coulBar0' ><td height="2"><b><font   id='menumodule1' >
<?php print LANGTITRE7?></font></b></td>
</tr>
<tr id='cadreCentral0'>
<td >
<!-- // fin  -->
...
<table width=83% border=0 cellpadding="2" cellspacing="2" >
...
<tr><td align=right><font class="T2"><?php print "Indice&nbsp;salaire" ?> : </font></td><td><input type=text name="saisie_indice_salaire" size=33 maxlength=150></td></tr>
</TABLE>
</fieldset>
<br><br>
<center>
...
if(isset($_POST["create"])):
	...
	validerequete("menuadmin");
    	$cnx=cnx();
    	error($cnx);
    	$cr=create_personnel($_POST["saisie_creat_nom"],$_POST["saisie_creat_prenom"],$_POST["saisie_creat_password"],'MVS',$_POST["saisie_intitule"],'',$_POST["saisie_creat_adr"],$_POST["saisie_creat_code"],$_POST["saisie_creat_tel"],$_POST["saisie_creat_mail"],$_POST["saisie_creat_commune"],$_POST["saisie_creat_tel_port"],'','',$_POST["saisie_indice_salaire"],'');
   	if($cr == 1) {
            alertJs(LANGNA4);
    	}else if ($cr == -3) {
