...
<tr id='coulBar0' ><td height="2"><b><font id='menumodule1' ><?php print LANGMESS185  ?></font></b></td></tr><tr id='cadreCentral0'><td >
<table align=center border=0 width='100%' ><tr><td>
<img src="image/commun/personne.png" align='center' />
</td><td>
<script language=JavaScript>buttonMagic("<?php print LANGTMESS439 ?>","list_personnel.php","_parent","","");</script>
<script language=JavaScript>buttonMagic("<?php print LANGAGENDA86 ?>","base_de_donne_importation.php","_parent","","");</script>
<script language=JavaScript>buttonMagic("<?php print LANGCREAT2 ?>","suppression_compte_personnel.php","_parent","","");</script>&nbsp;&nbsp;</td></tr></table>
</td></tr></table>
<br />
<?php
...
<form method=post action="creat_personnel.php" onsubmit="return verifcommun('<?php print $txt2?>')" name="formulaire">
<table border="0" cellpadding="3" cellspacing="1" width="100%" bgcolor="#0B3A0C" height="85">
<tr id='coulBar0' ><td height="2"><b><font   id='menumodule1' >
<?php print LANGMESS185 ?></font></b></td>
</tr>
<tr id='cadreCentral0'>
<td >
<!-- // fin  -->
