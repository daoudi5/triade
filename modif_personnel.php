...
<tr id='coulBar0' ><td height="2"><b><font   id='menumodule1' ><?php print LANGMODIF13 ?> <?php print "Personnel" ?></font></b></td></tr>
<tr id='cadreCentral0'>
<td >
<?php
...
if(isset($_POST["create"])){
	...
	$saisie_id=$_GET["saisie_id"];
	  ...
	  $passage_argument="oui"; // pour le JavaScript
          ...
          // pers_id,nom,prenom,mdp,civ,email,adr,code_post,commune,tel,tel_port,identifiant,offline,id_societe_tuteur,pays,indice_salaire
...
<tr><td align=right width=40%><font class="T2"><?php print LANGNA3?> : </font></td><td><input type=button onclick="open('modif_pers_pass.php?id=<?php print $saisie_id;?>&type=PER','pass','width=400,height=300')" value='<?php print LANGPER30 ?>'  class="bouton2" > </td></tr>
</table>
</fieldset>
<br><br><br>
...
<center>
	...
	<script language=JavaScript>buttonMagic("<?php print LANGTMESS476 ?>","list_personnel.php","_parent","","");</script>
<BR><br>
</center>
     </blockquote>
     <!-- // fin  -->
