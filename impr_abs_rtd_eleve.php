...
<tr id='coulBar0' ><td height="2"><b><font   id='menumodule1' ><?php print "Impression des absences et retards des élèves" ?></font></b></td></tr>
<tr id='cadreCentral0' >
<td ><br><br>
<!-- // fin  -->
...
<script language=JavaScript>buttonMagicSubmit3("<?php print LANGPER27 ?>","rien",""); //text,nomInput</script></td><td><script>buttonMagicRetour2('gestion_abs_retard.php','_self','Retour')</script></td></tr></table>
</form>
<br>
     <!-- // fin  -->
     </td></tr></table>
