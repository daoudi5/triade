...
<?php print LANGPARENT23 ?></font></b></td>
</tr>
<tr id='cadreCentral0' >
<td >
<?php
...
<br>
<table><tr><td>
<script language=JavaScript>buttonMagic('<?php print LANGPARENT24?>','demdst.php','fenDST','height=230,width=400,scrollbars=no,status=no','');</script>
...
?>
     ...
     <center> <A href="./calendrier_dst_visu11_readonly.php?saisie_annee_choix=<?php print $saisie_annee_moin?>" ><?php print LANCALED1?></A> <------> <A href="./calendrier_dst_visu11_readonly.php?saisie_annee_choix=<?php print $saisie_annee_plus?>" ><?php print LANCALED2?></A></center>
