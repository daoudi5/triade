...
if (isset($_POST["rien"])) {
	...
	print "<script language='JavaScript' src='http://support.triade-educ.com/centralestage/demandeaffiliation.php?productidclient=$productidclient&productidcentral=".PRODUCTID."'></script>";
