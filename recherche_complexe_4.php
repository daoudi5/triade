...
$listeaffiche=ereg_replace(",",", ",$listeaffiche);
$listeaffiche=ereg_replace(" nomT1",LANGEDIT8,$listeaffiche);
$listeaffiche=ereg_replace(" prenomT1",LANGEDIT5bis,$listeaffiche);
$listeaffiche=ereg_replace(" nomT2",LANGEDIT4,$listeaffiche);
$listeaffiche=ereg_replace(" prenomT2",LANGEDIT5,$listeaffiche);
$listeaffiche=ereg_replace(" telephone",LANGIMP20,$listeaffiche);
$listeaffiche=ereg_replace(" profpere",LANGIMP21,$listeaffiche);
$listeaffiche=ereg_replace(" telprofpere",LANGIMP22,$listeaffiche);
$listeaffiche=ereg_replace(" profmere",LANGIMP23,$listeaffiche);
$listeaffiche=ereg_replace(" telprofmere",LANGIMP24,$listeaffiche);
$listeaffiche=ereg_replace(" telport1",LANGEDIT2,$listeaffiche);
$listeaffiche=ereg_replace(" lieudenaissance",LANGEDIT6,$listeaffiche);
$listeaffiche=ereg_replace(" telport2",LANGEDIT9,$listeaffiche);
$listeaffiche=ereg_replace(",",", ",$listeaffiche);
?>
...
if (ereg (",$", $table22)) {
        $pattern = ',$';
        $replacement = '';
        $table22 = eregi_replace($pattern, $replacement, $table22);
}
