...
<tr>
<td align="right"><font class="T2"><?php print "Indiquez la semaine à consulter " ?> :</font></td>
<td colspan="2"   align="left"><input type="text" value="" name="saisie_date_debut" TYPE="text" size=13  class=bouton2 readonly>
<?php
 include_once("librairie_php/calendar.php");
 calendarSemaine("id1","document.formulaire.saisie_date_debut",$_SESSION["langue"],"0");
?>
</td>
</tr>
<tr>
