...
<?php print LANGRESA35?></font></b></td>
</tr>
<tr id='cadreCentral0'>
<td >
<!-- // fin  -->
...
<td bgcolor=yellow align=center ><?php print LANGRESA61?></td>
...
for($i=0;$i<count($data);$i++) {
	...
	print "<td width=5>";
	print "&nbsp;le&nbsp;".dateForm($data[$i][3])."&nbsp;";
	print "</td>";
	print "<td><a href='#' onMouseOver=\"AffBulle('<font class=\'T1\'>entre $heureDepart et $heurefin <br /> $info </font>'); window.status=''; return true;\" onMouseOut='HideBulle()' >&nbsp;".recherche_equip($data[$i][1])."<input type=hidden name='id$j' value='".$data[$i][0]."'>";
