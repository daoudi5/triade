...
<td bgcolor=yellow align=center ><?php print LANGRESA60?></td>
</tr>
...
for($i=0;$i<count($data);$i++) {
	...
	print "<td valign='top' >&nbsp;<a href='resr_salle_ajout.php?id=".$data[$i][0]."' title='Modifier' >";
	print "<img src='image/commun/editer.gif' border='0' />&nbsp;";
	print preg_replace("/ /","&nbsp;",$data[$i][1])."</a>&nbsp;</td>";
