...
<?php
	...
	print '							<span class="T1">Version Php &gt; 5.0&nbsp;:</span>'."\n";
	print '						</td>'."\n";
	...
	print '		<td>'."\n";
	print '			<img src="image/on1.gif" alt="on1" style="width: 8px; height: 8px" />'."\n";
	print '			<span class="T1">Permission d\'écriture : </span>'."\n";
	print '		</td>'."\n";
	...
	if ($droitok == 1) {
		...
		$txt.= '	fichiers Triade</u> doivent être en accès écriture. Modifier ';
		$txt.= '	les droits de l\\\'aborescence Triade pour être conforme à son ';
		$txt.= '	utilisation.';
		$txt.= '</span>';
	...
	if (function_exists( 'mysql_connect' )) {
		...
		$txt.= '	<b>MySql</b> doit être chargé pour pouvoir utiliser une base ';
		$txt.= '	de donnée MySql.';
		$txt.= '</span>';
	...
	if (php_module_load("gd") != 1) {
		$txt = '<span style="font-family: Verdana; font-size: 0.9em;">';
		$txt.= '	<span style="color: red; font-weight: bold">L</span>\\\'extension ';
		$txt.= '	<b>gd</b> doit être chargé pour pouvoir visualiser les ';
	...
	if (function_exists( 'sqlite_open' )) {
		...
		$txt = '<span style="font-family: Verdana; font-size: 0.9em;">';
		$txt.= '	<span style="color: red; font-weight: bold;">L</span>\\\'extension ';
		$txt.= '	<b>SQLite</b> doit être chargé pour pouvoir utiliser le module ';
...
<?php
		...
		if ($phprec[0] == "Register Globals") {
			...
			$txt.= '	variable doit être à OFF pour des questions de sécurité.';
			$txt.= '</span>';
			...
			$txt = '<span style="font-family: Verdana; font-size: 0.9em;">';
			$txt.= '	<span style="color: red; font-weight: bold;">R</span>ecommandé a '.$phprec[2];
			$txt.= '</span>';

			$txt = htmlspecialchars($txt);

			print '<a href="#" onmouseover="AffBulle2(\'Recommandé\',\'../image/commun/info.jpg\',\''.$txt.'\'); window.status=\'\'; return true;" onmouseout="HideBulle()">'."\n";
