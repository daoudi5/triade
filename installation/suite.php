			...
			<div style="text-align: center;">
				<table style="text-align: left;
					...
					<tr>
						...
						<optgroup label="Serveur Clés en mains">
                                                <option style="color:#000066;background-color:#FCE4BA" value="FREEEOS">Free-OS</option>
                                                </optgroup>
						<optgroup label="Serveur Windows">
						<option style="color:#000066;background-color:#FCE4BA" value="APACHE2TRIAD">Apache2triad 1.5.4</option>
						<option style="color:#000066;background-color:#FCE4BA" value="EASYPHP">Easyphp 5.3.0</option>
						<option style="color:#000066;background-color:#FCE4BA" value="WAMP">WampServer 2.2</option>
						<option style="color:#000066;background-color:#FCE4BA" value="IIS">Serveur IIS</option>
						</optgroup>
						<optgroup label="Serveur Mutualisé">
					...
					<tr>
						<td style="text-align: right;">
							<span class="T2">Login d'accès à la base&nbsp;:</span>
						</td>
						<td>
					...
					<tr>
						<td style="text-align: right;">
							<span class="T2">Mot de passe d'accès la base&nbsp;:</span>
						</td>
						<td>
					...
					<tr>
						<td style="text-align: right;">
							<span class="T2">Nom du répertoire racine&nbsp;:</span>
						</td>
						<td>
...
<?php
	...
	if($webroot != ''){
		ereg ($webroot.'/(.*)/installation/'.basename(__FILE__), __FILE__, $regs);
		if ($regs[1] != "") {
			$repecole = $regs[1];
		}else {
			$fichier = $_SERVER["PHP_SELF"];
			$repecole = ereg_replace('installation/suite.php','',$fichier);
			$repecole = ereg_replace('/$','',$repecole);
			$repecole = ereg_replace('^/','',$repecole);
		}
	}
	else {
...
?>
				...
				<!--	<tr>
					...
					<tr>
						<td style="text-align: right;">
							<span class="T2">Préfixe des tables&nbsp;:</span>
						</td>
						<td>
