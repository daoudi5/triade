...
ALTER TABLE `tria_classes` ADD   `offline` BOOLEAN NOT NULL; 
ALTER TABLE `tria_info_ecole` ADD `id` INT NOT NULL AUTO_INCREMENT PRIMARY KEY; 
ALTER TABLE `tria_classes` ADD `idsite` INT NOT NULL DEFAULT '1';
