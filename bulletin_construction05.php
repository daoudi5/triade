...
//	$pdf->WriteHTML();
	...
	for($i=0;$i<count($ordre);$i++) {
		...
		$pdf->MultiCell(100,$confPolice[1],$commentaireeleve,'','','L',1);
...
$pdf->SetFont('Arial','',8);
$pdf->WriteHTML("APPRECIATIONS ET RECOMMANDATIONS DU CONSEIL DE CLASSE :");

$commentairedirection=recherche_com($idEleve,$_POST["saisie_trimestre"],"montessori");
...
$montessori=recherchemontessori($idEleve,"montessori",$_POST["saisie_trimestre"]);
