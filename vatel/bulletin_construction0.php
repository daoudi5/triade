...
<div id="wrapper" style="padding-top: 50px;">
		...
		<header id="page-title" style="margin-bottom: 0px;" class='menu' >
			...
			<ul class="breadcrumb" itemprop="breadcrumb" >
				...
				<li style="visibility:visible" ><a href='imprimer_trimestre.php' ><?php print LANGVATEL210 ?></a></li>
...
<?php 
if (($typebull == "bull0102") || ($typebull == "bull0109") || ($typebull == "bull0109-2") || ($typebull == "bull0103") || ($typebull == "bull01022") || ($typebull == "bull03") ||  ($typebull == "bull01") ||  ($typebull == "bull01b")  || ($typebull == "bull01019") || ($typebull == "bull800")  || ($typebull == "bull0101") || ($typebull == "bull0101a") || ($typebull == "bull0101b") || ($typebull == "bull01017") || ($typebull == "bull0305") || ($typebull == "bull0305a") || ($typebull == "bull113") || ($typebull == "bull12") || ($typebull == "bull12bis") || ($typebull == "bull12ter") || ($typebull == "bull503") || ($typebull == "bulllprb") ||  ($typebull == "bull01011" ) ||  ($typebull == "bull01012" ) ||  ($typebull == "bull01013" ) ||  ($typebull == "bull01014" ) ||  ($typebull == "bull01015" ) || ($typebull == "bull01015-2") ||  ($typebull == "bull700" ) || ($typebull == "bull01018" ) ||  ($typebull == "bull01016" ) || ($typebull == "bull0305b") ||  ($typebull == "bull01UE") ||  ($typebull == "bull04UE") || ($typebull == "bull04UE2") || ($typebull == "bull01XL") || ($typebull == "bull02UE") || ($typebull == "bull03UE") || ($typebull == "bull05UE")) {
?>
	<br /><br />
	<?php 
	$idclasse=$_POST["saisie_classe"];
	...
	<?php if (($typebull == "bull0305") || ($typebull == "bull0305a") || ($typebull == "bull0305b")) { ?>
	...
	<?php 
	if (($typebull == "bull0305") || ($typebull == "bull0305a") || ($typebull == "bull0305b")) { ?>
	...
	if (($typebull == "bull04UE" ) || ($typebull == "bull04UE2" )) {
		...
		if ($typebull == "bull04UE" ) {
			print "<font class='T2'>Bulletin provisoire :</font> <input type='radio' name='bulletinProvisoire' $checkboxbullprovisoireOui value='oui' /> (<i>oui</i>)<br />";
				print "<ul><font class='T2'>- Avant rattrapage :</font> <input type='radio' name='rattrapageprovisoire' $checkboxRattrapageprovisoireOui  value='non' /> (<i>oui</i>)<br />";
				print "<font class='T2'>- Après rattrapage :</font> <input type='radio' name='rattrapageprovisoire' $checkboxRattrapageprovisoireNon  value='oui' /> (<i>oui</i>)<br /></ul>";
			print "<font class='T2'>Bulletin définitif :</font> <input type='radio' name='bulletinProvisoire' $checkboxbullprovisoireNon  value='non' /> (<i>oui</i>)<br /><br />";
		}
	} 	
...
<?php if ($_SESSION["membre"] == "menupersonnel")  { ?> 
	...
	<table border=0 align=center width="250"><tr><td align="center">
        <script language=JavaScript>buttonMagicRetourVATEL("imprimer_trimestre.php<?php print $url ?>","_parent")</script>
        <?php if ($nbEleve > 0) { ?><script language=JavaScript>buttonMagicSubmit3VATEL("<?php print LANGBULL6 ?>","rien","onclick='this.value=\"<?php print LANGBT5 ?>\";AfficheAttente()'");</script>&nbsp;&nbsp;
	<?php }else{ print "<br><br><font id='color3' class='T2 shadow'>Aucun ".INTITULEELEVE." pour cette classe en $anneeScolaire</font>"; } ?>
	</td></tr></table>
	<br><br>
<?php } ?>
...
<?php if ($_SESSION["membre"] == "menuscolaire") { ?> 
	...
	<br><br>
	<?php if (($typebull == "bull01") ||  ($typebull == "bull01b") || ("bull0101" == $typebull) || ($typebull == "bull0101a") || ($typebull == "bull0101b") || ($typebull == "bull01019") )  { print "</td></tr></table>"; } ?>
...
?>
	<br><br><br><font class="T2">Nbr de point en moins par abs. non justifiée : </font> <input type='text' size=2 name='ptenmoinsabs' value='<?php print $ptenmoinsabs ?>'  style='float:none' />
...
if (($typebull == "bull0208") || ($typebull == "bull01011")  ||  ($typebull == "bull01016") ||  ($typebull == "bull01018")  ||  ($typebull == "bull01012" ) ||  ($typebull == "bull01013" ) ||  ($typebull == "bull01014" ) || ($typebull == "bull800") || ($typebull == "bull01015" )) {
	$hauteurBull="10";
 ...
 if (($typebull == "bull0101") || ($typebull == "bull0101a") || ($typebull == "bull0101b")) {
 	$datap=config_param_visu("hauteurMatiere");
	$hauteurBull=$datap[0][0];
	if (trim($hauteurBull) == "") {
		$hauteurBull="10";
		if (($typebull == "bull0101") || ($typebull == "bull0101a") || ($typebull == "bull0101b")) { $hauteurBull="8"; }
	}
...
if (($typebull == "bull01") ||  ($typebull == "bull01b") || ($typebull == "bull01019") || ($typebull == "bull800") || ($typebull == "bull0101") || ($typebull == "bull0101a") || ($typebull == "bull0101b") || ($typebull == "bulllprb") || ($typebull == "bull01011") ||  ($typebull == "bull01012" ) ||  ($typebull == "bull01013" ) ||  ($typebull == "bull01014" ) ||  ($typebull == "bull01015" ) || ($typebull == "bull01015-2") || ($typebull == "bull700") || ($typebull == "bull01016") || ($typebull == "bull01018") ) {
	...
	if ( ($typebull == "bull0101") || ($typebull == "bull0101a") || ($typebull == "bull0101b") || ($typebull == "bull01017") || ($typebull == "bull01011") ||  ($typebull == "bull01012" ) ||  ($typebull == "bull01013" ) ||  ($typebull == "bull01014" ) ||  ($typebull == "bull01015" ) || ($typebull == "bull01015-2") || ($typebull == "bull01016") || ($typebull == "bull01018")  )  {
	...
	print "<td $cache colspan='2' align='right' > <font class='T2'>Afficher la moyenne générale :</font>e t <input type=checkbox name='affichemoyengeneral' value='oui' $affichemoyengeneral $disabledmoyengeneral > (oui) </td></tr>";
	...
	if ( ($typebull == "bull0101") || ($typebull == "bull0101a") || ($typebull == "bull0101b") || ($typebull == "bull01017") ||  ($typebull == "bull01") ||  ($typebull == "bull01b") || ($typebull == "bull01019")  || ($typebull == "bull800")  ||  ($typebull == "bull01015" ) || ($typebull == "bull01015-2") || ($typebull == "bull700")  ) {
...
if (($typebull == "bull0101") || ($typebull == "bull0101a") || ($typebull == "bull0101b"))  {
	...
	if (trim($notaffmoyclass) == "oui") { $notaffmoyclass="checked='checked'"; }
	if (($typebull != "bull0101a") && ($typebull != "bull0101b"))  { 
		$notaffmoyclass="checked='checked'"; 
		$disabledaffmoyclasse="readonly='readonly'" ;  
		print "<tr $cache ><td  colspan='2' align=right ><font class=T2> Ne pas afficher la moyenne de classe, mini et maxi :</font>";
		print " <input type='checkbox' name='notaffmoyclass'  value='oui' $notaffmoyclass $disabledaffmoyclasse /> (oui) </td></tr>";
	}
...
<?php
// VATEL
if (($typebull == "bul9999") ||  ($typebull == "bul9999en")) {
...
$liste_matiere=ereg_replace("\{","",$idliste[0][1]);
$liste_matiere=ereg_replace("\}","",$liste_matiere);
if ($liste_matiere != "") {
$sql=<<<EOF
...
for($i=0;$i<count($data);$i++)  {
	if ($data[$i][1] != "") {
		print "<option  id='select1' value='".$data[$i][0]."' title=\"".$data[$a][1]." ".ereg_replace("0$","",$data[$a][2])."\" >".$data[$i][1]." ".ereg_replace("0$","",$data[$i][2])."</option>";
        }
}
?>
</select>
...
?>
	...
	for($i=0;$i<count($data);$i++)  {
		if ($data[$i][1] != "") {
			print "<option STYLE='color:#000066;background-color:#CCCCFF' value='".$data[$i][0]."' >".$data[$i][1]." ".ereg_replace("0$","",$data[$i][2])."</option>";
	        }
	}
	?>
	</select>
...
if (($_POST["saisie_trimestre"] == "trimestre3" && $typebull == "bull02UE") || ($_POST["saisie_trimestre"] == "trimestre3" && $typebull == "bull04UE"))  {
	// rien
}else{
