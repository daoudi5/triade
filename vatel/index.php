...
<div class="fullwidthbanner-container roundedcorners">
        <div class="fullwidthbanner hidden-xs">
            <ul>
			 ...
			 <div style="background-color: rgba(36, 36, 36, 0.2); background: rgba(36, 36, 36, 0.2); color: rgba(36, 36, 36, 0.2); border:none 1px #000000; -moz-border-radius: 24px; -webkit-border-radius: 24px; border-radius: 24px; width:450px; height:<?php print $height ?>px;padding:25px " >
				 <font color='white'><?php print LANGVATEL245 ?></font><br><br>
				 <input type='button' class="btn btn-primary btn-sm  vat-btn-footer" value="<?php print LANGVATEL18 ?>" onClick="open('index1.php','_self','')" >
				 
				 <input type='button'  class="btn btn-primary btn-sm  vat-btn-footer" value="<?php print LANGVATEL19 ?>" onClick="open('index2.php','_self','')" >
				 
				 <input type='button' class="btn btn-primary btn-sm  vat-btn-footer" value="<?php print LANGVATEL20  ?>" onClick="open('index3.php','_self','')" >
				 </div>
                    </div>
                </li>
            </ul>
	...
	<section class="container text-center phone">
		<div style="background-color: rgba(36, 36, 36, 0.2); background: rgba(36, 36, 36, 0.2); color: rgba(36, 36, 36, 0.2); border:none 1px #000000; -moz-border-radius: 24px; -webkit-border-radius: 24px; border-radius: 24px; width:100%; height:<?php print $height ?>px;padding:15px " >
          <font color='white'><?php print LANGVATEL245 ?></font><br><br>
				 <input type='button' class="btn btn-primary btn-sm  vat-btn-footer" value="<?php print LANGVATEL18 ?>" onClick="open('index1.php','_self','')" ><br><br>
				 
				 <input type='button' class="btn btn-primary btn-sm  vat-btn-footer" value="<?php print LANGVATEL19 ?>" onClick="open('index2.php','_self','')" ><br><br>
