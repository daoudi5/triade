...
<tr><td height="2" colspan=3><b><font id='menumodule1' ><?php print LANGELE4?> : <font id="color2"><B><?php print $cl?></font></font></td></tr>
<?php
if( count($data) <= 0 ){
	print("<tr><td align='center' valign='center' >".LANGRECH1."</td></tr>");
}else{
?>
	<tr bgcolor="black"><td><font color='#FFFFFF'><B><?php print ucwords(LANGIMP8)?></B></font></td><td colspan='2'><font color='#FFFFFF'><B><?php print ucwords(LANGIMP9)?></B></font></td></tr>
	<?php
	for($i=0;$i<count($data);$i++) {
		...
		<td align=center width=5>&nbsp;[&nbsp;<a href="#" onClick="open('../photoajouteleve.php?ideleve=<?php print $data[$i][1]?>','photo','width=450,height=280')"><?php print "ajouter" ?></a>&nbsp;]&nbsp;[&nbsp;<a href="#" onclick="open('../photoajouteleve.php?idelevesupp=<?php print $data[$i][1]?>','photo','width=450,height=280')"><?php print LANGBT50 ?></a>&nbsp;]&nbsp;</td>
		</tr>
		<?php
	}
}
