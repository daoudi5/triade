...
SELECT c.libelle,e.nom,e.prenom,e.elev_id,c.code_class
...
for($i=0;$i<count($data);$i++)
	...
	<td><a style="text-decoration:underline" href="ficheeleve3.php?eid=<?php print $data[$i][3]?>&idclasse=<?php print $data[$i][4]?>"><?php print strtoupper($data[$i][1])?></a></td>
