...
?> 
	<div id="wrapper" style="padding-top: 50px;">
		...
		<header id="page-title" style="margin-bottom: 0px;" class='menu' >
			<div class="container">
			<span class="vat-capitalize-title"><?php print LANGVATEL34 ?> <?php print $nomduprof ?></span>
		...
		<form method="POST" name="formulaire0" action="ajoutabsRtdSanc.php">
...
<br/><br/>
<form method="POST" onsubmit="return verifAccesNotebis()" name="formulaire" action="ajoutabsRtdSanc2.php" target="_blank" >
