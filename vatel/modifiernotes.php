...
?> 
	<div id="wrapper" style="padding-top: 50px;">
		...
		<form method="POST" name="formulaire0" action="modifiernotes.php">
...
<br/>
<form method="POST" onsubmit="return verifAccesNotebis()" name="formulaire" action="modifiernotes2.php" >
...
<option value="0" STYLE="color:#000066;background-color:#FCE4BA"> <?php print LANGCHOIX3 ?> </option>
		...
		<BR>
				<?php
                 if (NOTEUSA == "oui") {
                 	?>
                 	<font class="T2"><?php print "Saisie en mode U.S.A "  ?> : </font>  
			<select name="NoteUsa" class="form-control vat-extend-select pointer" >
