...
?> 
	<div id="wrapper" style="padding-top: 50px;">
		...
		<header id="page-title" style="margin-bottom: 0px;" class='menu' >
			<div class="container">
			<span class="vat-capitalize-title"><?php print LANGVATEL24 ?> - <?php print LANGVATEL26 ?> <?php print $nomduprof ?></span>
...
&nbsp;&nbsp;<input type='submit' class="btn btn-primary btn-sm  vat-btn-footer" value="<?php print LANGOK ?>" name="create" />
<?php
...
?>
&nbsp;&nbsp;&nbsp;
<a href="./visu_pdf_prof.php?id=<?php print preg_replace('/\.\.\/data/','data2',$fichier) ?>" target="_blank"><img src="../image/commun/print.gif" border=0 align=center></a>
...
if ($triEleve == "nomeleve") { ?>
	<tr><td align="center">[ <a href="visunotes2.php?sMat=<?php print $mid ?>&sClasseGrp=<?php print $cgrp1 ?>&order=classe "><?php print LANGNNOTE2 ?></a> ]</td></tr>
<?php } ?>

<?php if ($triEleve == "classe") { ?>
<tr><td align="center">[ <a href="visunotes2.php?sMat=<?php print $mid ?>&sClasseGrp=<?php print $cgrp1 ?>&order=nomeleve "><?php print LANGNNOTE3 ?></a> ]</td></tr>
<?php } 
}
...
//$moyennne->set_pattern();
	...
	for($i=0;$i<count($mat);$i++){
		...
		print "<tr>\n";
		print "<td bgcolor='$bgcolor' bordercolor='white' style='padding:5px'  >&nbsp;".$mat[$i][1]."&nbsp;</td>\n";
		$data_note=recherche_note_pour_prof($mat[$i][0],$sql2,$mid,$idprof);
		...
		?>
			<td  bgcolor='<?php print $bgcolor ?>' style='padding:5px' bordercolor='white' width='10' <?php print $bgexam ?> >&nbsp;<?php print $bold.$noteaff.$boldf ?></a>&nbsp;</td>
			<?php
			// moyenne de l'élève
			...
			if ($okmoy == 1) {
				...
				if ($unenote == 1) {
					$nbeleve++;;
					print "<td  bgcolor='$bgcolor' bordercolor='white' style='padding:5px;border-left-style:solid;border-left-color:black;' >&nbsp;<b><a href='#' title=\"".LANGMESS82." ".INTITULEELEVE." $sur20 \" >$font $moyenneleveaff $fontf</a>&nbsp;</b></td>";
				}else{
					$moyenneleveaff="";
					print "<td  bgcolor='$bgcolor' bordercolor='white' style='padding:5px' >&nbsp;</td>";
				}
	...
	print "</table>";
	print("<center><font class=T1>".LANGRECH1."</font></center><br><br><br><br><br><br>");
}
Pgclose() 
?>
<!-- // fin  -->
