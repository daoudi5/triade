...
<table border="0" cellpadding="3" cellspacing="1" bordercolor='#000000' width='95%' height="85" align="center"  style="border-collapse: collapse;"  >
...
<script language=JavaScript>buttonMagicVATEL("<?php print LANGBT20?>","./affectation_creation.php","_top","",";parent.window.close();");</script>
<script language=JavaScript>buttonMagicSubmitVATEL("<?php print LANGBT21?>","rien"); //text,nomInput</script><br><br>
</td></tr></table>
<br>
