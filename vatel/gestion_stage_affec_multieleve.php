...
<script language="JavaScript" src="../librairie_js/function.js"></script>
	...
	<title><?php print LANGVATEL234 ?></title>
...
<tr><td valign='top'>
	...
	<tr bgcolor='#000000' >
		<td width='15%' >&nbsp;<font class='T22'><?php print LANGSTAGE100 ?></font></td>
		<td width='15%' >&nbsp;<font class='T22'><?php print LANGSTAGE101 ?></font></td>
		<td width='5%' >&nbsp;<font class='T22'><?php print LANGSTAGE102 ?></font></td>
		<td width='5%' >&nbsp;<font class='T22'><?php print LANGSTAGE103 ?></font></td>
		<td width='5%' >&nbsp;<font class='T22'><?php print LANGSTAGE104 ?></font></td>
		<td width='5%' >&nbsp;<font class='T22'><?php print LANGSTAGE105 ?></font></td>
		<td width='5%' >&nbsp;<font class='T22'><?php print LANGSTAGE106 ?></font></td>
		<td width='9%' >&nbsp;<font class='T22'><?php print LANGSTAGE107 ?></font></td>
	</tr>
<?php
...
for($i=0;$i<count($data);$i++) {
		...
		$nomprenom="<font class='T1'>".ucwords($data[$i][2])." ".ucfirst($data[$i][3])."</font>";
	...
	//	infoBulleEleveSansLoupe($data[$i][1],$nomprenom);
		...
		select_stage_multi2VATEL($saisie_classe,$i,$num_stage);
		print "</font></td>";
		print "<td valign='top' >&nbsp;<font class='T1'>";
		print "<select name='ident_$i' id='ident_$i' onChange=\"checkListMulti(this.value,'$urlcentrale','$p','".PRODUCTID."','$i');\"  style=\"padding:0px;height:initial;\" >";
		...
		print "</td>";
		print "<td valign='top'  >";
		print "<select id='select_$i' onChange=\"verifSiAutre('$i',this.value)\" style=\"padding:0px;height:initial;\"  >";
		...
		print "</td>";
		print "<td valign='top'  >&nbsp;<font class='T2'><input type='text' size='15' id='indemnitestage_$i' name='indemnitestage_$i' value=\"$indemnitestage\"  maxlength='200' ></font></td>";
		$indemnitestage="";
		$checked="";
		if ($loger == 1) $checked="checked='checked'" ;
		print "<td valign='top'  >&nbsp;<font size='1' ><input type='checkbox' name='loge_$i' id='loge_$i' value='1' style='float:none' class='btradio1' $checked > (oui)</font></td>";
		$checked="";
		if ($nourri == 1) $checked="checked='checked'" ;
		print "<td valign='top'  >&nbsp;<font size='1' ><input type='checkbox' name='nourri_$i' id='nourri_$i' value='1' style='float:none' class='btradio1' $checked  > (oui)</font></td>";
		print "<td valign='top' ><input type='hidden' name='saisie_classe_$i' value='$saisie_classe' id='saisie_classe_$i' >";
		print "&nbsp;&nbsp;<span id='aff_$i' style='display:none'><script language=JavaScript>buttonMagicSubmit4VATEL('".LANGENR."','','enrg($i)')</script></span>&nbsp;&nbsp;";
