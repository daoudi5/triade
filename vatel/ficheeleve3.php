...
<div id="wrapper" style="padding-top: 50px;">
		...
		<header id="page-title" style="margin-bottom: 0px;" class='menu' >
			<div class="container">
			<span class="vat-capitalize-title"><?php print LANGTITRE45 ?> </span>
...
<script language=JavaScript>buttonMagicSubmitVATEL("<?php print LANGMESS250 ?>","rien");</script>
...
<script language=JavaScript> buttonMagicSubmit3VATEL("<?php print LANGMESS251 ?>","sms","<?php print $disabledSMS?>")</script>
<input type='hidden' name="eid" value="<?php print  $id_eleve ?>" />
</form>
</td>
<td>
&nbsp;
<script language=JavaScript>buttonMagic2VATEL('<?php print $bouton?>','ficheeleve3.php?eid=<?php print $id_eleve?>&val=<?php print $inactifval?>','_self','')</script>
&nbsp;<script language=JavaScript>buttonMagic2VATEL('<?php print $bouton2 ?>','ficheeleve3.php?eid=<?php print $id_eleve?>&proba=<?php print $probaval?>','_self','')</script>
&nbsp;<script language=JavaScript>buttonMagic2VATEL('<?php print "Affecter &agrave; un stage"?>','gestion_stage_affec_eleve_2.php?id=<?php print $id_eleve?>&idclasse=<?php print $saisie_classe ?>','_self','')</script>
</td>

<!-- 
<script language=JavaScript>buttonMagic2VATEL("<?php print LANGPROF38 ?>","profpprojo.php?fiche=1&idClasse=<?php print $saisie_classe?>","video","width=800,height=600,resizable=yes,personalbar=no,toolbar=no,statusbar=no,locationbar=no,menubar=no,scrollbars=yes","<?php print $disabledprojo ?>");</script>
</td>
...
<script language=JavaScript>buttonMagicSubmit3VATEL("<?php print LANGMESS252 ?>","fiche","")</script>
<input type='hidden' name="eid" value="<?php print  $id_eleve ?>" />
</form>
</td>
-->
...
<?php if ( (CARNETSUIVIPROF == "oui") && ($_SESSION["membre"] == "menuprof"))  { ?>
	<tr><td><script language=JavaScript>buttonMagicVATEL("<?php print LANGMESST392 ?>","carnet_editer.php?sClasseGrp=<?php print $saisie_classe?>","_parent","","");</script></td></tr>
<?php } ?>
...
<!-- 
<table><tr>
</td><td><script language=JavaScript>buttonMagic2VATEL('<?php print $bouton?>','ficheeleve3.php?eid=<?php print $id_eleve?>&val=<?php print $inactifval?>','_self','')</script></td>
<td><script language=JavaScript>buttonMagic2VATEL('<?php print $bouton2 ?>','ficheeleve3.php?eid=<?php print $id_eleve?>&proba=<?php print $probaval?>','_self','')</script></td>
<td><script language=JavaScript>buttonMagic2VATEL('<?php print "Affecter &agrave; un stage"?>','gestion_stage_affec_eleve_2.php?id=<?php print $id_eleve?>&idclasse=<?php print $saisie_classe ?>','_self','')</script>
<?php if (true)  { ?>
<td><script language=JavaScript>buttonMagic2VATEL('<?php print "Impression"?>','impressionficheeleve.php?id=<?php print $id_eleve?>&idclasse=<?php print $saisie_classe ?>','_self','')</script>
<?php } ?>
</tr>
...
?>
	...
	<div style="position:relative;left:10px;top:15px;float:left;text-align:center;z-index:10000">
		<div style="position:absolute;top:-28px;left:-24px;z-index:1000000" ><img src='../image/commun/paperclip.png'></div>
	...
	<tr><td align='right'><font class='T2'><?php print LANGBULL29 ?> :</font>&nbsp;</td><td><?php print $annee_scolaire_eleve  ?></font></td></tr>
...
<div id="dhtmlgoodies_tabView2">
		...
		if (($_SESSION["membre"] == "menuadmin") || ($_SESSION["membre"] == "menupersonnel")){
			print "<br><script language=JavaScript>buttonMagicVATEL('".LANGMESS309."','profpcomplement.php?eid=$idEleve','_parent','','');</script>";
		}
		?>
		<br><br>
		<?php
...
<?php 
	if (  (((defined("NOTEELEVEVISU")) && (NOTEELEVEVISU == "oui")) && ($_SESSION["membre"] == "menuprof")) 
		...
		<script language=JavaScript>buttonMagicSubmitVATEL("<?php print LANGMESS310 ?>","rien");</script>
...
<?php   } ?>
  ...
  <div class="dhtmlgoodies_aTab" style="overflow:auto;" >
		<?php if (($_SESSION["membre"] == "menuadmin") || ($_SESSION["membre"] == "menuscolaire") ) {  ?>
			<br><table>
			<tr><td>
			<form method="post" action="gestionABSRtdSanc.php" >
			<script language=JavaScript>buttonMagicSubmitVATEL("<?php print LANGMESS311 ?>","rien");</script>
			<input type="hidden" name="saisie_eleve_id" value="<?php print $id_eleve ?>"  />
			</form>
			</td><td>&nbsp;
			<form method="post" action="gestion_abs_retard_modif_donne.php" >
			<td id='bordure'><script language=JavaScript>buttonMagicSubmitVATEL("<?php print LANGMESS312 ?>","rien");</script>
			<input type="hidden" name="saisie_eleve_id" value="<?php print $id_eleve ?>"  />
			</form>
			</td><td>&nbsp;
			<form method="post" action="gestion_abs_retard_modif.php" >
			<td id='bordure'><script language=JavaScript>buttonMagicSubmitVATEL("<?php print LANGMESS313 ?>","rien");</script>
			<input type="hidden" name="saisie_eleve_id" value="<?php print $id_eleve ?>"  />
			</form>
			</td></tr></table><br>
		<?php } 
			if ((ACCESPROFVISUABSRTD == "oui") ||  ($_SESSION["membre"] == "menuadmin") || ($_SESSION["membre"] == "menuscolaire") ||  ($_SESSION["membre"] == "menupersonnel")) { 
				...
				for($i=0;$i<count($data);$i++) { ?>
					...
					<table border="1" bordercolor="#000000" width="100%"  style="border-collapse: collapse;"  >
					<TR>
					<TD bgcolor='black' align=center width=15%><font color='white'><b><?php print LANGABS13 ?></b></font></td>
					<TD bgcolor='black' align=center width=20%><font color='white'><b><?php print LANGPARENT17 ?></b></font></td>
					<TD bgcolor='black' align=center width=15%><font color='white'><b><?php print LANGABS60 ?> </b></font></td>
					<TD bgcolor='black' align=center width=20%><font color='white'><b><?php print LANGABS12 ?> </b></font></td>
					</TR>
					<?php
					...
					for($j=0;$j<count($data_2);$j++) {
						...
						list($creneaux,$debcre,$fincre)=split('#',$data_2[$j][10]);
						...
						<table border="1" bordercolor="#000000" width="100%"  style="border-collapse: collapse;"  >
						<TR>
						<TD bgcolor='black' align=center width=15%><font color='white'><b><?php print LANGPARENT8 ?> </b></font></td>
						<TD bgcolor='black' align=center width=15%><font color='white'><b><?php print LANGABS60 ?> </b></font></td>
						<TD bgcolor='black' align=center width=20%><font color='white'><b>&nbsp;<?php
						...
						for($j=0;$j<count($data_3);$j++) {
							$bgcolor=($bgcolor=="#87C1E6") ? $bgcolor="#BCDAF0" : $bgcolor="#87C1E6" ;
							list($creneaux,$debcre,$fincre)=split('#',$data_3[$j][13]);
						?>
						<TR bgcolor='<?php print $bgcolor ?>' >
...
<?php 				} ?>
  ...
  <div class="dhtmlgoodies_aTab"  style="overflow:auto;"  >
	...
	<TD bgcolor='black' align=center width=5><font color='white'><b><?php print ucwords(LANGPROFK) ?></b></font></td>
	<TD bgcolor='black' align=center ><font color='white'><b><?php print LANGDISC57?></b></font> </td>
...
<TR>
<TD bgcolor='black' align=center width=10%><font color='white'><b><?php print LANGPARENT16 ?></b></font></td>
<TD bgcolor='black' align=center ><font color='white'><b><?php print LANGDISP2 ?></b></font></td>
</TR>
<?php
...
<?php } ?>
	...
	<div class="dhtmlgoodies_aTab"  style="overflow:auto;"  >
  		<?php if (($_SESSION["membre"] == "menuadmin") || ($_SESSION["membre"] == "menuscolaire")|| ($_SESSION["membre"] == "menupersonnel")) {  ?>
  			...
  			<?php 
			print "<tr><td bgcolor='black' width='10%' ><font color='white'><b>&nbsp;".LANGBULL3."</b></font></td><td bgcolor='black'><font color='white'><b>&nbsp;Classe</b></font></td></tr>";
			$data=listingHistoClasseEleve($idEleve); // annee, classe
			for ($i=0; $i<count($data);$i++) {
				$bgcolor=($bgcolor=="#87C1E6") ? $bgcolor="#BCDAF0" : $bgcolor="#87C1E6" ;
				print "<tr bgcolor='$bgcolor' ><td>&nbsp;".$data[$i][0]."&nbsp;</td><td>&nbsp;".$data[$i][1]."</td></tr>";
			}
   			?>
  			</table>
		<?php }else{ ?>
	...
	<div class="dhtmlgoodies_aTab"  style="overflow:auto;"  >
  		<?php if (($_SESSION["membre"] == "menuadmin") || ($_SESSION["membre"] == "menuscolaire")|| ($_SESSION["membre"] == "menupersonnel")) {  ?>
  			<table width=100% border="1" bgcolor='#FFFFFF'  style="border-collapse: collapse;"  >
  			<?php 
			print "<tr><td bgcolor='black' width='5%' ><font color='white'><b>&nbsp;Date</b></font></td><td bgcolor='black'><font color='white'><b>&nbsp;Action</b></font></td><td bgcolor='black'><font color='white'><b>&nbsp;Information</b></font></td></tr>";
			$data=listingHistoEleve($idEleve); // date,action,info
			for ($i=0; $i<count($data);$i++) {
				$bgcolor=($bgcolor=="#87C1E6") ? $bgcolor="#BCDAF0" : $bgcolor="#87C1E6" ;
				print "<tr bgcolor='$bgcolor' ><td>&nbsp;".dateForm($data[$i][0])."&nbsp;</td><td>&nbsp;".$data[$i][1]."</td><td>".$data[$i][2]."</td></tr>";
			}
   			?>
  			</table>
		<?php }else{ ?>
...
initTabs('dhtmlgoodies_tabView1',Array('<?php print LANGMESS259 ?>','<?php print LANGMESS260 ?>','<?php print LANGMESS261 ?>','<?php print LANGMESS262 ?>','<?php print LANGTMESS505 ?>','<?php print LANGMESS263 ?>'),'0','100%',840,Array(false,false,false,false,false,false,false));
