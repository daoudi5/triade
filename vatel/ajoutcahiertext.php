...
?> 
	<div id="wrapper" style="padding-top: 50px;">
		...
		<header id="page-title" style="margin-bottom: 0px;" class='menu' >
			<div class="container">
			<span class="vat-capitalize-title"><?php print LANGPROF37 ?> <?php print $nomduprof ?></span>
		...
		<form method="POST" name="formulaire0" action="ajoutcahiertext.php">
...
<br/><br/>
<form method="POST" onsubmit="return verifAccesNotebis()" name="formulaire" action="ajoutcahiertext2.php">
