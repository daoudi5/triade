...
?>
<form method="post" >
<font class="T2">&nbsp;&nbsp;Liste des horaires de prestation </font><br><br>
...
for($i=0;$i<count($data);$i++) {
	...
	print "<td id='bordure' align='center'><input type='text' size='6' value='$heure' onchange=\"AjuteEDTHoraire('$id',this.value,'','el$i','4')\" /></td>";
	print "<td id='bordure' align='center'><input type='text' size='6' value='$duree' onchange=\"AjuteEDTHoraire('$id','',this.value,'el$i','4')\" /></td>"; 
	print "</tr>";
}
