...
<?php
		...
		?>
					...
					<?php print $emetteur; 	?>
        				...
        				<tr bgcolor="#FFFFFF">
          				<td height="19" valign=top><div align="left" ><?php print LANGTE5?> : <?php print $data[0][8]?></div>
					</td>
					</td>
...
&nbsp;&nbsp;<a href='#' onclick="imprimer();"><img src="./image/print.gif" align="absmiddle" alt="Imprimer" border=0></A></div></td></tr>
					...
					<tr><td><div style=''><?php print stripslashes(Decrypte($data[0][3],$number)) ?></div></td></tr></table>
					<br><br><br>
					<hr>
