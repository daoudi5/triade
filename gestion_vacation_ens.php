...
<?php print "Confirmation de vacation d'un enseignant" ?></font></b></td>
</tr>
<tr id='cadreCentral0'>
<td valign='top'>
<br>
<form method="post" action="gestion_vacation_ens2.php" onsubmit="return valide_supp_choix('saisie_pers_supp','<?php print LANGSUPP13?>')" name="formulaire" >
<blockquote>
