...
?>
		...
		//
?>
		<tr bordercolor="#000000"  ><td valign='top' colspan='9' >Rapport de visite du <?php print dateForm($infocompterendu[0][2])." à ".timeForm($infocompterendu[0][3])." : ".$infocompterendu[0][5] ?><br /><i>Information : <?php print $info_plus ?></i></td></tr>
