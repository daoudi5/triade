...
<tr id='coulBar0' ><td height="2"><b><font   id='menumodule1' ><?php print "Vacation enseignant / Paiement " ?></font></b></td></tr>
<tr id='cadreCentral0' >
<td ><br><br>
     <!-- // fin  -->
...
<td colspan="2"   align="left"><input type="text" value="<?php print getCookies("date_paiem_debut") ?>" name="saisie_date_debut" TYPE="text" size=13  class=bouton2 readonly='readonly'  >
<?php
...
<td colspan="2"  align="left"><br><input type="text" value="<?php print getCookies("date_paiem_fin") ?>" name="saisie_date_fin" TYPE="text" size=13 class=bouton2 readonly='readonly' >
<?php
 include_once("librairie_php/calendar.php");
 if ($_SESSION["navigateur"] == "IE") {
