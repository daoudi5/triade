<?php
  $AppliStyleNom="Automne";           /*NOM DU STYLE AFFICHE DANS LE CHOIX DE L'INTERFACE*/
                                      /*           NE PAS DEPLACER NI SUPPRIMER          */

  $AppliFondEcran="#FFFFFF";                               /*FOND PAGE*/
  $AppliFondImage="url(\"../skins/Automne/bg.png\")";           /*IMAGE FOND PAGE*/

  $FormulaireFondInput="#FFFEF9";                          /*FOND FORMULAIRE*/
  $FormulaireTexteInput="#000000";                         /*TEXTE FORMULAIRE*/
  $FormulaireBordureInput="#000000 solid 1px";             /*BORDURE FORMULAIRE*/
  $FormulaireFondBouton="#9B615F";                         /*FOND BOUTON*/
  $FormulaireTexteBouton="#FFFFFF";                        /*TEXTE BOUTON*/
  $FormulaireBordureBouton="#000000 solid 1px";            /*BORDURE BOUTON*/
  $FormulaireImageBouton="none";                           /*IMAGE FOND BOUTON*/

  $MenuFond="#5B5B5B";                                     /*AGENDA FOND MENU*/
  $MenuOnLien="#FFFFFF";
  $MenuOnLienHover="#FFDF7F";
  $MenuOnFond="#9B615F;BORDER-LEFT:solid 1px #FFFFFF;BORDER-RIGHT:solid 1px #FFFFFF;";
  $MenuOffLien="#FFFFFF";
  $MenuOffLienHover="#FFDF7F";
  $MenuCopyright="#000000";                                /*TEXTE COPYRIGHT*/

  $AujourdhuiFond="#9B615F";
  $AujourdhuiLien="#FFFFFF";
  $AujourdhuiLienHover="#FFDF7F";

  $PageTitre="#8C4F50";
  $PageNomUtilisateur=$PageTitre;
  $PageDate="#FFFFFF";

  $CalNavigationFond="#373737";                            /*AGENDA FOND SOUS MENU*/
  $CalNavigationTexte="#FFFFFF";                           /*AGENDA TEXTE SOUS MENU*/
  $CalNavigationLien=$CalNavigationTexte;                  /*AGENDA LIEN SOUS MENU*/
  $CalNavigationLienHover="#FFDF7F";                       /*AGENDA SURVOL LIEN SOUS MENU*/
  $CalTitreFond="#E4D5D4";
  $CalFond="#E1E1E1";                                      /*CALENDRIER FOND CALENDRIER*/
  $CalJour="#000000";                                      /*CALENDRIER JOUR DU MOIS*/
  $CalJourHover="#9B615F";                                 /*CALENDRIER JOUR DU MOIS SURVOL*/
  $CalJourWE="#CC0000";                                    /*CALENDRIER JOUR DU MOIS WEEK-END*/
  $CalJourWEHover="#FF0000";                               /*CALENDRIER JOUR DU MOIS WEEK-END SURVOL*/
  $CalJourMoisPrec="#9B615F";                              /*CALENDRIER JOUR MOIS PRECEDENT*/
  ...
  $CalJourEvenement="#d5bdbd"; 									  				 /*CALENDRIER EVENEMENT*/
  $CalJourSelection="#C6A4A1";                             /*CALENDRIER FOND PLAGE SELECTION*/
  $CalJourCourant="#E4D5D4";                               /*CALENDRIER JOUR OU SEMAINE COURANTE*/
  $CalQuitterLien="#000000";
  $CalQuitterLienHover="#9B615F";
  $CalFondExport="#FFFFFF";                                /*FOND DES LIENS POUR L'IMPORT / EXPORT*/
  $CalFlechePopup="menuarrow_g.gif";                       /*FLECHE POUR LES MENUS DU CALENDRIER EN DHTML*/
                                                           /*A PLACER DANS "image/calendrier/"*/

  $AgendaLien="#000000";                                   /*AGENDA LIEN*/
  $AgendaLienHover="#9B615F";                              /*AGENDA LIEN SURVOL*/
  $AgendaTexte="#000000";                                  /*AGENDA TEXTE*/
  $AgendaBordureTableau="#243B50";
  $AgendaBordureNote=$AgendaBordureTableau;                /*PLANNING BORDURE NOTE*/
  $AgendaFondNotePerso="#E1EDF7";                          /*PLANNING FOND NOTE PERSO*/
  $AgendaFondNote="#FFFFC0";                               /*PLANNING FOND NOTE*/
  $AgendaPopupBordure=$AgendaBordureTableau;               /*AGENDA BORDURE POPUP*/
  $AgendaFondTitrePopup="#9B615F";                         /*AGENDA FOND TITRE POPUP*/
  $AgendaTexteTitrePopup="#FFFFFF";                        /*AGENDA TEXTE TITRE POPUP*/
  $AgendaFondPopup="#F7F7EF";                              /*AGENDA FOND POPUP*/
  $AgendaTextePopup="#000000";                             /*AGENDA TEXTE POPUP*/
  $AgendaContactPopup="#E4D5D4";                           /*AGENDA CONTACT ASSOCIE POPUP*/
  ...
  $AgendaLigneHover="#9B615F";                             /*SURVOL DES LIGNES DANS LES PLANNINGS*/

  $CalepinValide=$CalNavigationTexte;                      /*CALEPIN LETTRE VALIDE*/
  $CalepinNonValide="#9B615F";                             /*CALEPIN LETTRE NON VALIDE*/
  ...
  $PlanningJour="#F7F7EF";                                 /*PLANNING DISPO JOUR*/
