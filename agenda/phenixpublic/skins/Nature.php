<?php
  $AppliStyleNom="Nature";            /*NOM DU STYLE AFFICHE DANS LE CHOIX DE L'INTERFACE*/
                                      /*           NE PAS DEPLACER NI SUPPRIMER          */

  $AppliFondEcran="#FFFFFF";                               /*FOND PAGE*/
  $AppliFondImage="url(\"../skins/Nature/bg.png\")";           /*IMAGE FOND PAGE*/
  ...
  $FormulaireFondBouton="#FFDF7F";                         /*FOND BOUTON*/
  ...
  $MenuOnFond="#E1E1E1;BORDER-LEFT:solid 1px #FFFFFF;BORDER-RIGHT:solid 1px #FFFFFF;";
  $MenuOffLien="#FFFFFF";
  $MenuOffLienHover="#FFDF7F";
  $MenuCopyright="#000000";                                /*TEXTE COPYRIGHT*/

  $AujourdhuiFond="#52815E";
  ...
  $CalJourEvenement="#acc2b2"; 									  				 /*CALENDRIER EVENEMENT*/
  $CalJourSelection="#7FAB89";                             /*CALENDRIER FOND PLAGE SELECTION*/
  $CalJourCourant="#F7F7EF";                               /*CALENDRIER JOUR OU SEMAINE COURANTE*/
  ...
  $AgendaFondTitrePopup="#52815E";                         /*AGENDA FOND TITRE POPUP*/
  ...
  $AgendaContactPopup="#99CC99";                           /*AGENDA CONTACT ASSOCIE POPUP*/
  ...
  $AgendaLigneHover="#99CC99";                             /*SURVOL DES LIGNES DANS LES PLANNINGS*/

  $CalepinValide=$CalNavigationTexte;                      /*CALEPIN LETTRE VALIDE*/
  $CalepinNonValide="#969696";                             /*CALEPIN LETTRE NON VALIDE*/
