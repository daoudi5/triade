<?php
  $AppliStyleNom="Saumon";           /*NOM DU STYLE AFFICHE DANS LE CHOIX DE L'INTERFACE*/
                                      /*           NE PAS DEPLACER NI SUPPRIMER          */

  $AppliFondEcran="#FCE4BA";                               /*FOND PAGE*/
  $AppliFondImage="";      /*IMAGE FOND PAGE*/
  ...
  $FormulaireFondBouton="#BCCEE2";                         /*FOND BOUTON*/
  $FormulaireTexteBouton="#000000";                        /*TEXTE BOUTON*/
  $FormulaireBordureBouton="#000000 solid 1px";            /*BORDURE BOUTON*/
  $FormulaireImageBouton="url(\"../skins/Saumon/th.jpg\")"; /*IMAGE FOND BOUTON*/

  $MenuFond="#DEB887";                                     /*AGENDA FOND MENU*/
  $MenuOnLien="#FFFFFF";
  $MenuOnLienHover="#000000";
  $MenuOnFond="#DEB887; BORDER-LEFT: solid 1px #DEB887; BORDER-RIGHT: solid 1px #DEB887;";
  $MenuOffLien="#FFFFFF";
  $MenuOffLienHover="#000000";
  $MenuCopyright="#99CCCC";                                /*TEXTE COPYRIGHT*/

  $AujourdhuiFond="#DEB887";
  ...
  $CalNavigationFond="#666666";                            /*AGENDA FOND SOUS MENU*/
  ...
  $CalJourEvenement="#6699CC"; 											  		 /*CALENDRIER EVENEMENT*/
  $CalJourSelection="#99CCCC";                             /*CALENDRIER FOND PLAGE SELECTION*/
  $CalJourCourant="#B2CADE";                               /*CALENDRIER JOUR OU SEMAINE COURANTE*/
  ...
  $AgendaBordureTableau="#243B50";                         /*BORDURE DES TABLEAUX*/
  ...
  $AgendaFondTitrePopup="#506E87";                         /*AGENDA FOND TITRE POPUP*/
  ...
  $AgendaContactPopup="#b2cade";                           /*AGENDA CONTACT ASSOCIE POPUP*/
  ...
  $AgendaLigneHover="#6C859C";                             /*SURVOL DES LIGNES DANS LES PLANNINGS*/

  $CalepinValide=$CalNavigationTexte;                      /*CALEPIN LETTRE VALIDE*/
  $CalepinNonValide="#B2CADE";                             /*CALEPIN LETTRE NON VALIDE*/
  ...
  $bgColor[0]="#FAEBD7";                                   /*FOND LIGNE1*/
  $bgColor[1]="#CCCCCC";                                   /*FOND LIGNE2*/
