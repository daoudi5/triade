          ...
          <TR>
            <TD colspan="2" align="center" class="bordLRB" bgcolor="<?php echo $bgColor[1]; ?>"><TABLE border="0" cellspacing="0" cellpadding="2" style="font-size:11px;">
              ...
              <TR>
                ...
                <TD>******<INPUT type="hidden" class="Texte" name="ztLogin" size="15" maxlength="12" value="<?php echo "$membre$idpers" ; ?>"></TD>
              ...
              <TR>
                ...
                <TD>******<INPUT type="hidden" class="Texte" name="ztPasswd" size="15" maxlength="12" value="<?php echo "aucun"; ?>"><INPUT type="hidden" name="ztPasswdMD5"></TD>
              </TR>
              <TR>
              ...
              <TR>
                <TD height="50" colspan="3" align="center" valign="middle"><INPUT type="submit" class="Bouton" value="<?php echo trad("INDEX_CONNECTER"); ?>" name="btSubmit"><?php if ($PUBLIC) { ?>&nbsp;&nbsp;&nbsp;<INPUT type="button" style="visibility:hidden" class="Bouton" value="<?php echo trad("INDEX_NOUVEAU"); ?>" name="btCreer" onclick="javascript: compteUtil();"><?php } ?></TD>
              </TR>
            </TABLE></TD>
...
<script>document.formLogUtil.btSubmit.click();</script>
	</TD>
  </TR>
  </TABLE>
...
<BODY onLoad=\"javascript: window.focus(); selectUtil(document.frmProfil.zlUtilisateur, document.frmProfil.zlPartage); selectUtil(document.frmProfil.zlUtilisateur2, document.frmProfil.zlAffecte); document.frmProfil.ztNom.focus();\" topmargin=0 leftmargin=0 rightmargin=0 bottommargin=0 marginwidth=0 marginheight=0>
  ...
  <TR>
	...
	if ($membre == "menueleve") {
      ...
      $rsProfil['util_prenom'] = "$pre";
      $rsProfil['util_login']  = "$membre$idpers";
      $rsProfil['util_passwd'] = "aucun";
