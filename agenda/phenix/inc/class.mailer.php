...
class Mailer {
  ...
  /* * Variable qui contiendra l'objet smtp
     ...
     * @access public */
  var $smtp = NULL;
  /* * Si placé à TRUE, la connexion au serveur SMTP ne sera pas fermée après l'envoi, et sera réutilisée pour un envoi ultérieur.
     ...
     * @var  boolean
     * @access public */
  var $persistent_connection = TRUE;
  /***************************************************************/
