<?php
  $AppliStyleNom="P&eacute;trole";           /*NOM DU STYLE AFFICHE DANS LE CHOIX DE L'INTERFACE*/
                                      /*           NE PAS DEPLACER NI SUPPRIMER          */

  $AppliFondEcran="#FFFFFF";                               /*FOND PAGE*/
  $AppliFondImage="url(\"../skins/Petrole/bg.png\")";      /*IMAGE FOND PAGE*/
  ...
  $FormulaireImageBouton="url(\"../skins/Petrole/th.jpg\")"; /*IMAGE FOND BOUTON*/

  $MenuFond="#39526B";                                     /*AGENDA FOND MENU*/
  $MenuOnLien="#FFFFFF";
  $MenuOnLienHover="#99CCCC";
  $MenuOnFond="#6C859C;BORDER-LEFT: solid 1px #FFFFFF; BORDER-RIGHT: solid 1px #FFFFFF;";
  $MenuOffLien="#FFFFFF";
  $MenuOffLienHover="#99CCCC";
  $MenuCopyright="#99CCCC";                                /*TEXTE COPYRIGHT*/

  $AujourdhuiFond="#6C859C";
  ...
  $CalNavigationFond="#506E87";                            /*AGENDA FOND SOUS MENU*/
  ...
  $CalTitreFond="#B2CADE";
  $CalFond="#E1EDF7";                                      /*CALENDRIER FOND CALENDRIER*/
