<?php
  $AppliStyleNom="Bleue";             /*NOM DU STYLE AFFICHE DANS LE CHOIX DE L'INTERFACE*/
                                      /*           NE PAS DEPLACER NI SUPPRIMER          */

  $AppliFondEcran="#FFFFFF";                               /*FOND PAGE*/
  $AppliFondImage="url(\"../skins/Bleue/bg.png\")";        /*IMAGE FOND PAGE*/
  ...
  $FormulaireTexteBouton="#526B84";                        /*TEXTE BOUTON*/
  $FormulaireBordureBouton="#000000 solid 1px";            /*BORDURE BOUTON*/
  $FormulaireImageBouton="url(\"../skins/Bleue/th.jpg\")"; /*IMAGE FOND BOUTON*/

  $MenuFond="#00216B";                                     /*AGENDA FOND MENU*/
  $MenuOnLien="#FFFFFF";
  $MenuOnLienHover="#000000";
  $MenuOnFond="#738CAD;BORDER-LEFT:solid 1px #FFFFFF;BORDER-RIGHT:solid 1px #FFFFFF;";
  $MenuOffLien="#FFFFFF";
  $MenuOffLienHover="#738CAD";
  $MenuCopyright="#738CAD";                                /*TEXTE COPYRIGHT*/

  $AujourdhuiFond="#738CAD";
  ...
  $CalJourEvenement="#3399FF"; 												  	 /*CALENDRIER EVENEMENT*/
  $CalJourSelection="#A9C3DB";                             /*CALENDRIER FOND PLAGE SELECTION*/
  $CalJourCourant="#87C5FF";                               /*CALENDRIER JOUR OU SEMAINE COURANTE*/
  $CalQuitterLien="#000000";
  $CalQuitterLienHover="#000000";
  ...
  $AgendaLigneHover="#738CAD";                             /*SURVOL DES LIGNES DANS LES PLANNINGS*/
