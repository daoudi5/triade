<?php
  $AppliStyleNom="Violine";           /*NOM DU STYLE AFFICHE DANS LE CHOIX DE L'INTERFACE*/
                                      /*           NE PAS DEPLACER NI SUPPRIMER          */

  $AppliFondEcran="#A9C3DB";                               /*FOND PAGE*/
  $AppliFondImage="url(\"../skins/Violine/bg.png\")";      /*IMAGE FOND PAGE*/

  $FormulaireFondInput="#FFFFFF";                          /*FOND FORMULAIRE*/
  $FormulaireTexteInput="#000000";                         /*TEXTE FORMULAIRE*/
  $FormulaireBordureInput="#000000 solid 1px";             /*BORDURE FORMULAIRE*/
  $FormulaireFondBouton="#CDCFF6";                         /*FOND BOUTON*/
  $FormulaireTexteBouton="#5C70A0";                        /*TEXTE BOUTON*/
  $FormulaireBordureBouton="#000000 solid 1px";            /*BORDURE BOUTON*/
  $FormulaireImageBouton="url(\"../skins/Violine/th.jpg\")"; /*IMAGE FOND BOUTON*/

  $MenuFond="#88819F";                                     /*AGENDA FOND MENU*/
  $MenuOnLien="#FFFFFF";
  $MenuOnLienHover="#88819F";
  $MenuOnFond="#4B5A8A;BORDER-LEFT:solid 1px #FFFFFF;BORDER-RIGHT:solid 1px #FFFFFF;";/*4B5A8A*/
  $MenuOffLien="#FFFFFF";
  $MenuOffLienHover="#4B5A8A";
  $MenuCopyright="#000000";                                /*TEXTE COPYRIGHT*/

  $AujourdhuiFond="#4B5A8A";/*A9C3DB*/
  $AujourdhuiLien="#FFFFFF";
  $AujourdhuiLienHover="#88819F";

  $PageTitre="#5C70A0";
  $PageNomUtilisateur=$PageTitre;
  $PageDate="#5C70A0";

  $CalNavigationFond="#5C70A0";                            /*AGENDA FOND SOUS MENU*/
  ...
  $CalJourFerie="#FFFFC0";                                 /*CALENDRIER JOUR FERIE*/
  $CalJourEvenement="#9999FF"; 											  		 /*CALENDRIER EVENEMENT*/
  $CalJourSelection="#C0D1DA";                             /*CALENDRIER FOND PLAGE SELECTION*/
  $CalJourCourant="#C2CAE6";                               /*CALENDRIER JOUR OU SEMAINE COURANTE*/
  $CalQuitterLien="#000000";
  $CalQuitterLienHover="#304A7C";
  $CalFondExport="#FFFFFF";                                /*FOND DES LIENS POUR L'IMPORT / EXPORT*/
  $CalFlechePopup="menuarrow_w.gif";                       /*FLECHE POUR LES MENUS DU CALENDRIER EN DHTML*/
  ...
  $AgendaLigneHover="#88819F";                             /*SURVOL DES LIGNES DANS LES PLANNINGS*/

  $CalepinValide=$CalNavigationTexte;                      /*CALEPIN LETTRE VALIDE*/
  $CalepinNonValide="#A9C3DB";                             /*CALEPIN LETTRE NON VALIDE*/
  ...
  $PlanningJour="#EDEFF8";                                 /*PLANNING DISPO JOUR*/
  ...
  $PlanningLibre="#FFFFFF";                                /*PLANNING DISPO LIBRE*/
  $PlanningInvalideTexte="#000000";                        /*PLANNING DISPO JOUR INVALIDE TEXTE*/

  $bgColor[0]="#FFFFFF";                                   /*FOND LIGNE1*/
  $bgColor[1]="#EDEFF8";                                   /*FOND LIGNE2*/
