<?php
  $AppliStyleNom="Anthracite";             /*NOM DU STYLE AFFICHE DANS LE CHOIX DE L'INTERFACE*/
                                      /*           NE PAS DEPLACER NI SUPPRIMER          */

  $AppliFondEcran="#FFFFFF";                               /*FOND PAGE*/
  $AppliFondImage="url(\"../skins/Anthracite/bg.gif\")";   /*IMAGE FOND PAGE*/
  ...
  $MenuOnFond="#CECECE;BORDER-LEFT:solid 1px #000000;BORDER-RIGHT:solid 1px #000000;";
  $MenuOffLien="#FFEE7F";
  $MenuOffLienHover="#FFCC00";
  $MenuCopyright="#BBBBBB";                                /*TEXTE COPYRIGHT*/

  $AujourdhuiFond="#CECECE";
  $AujourdhuiLien="#535D66";
  $AujourdhuiLienHover="#000000";

  $PageTitre="#FFFFFF";
  $PageNomUtilisateur="#535D66";
  $PageDate="#FFFFFF";

  $CalNavigationFond="#333333";                            /*AGENDA FOND SOUS MENU*/
  $CalNavigationTexte="#FFFFFF";                           /*AGENDA TEXTE SOUS MENU*/
  $CalNavigationLien="#FFEE7F";                            /*AGENDA LIEN SOUS MENU*/
  $CalNavigationLienHover="#FFCC00";                       /*AGENDA SURVOL LIEN SOUS MENU*/
  $CalTitreFond="#DDDDDD";
  ...
  $CalJourFerie="#C1C1C1";                                 /*CALENDRIER JOUR FERIE*/
  $CalJourEvenement="#D7D7D7"; 									  				 /*CALENDRIER EVENEMENT*/
  $CalJourSelection="#E9EEF3";                             /*CALENDRIER FOND PLAGE SELECTION*/
  $CalJourCourant="#DDDDDD";                               /*CALENDRIER JOUR OU SEMAINE COURANTE*/
  $CalQuitterLien="#999999";
  $CalQuitterLienHover="#FFFFFF";
  ...
  $AgendaLegende="#FFFFFF";                                /*LEGENDE DES BOUTONS DE L'AGENDA*/
  $AgendaDateCreationNote="#666666";                       /*DATE DE CREATION D'UNE NOTE DANS LES POPUP*/
  $AgendaLigneHover="#9F9F9F";                             /*SURVOL DES LIGNES DANS LES PLANNINGS*/

  $CalepinValide="#FFEE7F";                                /*CALEPIN LETTRE VALIDE*/
  $CalepinNonValide="#FFFFFF";                             /*CALEPIN LETTRE NON VALIDE*/
...
// MAJ Phenix 5.0
  ...
  $AgendaTexteInfoTimezone="#FFFFFF";                      /*COULEUR DU TEXTE DU FUSEAU HORAIRE EN BAS DE PAGE*/
