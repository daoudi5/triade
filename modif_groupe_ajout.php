...
<TR>
<td bgcolor="yellow" align=center width=30%><?php print LANGGRP29 ?></TD>
<td bgcolor="yellow"  align=center><?php print LANGGRP30 ?></TD>
...
foreach($classesDsGroupe as $cle => $value){
	...
	if ($liste_classe == "") {$liste_classe="&nbsp;<i><font color=red>".LANGMESS56."</font></i>"; $noclass=1; }

	if ( ((eregi("$nomClasse",$liste_classe)) && ($saisie_classe != "")) || ($noclass == 1) || ($_SESSION["membre"] == "menuadmin") ) {
	?>
	...
	<TD align=center><input type=button onclick="open('modif_groupe_ajout2.php?gid=<?php print $aff[0]?>&sClasseGrp=<?php print $saisie_classe?>','liste_groupe_eleve','width=600,height=650,scrollbars=yes')" value="<?php print LANGGRP60?>" STYLE="font-family:Arial;font-size:10px;color:#CC0000;background-color:#CCCCFF;font-weight:bold;"></TD></tR>
<?php
	}
	$i++;
	$noclass=0;
