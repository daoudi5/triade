...
for($i=0;$i<count($data);$i++) {
	...
	$infoEntreprise="<font class='T2'>$ahref$nom_ent$fahref  - Contact : ".ucwords($contact)." - Email : $email &nbsp;-&nbsp;$contact_fonction<br>adresse: $adresse  CCP: $ccp   Ville: $ville   Pays: <font color=red>$pays</font>  &nbsp;Tel: $tel  -  Fax: $fax  - <br>Informations : $infoplus &nbsp;Sexe : $sexe / Logement : $logement / Salaire : $salaire</font>";
	print "<tr >";
