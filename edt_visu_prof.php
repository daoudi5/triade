...
<form name="form">
<br />
&nbsp;&nbsp;<input type="button" class="button" value="Semaine précédente" onclick="displayPreviousWeek();return false">
<input type="button" class="button" value="Semaine suivante" onclick="displayNextWeek();return false">
...
<?php print LANGMESS55 ?> : <select name="classeID" onchange="displayPreviousClasse2();">
<?php
print select_classe_search($donnee[0][6]); 
?>
