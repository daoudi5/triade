...
<tr id='coulBar0' ><td height="2"><b><font   id='menumodule1' ><?php print "Configuration des messages aux entreprises." ?></font></b></td></tr>
<tr id='cadreCentral0' >
<td valign=top>
<?php
$url="gestionconfigemailsouhaitcentral.php";
include("gestion_central_stage_url.php");
if ($url == "gestionconfigemailsouhaitcentral.php") { $url="$url?id=$id&p=null"; }
?>
