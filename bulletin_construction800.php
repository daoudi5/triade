...
for($j=$dep;$j<$nbEleveT;$j++) {  // premiere ligne de la creation PDF
	...
	$appreciation="Appréciation de l'équipe pédagogique";
	if ($abssconet == "oui") {
	...
	$barre="_________________________________________________________________________________________________";
	$appreciation2="Appréciation du tuteur en entreprise";
	...
	$pdf->SetFont('Arial','',9);
	$pdf->SetFillColor(220);
	$pdf->SetXY(3,60); //  placement  cadre titre
	$pdf->MultiCell(196,11,'',1,'C',1);
...
$pdf->SetFillColor(220);
$pdf->SetXY(3,$Ycom);
$pdf->MultiCell(196,$EpaisCom,'',1,'C',0);
$pdf->SetXY(4,$YcomP1);
