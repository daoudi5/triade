...
if (count($valeur)) {
	...
	if ($_POST["saisie_trimestre"] == "trimestre3" ) { $textTrimestre=" FIN DE SESSION"; $triabsconet="T3"; }
}
...
if (file_exists("./image/banniere/banniere-lfmp.jpg")) {
	$taille = getimagesize("./image/banniere/banniere-lfmp.jpg");
	$logox=100;
	$logoy=25;
	$pdf->Image("./image/banniere/banniere-lfmp.jpg","60",$YcomP1+40,$logox,$logoy);
}
