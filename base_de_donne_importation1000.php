...
<ul>
<br />
<form method=post  action='./base_de_donne_importation1010.php' name=formulaire ENCTYPE="multipart/form-data">

<font class=T2><?php print LANGGEP2?> : (<b>xls</b>)  <input type="file" name="fichier1" size=20 ></font> <br />
<br />
<br />
<img src='image/on1.gif' height=8 width=8 > <?php print "Prendre la première ligne du fichier " ?> : <input type=checkbox name="optionligne" value="oui" > (<?php print LANGOUI ?>)
<br />
<br />
<br />
<ul><ul>
