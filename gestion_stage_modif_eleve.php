...
for($i=0;$i<count($data);$i++)
	...
	<td width=5><input type=button onclick="open('gestion_stage_modif_eleve_2.php?id=<?php print $data[$i][1]?>&idclasse=<?php print $saisie_classe ?>','_parent','')" value="Consulter" STYLE="font-family: Arial;font-size:10px;color:#CC0000;background-color:#CCCCFF;font-weight:bold;"></td>
