...
<ul>
<br />
<form method=post  action='./base_de_donne_gep66.php' name=formulaire ENCTYPE="multipart/form-data">

<font class=T1><?php print LANGGEP2?> : <b>F_ERE.DBF</b>  <input type="file" name="fichier1" size=20 > <br /><br />
